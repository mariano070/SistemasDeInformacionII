...
using System.IO;
public class bldaptbus004_b_1 : GxBaseBuilder
{
   string cs_path = "." ;
   public bldaptbus004_b_1( ) : base()
   {
   }
   ...
   {
      bldaptbus004_b_1 x = new bldaptbus004_b_1() ;
      x.SetMainSourceFile( "aptbus004_b_1.cs");
   ...
   {
      ItemCollection sc = new ItemCollection() ;
      sc.Add( @"bin\aptbus004_b_1.exe", cs_path + @"\aptbus004_b_1.rsp");
      return sc ;
   }
