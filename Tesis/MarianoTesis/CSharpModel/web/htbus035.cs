/*
               File: HTBUS035
        Description: Generar Listado de Asociaciones de bienes de uso
             Author: GeneXus C# Generator version 10_1_5-42940
       Generated on: 2/4/2014 19:3:24.31
...
namespace GeneXus.Programs {
   public class htbus035 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public htbus035( )
      {
      ...
      public htbus035( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" onsubmit=\"try{return gx.csv.validForm()}catch(e){return true;}\" name=\"MAINFORM\" method=\"post\" action=\""+formatLink("htbus035.aspx") + "?" + UrlEncode(StringUtil.RTrim(AV5SISTEMA)) + "," + UrlEncode(StringUtil.RTrim(AV8USUARIO))+"\" class=\""+"Form"+"\">") ;
      ...
      {
         return "Generar Listado de Asociaciones de bienes de uso" ;
      }
      ...
      {
         return formatLink("htbus035.aspx") + "?" + UrlEncode(StringUtil.RTrim(AV5SISTEMA)) + "," + UrlEncode(StringUtil.RTrim(AV8USUARIO)) ;
      }
      ...
      protected void START1H2( )
      {
         ...
         Form.Meta.addItem("Description", "Generar Listado de Asociaciones de bienes de uso", 0) ;
         context.wjLoc = "" ;
      ...
      protected void E121H2( )
      {
         ...
         if ( AV7TTBUS7_Pos != 0 )
         {
            ...
            {
               A33TTBUS7_Pos = H001H2_A33TTBUS7_Pos[0] ;
      ...
      protected void E141H2( )
      {
         ...
         context.wjLoc = formatLink("aptbus035.aspx") + "?" + UrlEncode(StringUtil.RTrim(AV14NOMBRE_REPORTE)) + "," + UrlEncode(StringUtil.RTrim(AV8USUARIO)) + "," + UrlEncode("" +AV7TTBUS7_Pos) + "," + UrlEncode(StringUtil.RTrim(AV6TTBUS7_CodResp)) ;
      }
      ...
      protected void wb_table1_2_1H2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td style=\"height:15px\">") ;
            wb_table2_10_1H2( true) ;
         }
         else
         {
            wb_table2_10_1H2( false) ;
         }
         return  ;
      }

      protected void wb_table2_10_1H2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            ClassString = "Button" ;
            StyleString = "" ;
            GxWebStd.gx_button_ctrl( context, context.GetButtonType( ), bttButton1_Internalname, "Generar Listado", "Generar Listado", "", StyleString, ClassString, 1, 1, "rounded", 5, bttButton1_Jsonclick, "E\\'GENERAR LISTADO\\'.", TempTags, "", "", "HLP_HTBUS035.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
      ...
      protected void wb_table2_10_1H2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblock1_Internalname, 1, 1, 0, "Posición:", "", "", "", 0, lblTextblock1_Jsonclick, "", StyleString, ClassString, "HLP_HTBUS035.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            ...
            StyleString = "" ;
            GxWebStd.gx_single_line_edit( context, edtavTtbus7_pos_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV7TTBUS7_Pos), 3, 0, ",", "")), "", 3, "chr", 1, "row", 3, 1, 1, 0, 0, 0, "", "", StyleString, ClassString, "", context.localUtil.Format( (decimal)(AV7TTBUS7_Pos), "ZZ9"), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(15);\"", 0, edtavTtbus7_pos_Jsonclick, "", 0, 1, -1, true, "right", "HLP_HTBUS035.htm");
            /* Static images/pictures */
            ClassString = "Image" ;
            StyleString = "" ;
            GxWebStd.gx_bitmap( context, imgprompt_Ttbus7_pos_Internalname, "", "prompt.gif", "Modern", 1, 1, "", "", 0, 0, 0, "", 0, "", 0, 0, imgprompt_Ttbus7_pos_Link, "", 0, "", "", StyleString, ClassString, "", "", "''", "", "HLP_HTBUS035.htm");
            context.WriteHtmlText( "&nbsp;&nbsp; ") ;
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 16,'',false,'',0)\"" ;
            ClassString = "Attribute" ;
            StyleString = "" ;
            GxWebStd.gx_single_line_edit( context, edtavTtbus7_des_Internalname, StringUtil.RTrim( AV10TTBUS7_Des), "", 50, "chr", 1, "row", 50, 1, edtavTtbus7_des_Enabled, 0, 0, 0, "", "", StyleString, ClassString, "", StringUtil.RTrim( context.localUtil.Format( AV10TTBUS7_Des, "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(16);\"", 0, edtavTtbus7_des_Jsonclick, "", 0, 1, -1, true, "left", "HLP_HTBUS035.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            ...
            ClassString = "TextBlock" ;
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblock2_Internalname, 1, 1, 0, "Responsable:", "", "", "", 0, lblTextblock2_Jsonclick, "", StyleString, ClassString, "HLP_HTBUS035.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            ...
            ClassString = "Attribute" ;
            StyleString = "" ;
            GxWebStd.gx_single_line_edit( context, edtavTtbus7_codresp_Internalname, StringUtil.RTrim( AV6TTBUS7_CodResp), "", 16, "chr", 1, "row", 16, 1, 1, 0, 0, 0, "", "", StyleString, ClassString, "", StringUtil.RTrim( context.localUtil.Format( AV6TTBUS7_CodResp, "@!")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onblur(21);\"", 0, edtavTtbus7_codresp_Jsonclick, "", 0, 1, -1, true, "left", "HLP_HTBUS035.htm");
            /* Static images/pictures */
            ClassString = "Image" ;
            StyleString = "" ;
            GxWebStd.gx_bitmap( context, imgprompt_Ttbus7_codresp_Internalname, "", "prompt.gif", "Modern", 1, 1, "", "", 0, 0, 0, "", 0, "", 0, 0, imgprompt_Ttbus7_codresp_Link, "", 0, "", "", StyleString, ClassString, "", "", "''", "", "HLP_HTBUS035.htm");
            context.WriteHtmlText( "&nbsp;&nbsp; ") ;
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 22,'',false,'',0)\"" ;
            ClassString = "Attribute" ;
            StyleString = "" ;
            GxWebStd.gx_single_line_edit( context, edtavUsu_des_Internalname, StringUtil.RTrim( AV9USU_DES), "", 50, "chr", 1, "row", 50, 1, edtavUsu_des_Enabled, 0, 0, 0, "", "", StyleString, ClassString, "", StringUtil.RTrim( context.localUtil.Format( AV9USU_DES, "@!")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onblur(22);\"", 0, edtavUsu_des_Jsonclick, "", 0, 1, -1, true, "left", "HLP_HTBUS035.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "</tbody>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_10_1H2e( true) ;
         }
         else
         {
            wb_table2_10_1H2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( Form.Jscriptsrc.Item(idxLst)), "?1932449");
            idxLst = (int)(idxLst+1) ;
         }
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("htbus035.js", "?1932449");
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Generar Listado de Asociaciones de bienes de uso" ;
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "" ;
         H001H2_A33TTBUS7_Pos = new short[1] ;
         H001H2_A34TTBUS7_Des = new String[] {""} ;
         H001H2_n34TTBUS7_Des = new bool[] {false} ;
         A34TTBUS7_Des = "" ;
         H001H3_A6USU_COD = new String[] {""} ;
         H001H3_A7USU_DES = new String[] {""} ;
         A6USU_COD = "" ;
         A7USU_DES = "" ;
         AV14NOMBRE_REPORTE = "" ;
         sStyleString = "" ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.htbus035__default(),
            new Object[][] {
                new Object[] {
               H001H2_A33TTBUS7_Pos, H001H2_A34TTBUS7_Des, H001H2_n34TTBUS7_Des
               }
               , new Object[] {
               H001H3_A6USU_COD, H001H3_A7USU_DES
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private short[] H001H2_A33TTBUS7_Pos ;
      private String[] H001H2_A34TTBUS7_Des ;
      private bool[] H001H2_n34TTBUS7_Des ;
      private String[] H001H3_A6USU_COD ;
      private String[] H001H3_A7USU_DES ;
   ...
   public class htbus035__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H001H2", "SELECT T1.[TTBUS7_Pos] AS TTBUS7_Pos, T2.[W53DES] AS TTBUS7_Des FROM ([TTBUS007] T1 WITH (NOLOCK) INNER JOIN [T53FPOS] T2 WITH (NOLOCK) ON T2.[W53POS] = T1.[TTBUS7_Pos]) WHERE T1.[TTBUS7_Pos] = @AV7TTBUS7_Pos ORDER BY T1.[TTBUS7_Pos] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001H2,1,0,false,true )
             ,new CursorDef("H001H3", "SELECT [USU_COD], [USU_DES] FROM [SEG002] WITH (NOLOCK) WHERE [USU_COD] = @AV6TTBUS7_CodResp ORDER BY [USU_COD] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001H3,1,0,false,true )
          };
       }
    }
