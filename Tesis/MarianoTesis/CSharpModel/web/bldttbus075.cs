...
using System.IO;
public class bldttbus075 : GxBaseBuilder
{
   string cs_path = "." ;
   public bldttbus075( ) : base()
   {
   }
   ...
   {
      bldttbus075 x = new bldttbus075() ;
      x.SetMainSourceFile( "ttbus075.cs");
   ...
   {
      ItemCollection sc = new ItemCollection() ;
      sc.Add( @"bin\ttbus075.dll", cs_path + @"\ttbus075.rsp");
      return sc ;
   }
