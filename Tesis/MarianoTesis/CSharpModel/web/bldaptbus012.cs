...
using System.IO;
public class bldaptbus012 : GxBaseBuilder
{
   string cs_path = "." ;
   public bldaptbus012( ) : base()
   {
   }
   ...
   {
      bldaptbus012 x = new bldaptbus012() ;
      x.SetMainSourceFile( "aptbus012.cs");
   ...
   {
      ItemCollection sc = new ItemCollection() ;
      sc.Add( @"bin\aptbus012.dll", cs_path + @"\aptbus012.rsp");
      return sc ;
   }
