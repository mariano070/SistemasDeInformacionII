/*
               File: TSEG002TPRM005WC
        Description: TSEG002 TPRM005 WC
             Author: GeneXus C# Generator version 10_1_5-42940
       Generated on: 1/6/2014 11:19:42.46
...
namespace GeneXus.Programs {
   public class tseg002tprm005wc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public tseg002tprm005wc( )
      {
      ...
      public tseg002tprm005wc( IGxContext context )
      {
      ...
      public void execute( String aP0_PRM5_USU )
      {
         this.AV7PRM5_USU = aP0_PRM5_USU;
         executePrivate();
      }
         ...
         if ( StringUtil.Len( (String)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV7PRM5_USU = GetNextPar( ) ;
                  componentprepare(new Object[] {(String)sCompPrefix,(String)sSFPrefix,(String)AV7PRM5_USU});
                  componentstart();
               ...
               {
                  /* GeneXus formulas. */
                  AV16Pgmname = "TSEG002TPRM005WC" ;
                  context.Gx_err = 0 ;
                  Grid_PageSize12 = (int)(NumberUtil.Val( GetNextPar( ), ".")) ;
                  AV7PRM5_USU = GetNextPar( ) ;
                  context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "AV7PRM5_USU", AV7PRM5_USU);
                  edtavDelete_Tooltiptext = GetNextPar( ) ;
                  context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavDelete_Internalname, "Tooltiptext", edtavDelete_Tooltiptext);
                  AV13Delete = GetNextPar( ) ;
                  context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavDelete_Internalname, "Bitmap", context.convertURL( AV13Delete));
                  ...
                  AV12Update = GetNextPar( ) ;
                  context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavUpdate_Internalname, "Bitmap", context.convertURL( AV12Update));
                  A284PRM5_USU = GetNextPar( ) ;
                  context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A284PRM5_USU", A284PRM5_USU);
                  sPrefix = GetNextPar( ) ;
                  setAjaxCallMode();
                  if ( ! IsValidAjaxCall( true) )
                  {
                  ...
                  gxgrGrid_refresh( Grid_PageSize12, AV7PRM5_USU, AV13Delete, AV12Update, A284PRM5_USU, sPrefix) ;
                  return  ;
               }
               else
               {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.WriteHtmlText( "TSEG002 TPRM005 WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" onsubmit=\"try{return gx.csv.validForm()}catch(e){return true;}\" name=\"MAINFORM\" method=\"post\" action=\""+formatLink("tseg002tprm005wc.aspx") + "?" + UrlEncode(StringUtil.RTrim(AV7PRM5_USU))+"\" class=\""+"Form"+"\">") ;
      ...
      protected void RenderHtmlCloseForm0N2( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV7PRM5_USU", StringUtil.RTrim( wcpOAV7PRM5_USU));
         GxWebStd.gx_hidden_field( context, sPrefix+"vPRM5_USU", StringUtil.RTrim( AV7PRM5_USU));
         ...
         {
            context.AddJavascriptSource("tseg002tprm005wc.js", "?11194252");
         }
      ...
      protected void WB0N0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "tseg002tprm005wc.aspx");
            }
      ...
      protected void wb_table1_2_0N2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            StyleString = "" ;
            GxWebStd.gx_single_line_edit( context, edtPRM5_USU_Internalname, StringUtil.RTrim( A284PRM5_USU), "", 16, "chr", 1, "row", 16, edtPRM5_USU_Visible, 0, 0, 0, 0, "", "", StyleString, ClassString, "", StringUtil.RTrim( context.localUtil.Format( A284PRM5_USU, "@!")), "", 0, edtPRM5_USU_Jsonclick, "", 0, 1, 1, true, "left", "HLP_TSEG002TPRM005WC.htm");
         }
         wbLoad = true ;
      }
      ...
      protected void START0N2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("Description", "TSEG002 TPRM005 WC", 0) ;
            context.wjLoc = "" ;
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 10), "'DOINSERT'") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              edtPRM5_ZNA_Internalname = sPrefix+"PRM5_ZNA_"+sGXsfl_12_idx ;
                              AV12Update = cgiGet( "GXimg"+edtavUpdate_Internalname) ;
                              context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavUpdate_Internalname, "Bitmap", context.convertURL( AV12Update));
                              AV13Delete = cgiGet( "GXimg"+edtavDelete_Internalname) ;
                              context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavDelete_Internalname, "Bitmap", context.convertURL( AV13Delete));
                              A285PRM5_ZNA = (int)(context.localUtil.CToN( cgiGet( edtPRM5_ZNA_Internalname), ",", ".")) ;
                              context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A285PRM5_ZNA", StringUtil.LTrim( StringUtil.Str( (decimal)(A285PRM5_ZNA), 9, 0)));
                              sEvtType = StringUtil.Right( sEvt, 1) ;
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 sEvt = StringUtil.Left( sEvt, (short)(StringUtil.Len( sEvt)-1)) ;
      ...
      {
         /* Using cursor H000N3 */
         pr_default.execute(1, new Object[] {AV7PRM5_USU});
      ...
      protected void STRUP0N0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            A284PRM5_USU = StringUtil.Upper( cgiGet( edtPRM5_USU_Internalname)) ;
            context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A284PRM5_USU", A284PRM5_USU);
            /* Read saved values. */
            nRC_Grid = (short)(context.localUtil.CToN( cgiGet( sPrefix+"nRC_Grid"), ",", ".")) ;
            wcpOAV7PRM5_USU = cgiGet( sPrefix+"wcpOAV7PRM5_USU") ;
      ...
      protected void E120N2( )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavDelete_Internalname, "Tooltiptext", edtavDelete_Tooltiptext);
         edtPRM5_USU_Visible = 0 ;
         context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtPRM5_USU_Internalname, "Visible", StringUtil.LTrim( StringUtil.Str( (decimal)(edtPRM5_USU_Visible), 5, 0)));
      ...
      {
         /* Grid_Load Routine */
         edtavUpdate_Link = formatLink("tprm005.aspx") + "?" + UrlEncode(StringUtil.RTrim("UPD")) + "," + UrlEncode(StringUtil.RTrim(A284PRM5_USU)) + "," + UrlEncode("" +A285PRM5_ZNA) ;
         context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavUpdate_Internalname, "Link", edtavUpdate_Link);
         edtavDelete_Link = formatLink("tprm005.aspx") + "?" + UrlEncode(StringUtil.RTrim("DLT")) + "," + UrlEncode(StringUtil.RTrim(A284PRM5_USU)) + "," + UrlEncode("" +A285PRM5_ZNA) ;
      ...
      {
         /* 'DoInsert' Routine */
         context.wjLoc = formatLink("tprm005.aspx") + "?" + UrlEncode(StringUtil.RTrim("INS")) + "," + UrlEncode(StringUtil.RTrim(AV7PRM5_USU)) + "," + UrlEncode("" +0) ;
      }
      ...
      protected void wb_table1_2_0N2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table2_5_0N2( true) ;
         }
         else
         {
            wb_table2_5_0N2( false) ;
         }
         return  ;
      }

      protected void wb_table2_5_0N2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
      ...
      protected void wb_table2_5_0N2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            StyleString = "" ;
            GxWebStd.gx_bitmap( context, imgInsert_Internalname, "", context.GetImagePath( "5649fbb8-8ce0-4810-a5ce-bd649ea83c3a", "", "Modern"), "Modern", 1, 1, "", "Agrega", 0, 0, 0, "", 0, "", 0, 0, "", "", 5, imgInsert_Jsonclick, sPrefix+"E\\'DOINSERT\\'.", StyleString, ClassString, "", ""+TempTags, "", "", "HLP_TSEG002TPRM005WC.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            ...
            if ( GridContainer.GetWrapped() == 1 )
            {
               ...
               context.SendWebValue( "Zona Promoción") ;
               context.WriteHtmlTextNl( "</th>") ;
            ...
            else
            {
               ...
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
               GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A285PRM5_ZNA), 9, 0, ".", "")));
               GridContainer.AddColumnProperties(GridColumn);
         ...
         if ( wbEnd == 12 )
         {
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_5_0N2e( true) ;
         }
         else
         {
            wb_table2_5_0N2e( false) ;
         }
      }
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV7PRM5_USU = (String)getParm(obj,0) ;
         context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "AV7PRM5_USU", AV7PRM5_USU);
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV7PRM5_USU = (String)((String)getParm(obj,0)) ;
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "tseg002tprm005wc");
         ...
         {
            AV7PRM5_USU = (String)getParm(obj,2) ;
            context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "AV7PRM5_USU", AV7PRM5_USU);
         }
         wcpOAV7PRM5_USU = cgiGet( sPrefix+"wcpOAV7PRM5_USU") ;
         if ( ! GetJustCreated( ) && ( ( StringUtil.StrCmp(AV7PRM5_USU, wcpOAV7PRM5_USU) != 0 ) ) )
         {
            setjustcreated();
         }
         wcpOAV7PRM5_USU = AV7PRM5_USU ;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlAV7PRM5_USU = cgiGet( sPrefix+"AV7PRM5_USU_CTRL") ;
         if ( StringUtil.Len( sCtrlAV7PRM5_USU) > 0 )
         {
            AV7PRM5_USU = cgiGet( sCtrlAV7PRM5_USU) ;
            context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "AV7PRM5_USU", AV7PRM5_USU);
         }
         else
         {
            AV7PRM5_USU = cgiGet( sPrefix+"AV7PRM5_USU_PARM") ;
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV7PRM5_USU_PARM", StringUtil.RTrim( AV7PRM5_USU));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV7PRM5_USU)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV7PRM5_USU_CTRL", StringUtil.RTrim( sCtrlAV7PRM5_USU));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( Form.Jscriptsrc.Item(idxLst)), "?11194281");
            idxLst = (int)(idxLst+1) ;
         }
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("tseg002tprm005wc.js", "?11194281");
         }
      ...
      protected void sendrow_122( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_12_idx <= subGrid_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtPRM5_ZNA_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A285PRM5_ZNA), 9, 0, ",", "")),(String)"",(short)0,(String)"px",(short)17,(String)"",(short)9,(short)-1,(short)0,(short)0,(short)0,(short)0,(String)"",(String)"",(String)StyleString,(String)ClassString,(String)ROClassString,context.localUtil.Format( (decimal)(A285PRM5_ZNA), "ZZZZZZZZ9"),(String)"",(short)0,(String)edtPRM5_ZNA_Jsonclick,(String)"",(short)12,(short)1,(short)1,(bool)true,(String)"right"});
      ...
      protected void init_default_properties( )
      {
         ...
         edtPRM5_USU_Internalname = sPrefix+"PRM5_USU" ;
      ...
      {
         init_default_properties( ) ;
         edtPRM5_ZNA_Jsonclick = "" ;
         subGrid_Class = "WorkWith" ;
         subGrid_Backcolorstyle = 3 ;
         edtavDelete_Link = "" ;
         edtavUpdate_Link = "" ;
         edtPRM5_USU_Jsonclick = "" ;
         edtPRM5_USU_Visible = 1 ;
         subGrid_Rows = 0 ;
         edtavUpdate_Tooltiptext = "Modifica" ;
         edtavDelete_Tooltiptext = "Eliminar" ;
      }
      ...
      public override void initialize( )
      {
         ...
         EvtRowId = "" ;
         sEvtType = "" ;
         edtPRM5_ZNA_Internalname = "" ;
         GridContainer = new GXWebGrid( context);
         scmdbuf = "" ;
         H000N2_A284PRM5_USU = new String[] {""} ;
         H000N2_A285PRM5_ZNA = new int[1] ;
         H000N3_AGRID_nRecordCount = new int[1] ;
         AV10TrnContext = new SdtTransactionContext(context);
         ...
         ROClassString = "" ;
         GXt_char7 = "" ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.tseg002tprm005wc__default(),
            new Object[][] {
                new Object[] {
               H000N2_A284PRM5_USU, H000N2_A285PRM5_ZNA
               }
               , new Object[] {
      ...
      private int edtPRM5_USU_Visible ;
      ...
      private String AV7PRM5_USU ;
      private String wcpOAV7PRM5_USU ;
      ...
      private String edtPRM5_USU_Internalname ;
      private String edtPRM5_USU_Jsonclick ;
      private String sXEvt ;
      private String sEvt ;
      private String EvtGridId ;
      private String EvtRowId ;
      private String sEvtType ;
      private String edtPRM5_ZNA_Internalname ;
      ...
      private String sCtrlAV7PRM5_USU ;
      private String ROClassString ;
      private String edtPRM5_ZNA_Jsonclick ;
      ...
      private String[] H000N2_A284PRM5_USU ;
      private int[] H000N2_A285PRM5_ZNA ;
      private int[] H000N3_AGRID_nRecordCount ;
   ...
   public class tseg002tprm005wc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV7PRM5_USU",SqlDbType.Char,16,0}
          } ;
          Object[] prmH000N3 ;
          ...
          def= new CursorDef[] {
              new CursorDef("H000N2", "SELECT [PRM5_USU], [PRM5_ZNA] FROM [TPRM005] WITH (NOLOCK) WHERE [PRM5_USU] = @AV7PRM5_USU ORDER BY [PRM5_USU], [PRM5_ZNA] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000N2,11,0,true,false )
             ,new CursorDef("H000N3", "SELECT COUNT(*) FROM [TPRM005] WITH (NOLOCK) WHERE [PRM5_USU] = @AV7PRM5_USU ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000N3,1,0,true,false )
          };
       }
    }
