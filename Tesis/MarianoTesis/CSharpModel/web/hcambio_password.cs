/*
       ...
       Generated on: 4/2/2014 19:29:46.35
...
namespace GeneXus.Programs {
   public class hcambio_password : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( Form.Jscriptsrc.Item(idxLst)), "?19294654");
            idxLst = (int)(idxLst+1) ;
         }
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("hcambio_password.js", "?19294654");
