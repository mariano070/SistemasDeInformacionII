...
using System.IO;
public class bldaptbus016_1 : GxBaseBuilder
{
   string cs_path = "." ;
   public bldaptbus016_1( ) : base()
   {
   }
   ...
   {
      bldaptbus016_1 x = new bldaptbus016_1() ;
      x.SetMainSourceFile( "aptbus016_1.cs");
   ...
   {
      ItemCollection sc = new ItemCollection() ;
      sc.Add( @"bin\aptbus016_1.dll", cs_path + @"\aptbus016_1.rsp");
      return sc ;
   }
