...
using System.IO;
public class bldaptbus010 : GxBaseBuilder
{
   string cs_path = "." ;
   public bldaptbus010( ) : base()
   {
   }
   ...
   {
      bldaptbus010 x = new bldaptbus010() ;
      x.SetMainSourceFile( "aptbus010.cs");
   ...
   {
      ItemCollection sc = new ItemCollection() ;
      sc.Add( @"bin\aptbus010.dll", cs_path + @"\aptbus010.rsp");
      return sc ;
   }
