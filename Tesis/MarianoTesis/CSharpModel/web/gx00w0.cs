/*
               File: Gx00W0
        Description: Lista de Selección SEG000
...
namespace GeneXus.Programs {
   public class gx00w0 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      {
         return "Lista de Selección SEG000" ;
      }
      ...
      protected void START3R2( )
      {
         ...
         Form.Meta.addItem("Description", "Lista de Selección SEG000", 0) ;
         context.wjLoc = "" ;
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Lista de Selección SEG000" ;
