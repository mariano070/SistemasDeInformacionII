         ...
         if ( oReader.IsSimple == 0 )
         {
            ...
            while ( ( ( StringUtil.StrCmp(oReader.Name, sTagName) != 0 ) || ( oReader.NodeType == 1 ) ) && ( GXSoapError > 0 ) )
            {
               ...
               if ( StringUtil.StrCmp(oReader.LocalName, "Attributes") == 0 )
               {
                  ...
                  {
                     gxTv_SdtTransactionContext_Attributes = new GxObjectCollection( context, "TransactionContext.Attribute", "MarianoTesis", "SdtTransactionContext_Attribute", "GeneXus.Programs");
                  }
                  if ( oReader.IsSimple == 0 )
                  {
