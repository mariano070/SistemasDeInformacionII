...
using System.IO;
public class bldwwtseg003 : GxBaseBuilder
{
   string cs_path = "." ;
   public bldwwtseg003( ) : base()
   {
   }
   ...
   {
      bldwwtseg003 x = new bldwwtseg003() ;
      x.SetMainSourceFile( "wwtseg003.cs");
   ...
   {
      ItemCollection sc = new ItemCollection() ;
      sc.Add( @"bin\wwtseg003.dll", cs_path + @"\wwtseg003.rsp");
      return sc ;
   }
