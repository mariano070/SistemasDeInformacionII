...
using System.IO;
public class bldaptbus011 : GxBaseBuilder
{
   string cs_path = "." ;
   public bldaptbus011( ) : base()
   {
   }
   ...
   {
      bldaptbus011 x = new bldaptbus011() ;
      x.SetMainSourceFile( "aptbus011.cs");
   ...
   {
      ItemCollection sc = new ItemCollection() ;
      sc.Add( @"bin\aptbus011.dll", cs_path + @"\aptbus011.rsp");
      return sc ;
   }
