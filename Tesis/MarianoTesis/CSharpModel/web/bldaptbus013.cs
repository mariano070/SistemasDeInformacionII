...
using System.IO;
public class bldaptbus013 : GxBaseBuilder
{
   string cs_path = "." ;
   public bldaptbus013( ) : base()
   {
   }
   ...
   {
      bldaptbus013 x = new bldaptbus013() ;
      x.SetMainSourceFile( "aptbus013.cs");
   ...
   {
      ItemCollection sc = new ItemCollection() ;
      sc.Add( @"bin\aptbus013.dll", cs_path + @"\aptbus013.rsp");
      return sc ;
   }
