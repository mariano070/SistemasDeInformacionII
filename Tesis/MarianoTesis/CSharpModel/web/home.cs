/*
       ...
       Generated on: 1/6/2014 11:18:22.6
...
namespace GeneXus.Programs {
   public class home : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlCloseForm( )
      {
         ...
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vPROGRAMNAMES", (Object)(AV6ProgramNames));
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("vPROGRAMNAMES", (Object)(AV6ProgramNames));
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( Form.Jscriptsrc.Item(idxLst)), "?11182220");
            idxLst = (int)(idxLst+1) ;
         }
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("home.js", "?11182220");
         }
      ...
      public override void initialize( )
      {
         gxfirstwebparm = "" ;
         gxfirstwebparm_bkp = "" ;
         AV6ProgramNames = new GxObjectCollection( context, "ProgramNames.ProgramName", "MarianoTesis", "SdtProgramNames_ProgramName", "GeneXus.Programs");
         sDynURL = "" ;
         FormProcess = "" ;
         GX_FocusControl = "" ;
         Form = new GXWebForm();
