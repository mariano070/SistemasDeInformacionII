/*
       ...
       Generated on: 4/2/2014 19:29:54.87
...
namespace GeneXus.Programs {
   public class htbusseg0_ini : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( Form.Jscriptsrc.Item(idxLst)), "?1929555");
            idxLst = (int)(idxLst+1) ;
         }
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("htbusseg0_ini.js", "?1929555");
