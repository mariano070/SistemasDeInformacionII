/*
       ...
       Generated on: 4/2/2014 19:29:15.61
...
namespace GeneXus.Programs {
   public class htbus003c : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( Form.Jscriptsrc.Item(idxLst)), "?19291652");
            idxLst = (int)(idxLst+1) ;
         }
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("htbus003c.js", "?19291653");
         }
