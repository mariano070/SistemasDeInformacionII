/*
       ...
       Generated on: 4/2/2014 19:29:22.65
...
namespace GeneXus.Programs {
   public class htbus001_prev : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( Form.Jscriptsrc.Item(idxLst)), "?19292270");
            idxLst = (int)(idxLst+1) ;
         }
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("htbus001_prev.js", "?19292270");
         }
