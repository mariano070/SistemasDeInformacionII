/*
       ...
       Generated on: 2/5/2014 11:30:51.4
...
namespace GeneXus.Programs {
   public class gx00l2 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      {
         this.AV8pUSU_COD = aP0_pUSU_COD;
         this.AV9pSIS_COD = aP1_pSIS_COD;
         this.AV10pPRG_COD = 0 ;
         executePrivate();
         aP2_pPRG_COD=this.AV10pPRG_COD;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
            {
               ...
               AV8pUSU_COD = GetNextPar( ) ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV8pUSU_COD", AV8pUSU_COD);
               AV9pSIS_COD = (short)(NumberUtil.Val( GetNextPar( ), ".")) ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV9pSIS_COD", StringUtil.LTrim( StringUtil.Str( (decimal)(AV9pSIS_COD), 3, 0)));
               setAjaxCallMode();
               if ( ! IsValidAjaxCall( true) )
               {
                  GxWebError = 1 ;
               ...
               gxgrGrid1_refresh( Grid1_PageSize21, AV6cPRG_COD, AV8pUSU_COD, AV9pSIS_COD) ;
               return  ;
            }
            else
            {
            ...
            if ( ! entryPointCalled )
            {
               AV8pUSU_COD = gxfirstwebparm ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV8pUSU_COD", AV8pUSU_COD);
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  AV9pSIS_COD = (short)(NumberUtil.Val( GetNextPar( ), ".")) ;
                  context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV9pSIS_COD", StringUtil.LTrim( StringUtil.Str( (decimal)(AV9pSIS_COD), 3, 0)));
                  AV10pPRG_COD = (short)(NumberUtil.Val( GetNextPar( ), ".")) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" onsubmit=\"try{return gx.csv.validForm()}catch(e){return true;}\" name=\"MAINFORM\" method=\"post\" action=\""+formatLink("gx00l2.aspx") + "?" + UrlEncode(StringUtil.RTrim(AV8pUSU_COD)) + "," + UrlEncode("" +AV9pSIS_COD) + "," + UrlEncode("" +AV10pPRG_COD)+"\" class=\""+"Form"+"\">") ;
      ...
      public override void RenderHtmlCloseForm( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vPUSU_COD", StringUtil.RTrim( AV8pUSU_COD));
         GxWebStd.gx_hidden_field( context, "vPSIS_COD", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV9pSIS_COD), 3, 0, ",", "")));
      ...
      {
         return formatLink("gx00l2.aspx") + "?" + UrlEncode(StringUtil.RTrim(AV8pUSU_COD)) + "," + UrlEncode("" +AV9pSIS_COD) + "," + UrlEncode("" +AV10pPRG_COD) ;
      }
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 4), "LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              edtPRG_COD_Internalname = "PRG_COD_"+sGXsfl_21_idx ;
                              edtUSU_COD_Internalname = "USU_COD_"+sGXsfl_21_idx ;
                              edtSIS_COD_Internalname = "SIS_COD_"+sGXsfl_21_idx ;
      ...
      protected void RF4C2( )
      {
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( context.wjLoc)) && ( context.nUserReturn != 1 ) )
         {
            ...
            edtSIS_COD_Internalname = "SIS_COD_"+sGXsfl_21_idx ;
            /* Using cursor H004C2 */
            pr_default.execute(0, new Object[] {AV8pUSU_COD, AV9pSIS_COD, AV6cPRG_COD});
            nGXsfl_21_idx = 1 ;
            GRID1_nEOF = 0 ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( 10 == 0 ) || ( GRID1_nCurrentRecord < GRID1_nFirstRecordOnPage + subGrid1_Recordsperpage( ) ) ) ) )
            {
               A116SIS_COD = H004C2_A116SIS_COD[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A116SIS_COD", StringUtil.LTrim( StringUtil.Str( (decimal)(A116SIS_COD), 3, 0)));
               A6USU_COD = H004C2_A6USU_COD[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A6USU_COD", A6USU_COD);
               A126PRG_COD = H004C2_A126PRG_COD[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A126PRG_COD", StringUtil.LTrim( StringUtil.Str( (decimal)(A126PRG_COD), 4, 0)));
               /* Execute user event: E124C2 */
               E124C2 ();
      ...
      {
         /* Using cursor H004C3 */
         pr_default.execute(1, new Object[] {AV8pUSU_COD, AV9pSIS_COD, AV6cPRG_COD});
         GRID1_nRecordCount = H004C3_AGRID1_nRecordCount[0] ;
         pr_default.close(1);
      ...
      protected void STRUP4C0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV8pUSU_COD = cgiGet( "vPUSU_COD") ;
            AV9pSIS_COD = (short)(context.localUtil.CToN( cgiGet( "vPSIS_COD"), ",", ".")) ;
      ...
      protected void E134C2( )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV10pPRG_COD", StringUtil.LTrim( StringUtil.Str( (decimal)(AV10pPRG_COD), 4, 0)));
         context.setWebReturnParms(new Object[] {(short)AV10pPRG_COD});
      ...
      protected void wb_table1_2_4C2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table2_9_4C2( true) ;
         }
         else
         {
            wb_table2_9_4C2( false) ;
         }
         return  ;
      }

      protected void wb_table2_9_4C2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table3_18_4C2( true) ;
         }
         else
         {
            wb_table3_18_4C2( false) ;
         }
         return  ;
      }

      protected void wb_table3_18_4C2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</fieldset>") ;
      ...
      protected void wb_table3_18_4C2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
         ...
         if ( wbEnd == 21 )
         {
            ...
            wb_table4_28_4C2( true) ;
         }
         else
         {
            wb_table4_28_4C2( false) ;
         }
         return  ;
      }

      protected void wb_table4_28_4C2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_18_4C2e( true) ;
         }
         else
         {
            wb_table3_18_4C2e( false) ;
         }
      }

      protected void wb_table4_28_4C2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            StyleString = "" ;
            GxWebStd.gx_button_ctrl( context, context.GetButtonType( ), bttBtn_cancel_Internalname, "Cancelar", "Cancelar", "", StyleString, ClassString, 1, 1, "rounded", 1, bttBtn_cancel_Jsonclick, "ECANCEL.", TempTags, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(21), 3, 0)+","+"null"+");", "", "HLP_Gx00L2.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "</tbody>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table4_28_4C2e( true) ;
         }
         else
         {
            wb_table4_28_4C2e( false) ;
         }
      }

      protected void wb_table2_9_4C2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblockprg_cod_Internalname, 1, 1, 0, "CODIGO", "", "", "", 0, lblTextblockprg_cod_Jsonclick, "", StyleString, ClassString, "HLP_Gx00L2.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            ...
            StyleString = "" ;
            GxWebStd.gx_single_line_edit( context, edtavCprg_cod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6cPRG_COD), 4, 0, ",", "")), "", 4, "chr", 1, "row", 4, 1, 1, 0, 0, 0, "", "", StyleString, ClassString, "", context.localUtil.Format( (decimal)(AV6cPRG_COD), "ZZZ9"), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(14);\"", 0, edtavCprg_cod_Jsonclick, "", 0, 1, -1, true, "right", "HLP_Gx00L2.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "</tbody>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_9_4C2e( true) ;
         }
         else
         {
            wb_table2_9_4C2e( false) ;
         }
      }
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8pUSU_COD = (String)getParm(obj,0) ;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV8pUSU_COD", AV8pUSU_COD);
         AV9pSIS_COD = Convert.ToInt16(getParm(obj,1)) ;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV9pSIS_COD", StringUtil.LTrim( StringUtil.Str( (decimal)(AV9pSIS_COD), 3, 0)));
         AV10pPRG_COD = Convert.ToInt16(getParm(obj,2)) ;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV10pPRG_COD", StringUtil.LTrim( StringUtil.Str( (decimal)(AV10pPRG_COD), 4, 0)));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( Form.Jscriptsrc.Item(idxLst)), "?11305129");
            idxLst = (int)(idxLst+1) ;
         }
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx00l2.js", "?11305129");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "" ;
         H004C2_A116SIS_COD = new short[1] ;
         H004C2_A6USU_COD = new String[] {""} ;
         H004C2_A126PRG_COD = new short[1] ;
         H004C3_AGRID1_nRecordCount = new int[1] ;
         sStyleString = "" ;
         ClassString = "" ;
         StyleString = "" ;
         subGrid1_Linesclass = "" ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx00l2__default(),
            new Object[][] {
                new Object[] {
               H004C2_A116SIS_COD, H004C2_A6USU_COD, H004C2_A126PRG_COD
               }
               , new Object[] {
               H004C3_AGRID1_nRecordCount
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private short AV9pSIS_COD ;
      private short wcpOAV9pSIS_COD ;
      ...
      private String AV8pUSU_COD ;
      private String wcpOAV8pUSU_COD ;
      ...
      private short[] H004C2_A116SIS_COD ;
      private String[] H004C2_A6USU_COD ;
      private short[] H004C2_A126PRG_COD ;
      private int[] H004C3_AGRID1_nRecordCount ;
   ...
   public class gx00l2__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV8pUSU_COD",SqlDbType.Char,16,0} ,
          new Object[] {"@AV9pSIS_COD",SqlDbType.SmallInt,3,0} ,
          ...
          def= new CursorDef[] {
              new CursorDef("H004C2", "SELECT [SIS_COD], [USU_COD], [PRG_COD] FROM [SEG004] WITH (NOLOCK) WHERE [USU_COD] = @AV8pUSU_COD and [SIS_COD] = @AV9pSIS_COD and [PRG_COD] >= @AV6cPRG_COD ORDER BY [USU_COD], [SIS_COD], [PRG_COD]  OPTION (FAST 11)",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004C2,11,1,false,false )
             ,new CursorDef("H004C3", "SELECT COUNT(*) FROM [SEG004] WITH (NOLOCK) WHERE [USU_COD] = @AV8pUSU_COD and [SIS_COD] = @AV9pSIS_COD and [PRG_COD] >= @AV6cPRG_COD ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004C3,1,1,false,false )
          };
       }
    }
