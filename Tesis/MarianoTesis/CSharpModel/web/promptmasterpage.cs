/*
       ...
       Generated on: 4/2/2014 19:28:59.74
...
namespace GeneXus.Programs {
   public class promptmasterpage : GXMasterPage, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlCloseForm032( )
      {
         ...
         context.AddJavascriptSource("promptmasterpage.js", "?19285975");
      ...
      protected void wb_table6_24_032( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            ClassString = "Image" ;
            StyleString = "" ;
            GxWebStd.gx_bitmap( context, imgImage1_Internalname, "", context.GetImagePath( "f5f8a0c4-001a-440a-877e-a7d6e67aefb3", "", "Modern"), "Modern", 1, 1, "", "", 0, 0, 112, "", 46, "", 0, 0, "", "", 0, "", "", StyleString, ClassString, "", "", "", "", "HLP_PromptMasterPage.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "</tbody>") ;
            /* End of table */
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( getDataAreaObject().GetForm().Jscriptsrc.Item(idxLst)), "?19285981");
            idxLst = (int)(idxLst+1) ;
         }
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("promptmasterpage.js", "?19285981");
         }
