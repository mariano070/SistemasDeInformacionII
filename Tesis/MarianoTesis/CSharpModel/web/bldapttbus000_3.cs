...
using System.IO;
public class bldapttbus000_3 : GxBaseBuilder
{
   string cs_path = "." ;
   public bldapttbus000_3( ) : base()
   {
   }
   ...
   {
      bldapttbus000_3 x = new bldapttbus000_3() ;
      x.SetMainSourceFile( "apttbus000_3.cs");
   ...
   {
      ItemCollection sc = new ItemCollection() ;
      sc.Add( @"bin\apttbus000_3.exe", cs_path + @"\apttbus000_3.rsp");
      return sc ;
   }
