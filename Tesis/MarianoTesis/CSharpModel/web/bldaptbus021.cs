...
using System.IO;
public class bldaptbus021 : GxBaseBuilder
{
   string cs_path = "." ;
   public bldaptbus021( ) : base()
   {
   }
   ...
   {
      bldaptbus021 x = new bldaptbus021() ;
      x.SetMainSourceFile( "aptbus021.cs");
   ...
   {
      ItemCollection sc = new ItemCollection() ;
      sc.Add( @"bin\aptbus021.exe", cs_path + @"\aptbus021.rsp");
      return sc ;
   }
