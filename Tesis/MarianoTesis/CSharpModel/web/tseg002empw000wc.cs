/*
               File: TSEG002EMPW000WC
        Description: TSEG002 EMPW000 WC
             Author: GeneXus C# Generator version 10_1_5-42940
       Generated on: 1/6/2014 11:19:41.82
...
namespace GeneXus.Programs {
   public class tseg002empw000wc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public tseg002empw000wc( )
      {
      ...
      public tseg002empw000wc( IGxContext context )
      {
      ...
      public void execute( String aP0_EMPW_USU )
      {
         this.AV7EMPW_USU = aP0_EMPW_USU;
         executePrivate();
      }
         ...
         if ( StringUtil.Len( (String)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV7EMPW_USU = GetNextPar( ) ;
                  componentprepare(new Object[] {(String)sCompPrefix,(String)sSFPrefix,(String)AV7EMPW_USU});
                  componentstart();
               ...
               {
                  /* GeneXus formulas. */
                  AV16Pgmname = "TSEG002EMPW000WC" ;
                  context.Gx_err = 0 ;
                  Grid_PageSize12 = (int)(NumberUtil.Val( GetNextPar( ), ".")) ;
                  AV7EMPW_USU = GetNextPar( ) ;
                  context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "AV7EMPW_USU", AV7EMPW_USU);
                  edtavDelete_Tooltiptext = GetNextPar( ) ;
                  context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavDelete_Internalname, "Tooltiptext", edtavDelete_Tooltiptext);
                  AV13Delete = GetNextPar( ) ;
                  context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavDelete_Internalname, "Bitmap", context.convertURL( AV13Delete));
                  ...
                  context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A278EMPW_USU", A278EMPW_USU);
                  sPrefix = GetNextPar( ) ;
                  setAjaxCallMode();
                  if ( ! IsValidAjaxCall( true) )
                  {
                  ...
                  gxgrGrid_refresh( Grid_PageSize12, AV7EMPW_USU, AV13Delete, AV12Update, A278EMPW_USU, sPrefix) ;
                  return  ;
               }
               else
               {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.WriteHtmlText( "TSEG002 EMPW000 WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" onsubmit=\"try{return gx.csv.validForm()}catch(e){return true;}\" name=\"MAINFORM\" method=\"post\" action=\""+formatLink("tseg002empw000wc.aspx") + "?" + UrlEncode(StringUtil.RTrim(AV7EMPW_USU))+"\" class=\""+"Form"+"\">") ;
      ...
      protected void RenderHtmlCloseForm0J2( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV7EMPW_USU", StringUtil.RTrim( wcpOAV7EMPW_USU));
         GxWebStd.gx_hidden_field( context, sPrefix+"vEMPW_USU", StringUtil.RTrim( AV7EMPW_USU));
         ...
         {
            context.AddJavascriptSource("tseg002empw000wc.js", "?11194187");
         }
      ...
      protected void WB0J0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "tseg002empw000wc.aspx");
            }
      ...
      protected void wb_table1_2_0J2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            StyleString = "" ;
            GxWebStd.gx_single_line_edit( context, edtEMPW_USU_Internalname, StringUtil.RTrim( A278EMPW_USU), "", 16, "chr", 1, "row", 16, edtEMPW_USU_Visible, 0, 0, 0, 0, "", "", StyleString, ClassString, "", StringUtil.RTrim( context.localUtil.Format( A278EMPW_USU, "@!")), "", 0, edtEMPW_USU_Jsonclick, "", 0, 1, 1, true, "left", "HLP_TSEG002EMPW000WC.htm");
         }
         wbLoad = true ;
      }
      ...
      protected void START0J2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("Description", "TSEG002 EMPW000 WC", 0) ;
            context.wjLoc = "" ;
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 10), "'DOINSERT'") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              edtEMPW_EMP_Internalname = sPrefix+"EMPW_EMP_"+sGXsfl_12_idx ;
                              edtEMPW_EMD_Internalname = sPrefix+"EMPW_EMD_"+sGXsfl_12_idx ;
                              ...
                              context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A279EMPW_EMP", StringUtil.LTrim( StringUtil.Str( (decimal)(A279EMPW_EMP), 8, 0)));
                              A281EMPW_EMD = cgiGet( edtEMPW_EMD_Internalname) ;
                              context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A281EMPW_EMD", A281EMPW_EMD);
                              sEvtType = StringUtil.Right( sEvt, 1) ;
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 sEvt = StringUtil.Left( sEvt, (short)(StringUtil.Len( sEvt)-1)) ;
      ...
      protected void RF0J2( )
      {
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( context.wjLoc)) && ( context.nUserReturn != 1 ) )
         {
            ...
            edtEMPW_EMD_Internalname = sPrefix+"EMPW_EMD_"+sGXsfl_12_idx ;
            /* Using cursor H000J2 */
            pr_default.execute(0, new Object[] {AV7EMPW_USU});
            nGXsfl_12_idx = 1 ;
            GRID_nEOF = 0 ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < GRID_nFirstRecordOnPage + subGrid_Recordsperpage( ) ) ) ) )
            {
               A278EMPW_USU = H000J2_A278EMPW_USU[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A278EMPW_USU", A278EMPW_USU);
               A281EMPW_EMD = H000J2_A281EMPW_EMD[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A281EMPW_EMD", A281EMPW_EMD);
               A279EMPW_EMP = H000J2_A279EMPW_EMP[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A279EMPW_EMP", StringUtil.LTrim( StringUtil.Str( (decimal)(A279EMPW_EMP), 8, 0)));
               /* Execute user event: E130J2 */
               E130J2 ();
      ...
      {
         /* Using cursor H000J3 */
         pr_default.execute(1, new Object[] {AV7EMPW_USU});
      ...
      protected void STRUP0J0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV7EMPW_USU = cgiGet( sPrefix+"wcpOAV7EMPW_USU") ;
      ...
      protected void E120J2( )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavDelete_Internalname, "Tooltiptext", edtavDelete_Tooltiptext);
         edtEMPW_USU_Visible = 0 ;
         context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtEMPW_USU_Internalname, "Visible", StringUtil.LTrim( StringUtil.Str( (decimal)(edtEMPW_USU_Visible), 5, 0)));
      ...
      {
         /* Grid_Load Routine */
         edtavUpdate_Link = formatLink("empw000.aspx") + "?" + UrlEncode(StringUtil.RTrim("UPD")) + "," + UrlEncode(StringUtil.RTrim(A278EMPW_USU)) + "," + UrlEncode("" +A279EMPW_EMP) ;
         context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavUpdate_Internalname, "Link", edtavUpdate_Link);
         edtavDelete_Link = formatLink("empw000.aspx") + "?" + UrlEncode(StringUtil.RTrim("DLT")) + "," + UrlEncode(StringUtil.RTrim(A278EMPW_USU)) + "," + UrlEncode("" +A279EMPW_EMP) ;
      ...
      {
         /* 'DoInsert' Routine */
         context.wjLoc = formatLink("empw000.aspx") + "?" + UrlEncode(StringUtil.RTrim("INS")) + "," + UrlEncode(StringUtil.RTrim(AV7EMPW_USU)) + "," + UrlEncode("" +0) ;
      }
      ...
      protected void wb_table2_5_0J2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            StyleString = "" ;
            GxWebStd.gx_bitmap( context, imgInsert_Internalname, "", context.GetImagePath( "5649fbb8-8ce0-4810-a5ce-bd649ea83c3a", "", "Modern"), "Modern", 1, 1, "", "Agrega", 0, 0, 0, "", 0, "", 0, 0, "", "", 5, imgInsert_Jsonclick, sPrefix+"E\\'DOINSERT\\'.", StyleString, ClassString, "", ""+TempTags, "", "", "HLP_TSEG002EMPW000WC.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            ...
            else
            {
               ...
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
               GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A279EMPW_EMP), 8, 0, ".", "")));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
               GridColumn.AddObjectProperty("Value", StringUtil.RTrim( A281EMPW_EMD));
               GridContainer.AddColumnProperties(GridColumn);
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV7EMPW_USU = (String)getParm(obj,0) ;
         context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "AV7EMPW_USU", AV7EMPW_USU);
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV7EMPW_USU = (String)((String)getParm(obj,0)) ;
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "tseg002empw000wc");
         ...
         {
            AV7EMPW_USU = (String)getParm(obj,2) ;
            context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "AV7EMPW_USU", AV7EMPW_USU);
         }
         wcpOAV7EMPW_USU = cgiGet( sPrefix+"wcpOAV7EMPW_USU") ;
         if ( ! GetJustCreated( ) && ( ( StringUtil.StrCmp(AV7EMPW_USU, wcpOAV7EMPW_USU) != 0 ) ) )
         {
            setjustcreated();
         }
         wcpOAV7EMPW_USU = AV7EMPW_USU ;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlAV7EMPW_USU = cgiGet( sPrefix+"AV7EMPW_USU_CTRL") ;
         if ( StringUtil.Len( sCtrlAV7EMPW_USU) > 0 )
         {
            AV7EMPW_USU = cgiGet( sCtrlAV7EMPW_USU) ;
            context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "AV7EMPW_USU", AV7EMPW_USU);
         }
         else
         {
            AV7EMPW_USU = cgiGet( sPrefix+"AV7EMPW_USU_PARM") ;
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV7EMPW_USU_PARM", StringUtil.RTrim( AV7EMPW_USU));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV7EMPW_USU)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV7EMPW_USU_CTRL", StringUtil.RTrim( sCtrlAV7EMPW_USU));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( Form.Jscriptsrc.Item(idxLst)), "?11194219");
            idxLst = (int)(idxLst+1) ;
         }
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("tseg002empw000wc.js", "?11194219");
         }
      ...
      protected void sendrow_122( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_12_idx <= subGrid_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtEMPW_EMP_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A279EMPW_EMP), 8, 0, ",", "")),(String)"",(short)0,(String)"px",(short)17,(String)"",(short)8,(short)-1,(short)0,(short)0,(short)0,(short)0,(String)"",(String)"",(String)StyleString,(String)ClassString,(String)ROClassString,context.localUtil.Format( (decimal)(A279EMPW_EMP), "ZZZZZZZ9"),(String)"",(short)0,(String)edtEMPW_EMP_Jsonclick,(String)"",(short)12,(short)1,(short)1,(bool)true,(String)"right"});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
      ...
      protected void init_default_properties( )
      {
         ...
         edtEMPW_USU_Internalname = sPrefix+"EMPW_USU" ;
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "" ;
         H000J2_A278EMPW_USU = new String[] {""} ;
         H000J2_A281EMPW_EMD = new String[] {""} ;
         H000J2_A279EMPW_EMP = new int[1] ;
         H000J3_AGRID_nRecordCount = new int[1] ;
         AV10TrnContext = new SdtTransactionContext(context);
         ...
         ROClassString = "" ;
         GXt_char7 = "" ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.tseg002empw000wc__default(),
            new Object[][] {
                new Object[] {
               H000J2_A278EMPW_USU, H000J2_A281EMPW_EMD, H000J2_A279EMPW_EMP
               }
               , new Object[] {
      ...
      private int edtEMPW_USU_Visible ;
      ...
      private String AV7EMPW_USU ;
      private String wcpOAV7EMPW_USU ;
      ...
      private String sCtrlAV7EMPW_USU ;
      ...
      private String[] H000J2_A278EMPW_USU ;
      private String[] H000J2_A281EMPW_EMD ;
      private int[] H000J2_A279EMPW_EMP ;
      private int[] H000J3_AGRID_nRecordCount ;
   ...
   public class tseg002empw000wc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV7EMPW_USU",SqlDbType.Char,16,0}
          } ;
          Object[] prmH000J3 ;
          ...
          def= new CursorDef[] {
              new CursorDef("H000J2", "SELECT [EMPW_USU], [EMPW_EMD], [EMPW_EMP] FROM [EMPW000] WITH (NOLOCK) WHERE [EMPW_USU] = @AV7EMPW_USU ORDER BY [EMPW_USU], [EMPW_EMP] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000J2,11,0,true,false )
             ,new CursorDef("H000J3", "SELECT COUNT(*) FROM [EMPW000] WITH (NOLOCK) WHERE [EMPW_USU] = @AV7EMPW_USU ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000J3,1,0,true,false )
          };
       }
    }
