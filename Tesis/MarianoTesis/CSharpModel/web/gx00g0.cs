/*
       ...
       Generated on: 1/6/2014 11:8:24.38
...
namespace GeneXus.Programs {
   public class gx00g0 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
            {
               ...
               gxgrGrid1_refresh( Grid1_PageSize26, AV6cUSU_COD, AV7cSIS_COD) ;
               return  ;
            }
            else
            {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" onsubmit=\"try{return gx.csv.validForm()}catch(e){return true;}\" name=\"MAINFORM\" method=\"post\" action=\""+formatLink("gx00g0.aspx") + "?" + UrlEncode(StringUtil.RTrim(AV9pUSU_COD)) + "," + UrlEncode("" +AV10pSIS_COD)+"\" class=\""+"Form"+"\">") ;
      ...
      {
         return formatLink("gx00g0.aspx") + "?" + UrlEncode(StringUtil.RTrim(AV9pUSU_COD)) + "," + UrlEncode("" +AV10pSIS_COD) ;
      }
      ...
      protected void START2S2( )
      {
         ...
         Form.Meta.addItem("Description", "Selection List SEG003", 0) ;
         context.wjLoc = "" ;
      ...
      protected void RF2S2( )
      {
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( context.wjLoc)) && ( context.nUserReturn != 1 ) )
         {
            ...
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV6cUSU_COD", AV6cUSU_COD);
            /* Using cursor H002S2 */
            pr_default.execute(0, new Object[] {lV6cUSU_COD, AV7cSIS_COD});
            nGXsfl_26_idx = 1 ;
            GRID1_nEOF = 0 ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( 10 == 0 ) || ( GRID1_nCurrentRecord < GRID1_nFirstRecordOnPage + subGrid1_Recordsperpage( ) ) ) ) )
            {
               A116SIS_COD = H002S2_A116SIS_COD[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A116SIS_COD", StringUtil.LTrim( StringUtil.Str( (decimal)(A116SIS_COD), 3, 0)));
               A6USU_COD = H002S2_A6USU_COD[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A6USU_COD", A6USU_COD);
               /* Execute user event: E122S2 */
               E122S2 ();
      ...
      protected int subGrid1_Recordcount( )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV6cUSU_COD", AV6cUSU_COD);
         /* Using cursor H002S3 */
         pr_default.execute(1, new Object[] {lV6cUSU_COD, AV7cSIS_COD});
      ...
      {
         /* Start Routine */
         Form.Caption = StringUtil.Format( "Lista de Selección %1", "SEG003", "", "", "", "", "", "", "", "") ;
      ...
      {
         /* Enter Routine */
         AV9pUSU_COD = A6USU_COD ;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV9pUSU_COD", AV9pUSU_COD);
         AV10pSIS_COD = A116SIS_COD ;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV10pSIS_COD", StringUtil.LTrim( StringUtil.Str( (decimal)(AV10pSIS_COD), 3, 0)));
         context.setWebReturnParms(new Object[] {(String)AV9pUSU_COD,(short)AV10pSIS_COD});
      ...
      protected void wb_table2_9_2S2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table3_23_2S2( true) ;
         }
         else
         {
            wb_table3_23_2S2( false) ;
         }
         return  ;
      }

      protected void wb_table3_23_2S2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</fieldset>") ;
      ...
      protected void wb_table3_23_2S2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
         ...
         if ( wbEnd == 26 )
         {
            ...
            wb_table4_32_2S2( true) ;
         }
         else
         {
            wb_table4_32_2S2( false) ;
         }
         return  ;
      }

      protected void wb_table4_32_2S2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_23_2S2e( true) ;
         }
         else
         {
            wb_table3_23_2S2e( false) ;
         }
      }

      protected void wb_table4_32_2S2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            StyleString = "" ;
            GxWebStd.gx_button_ctrl( context, context.GetButtonType( ), bttBtn_cancel_Internalname, "Cancelar", "Cancelar", "", StyleString, ClassString, 1, 1, "rounded", 1, bttBtn_cancel_Jsonclick, "ECANCEL.", TempTags, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(26), 3, 0)+","+"null"+");", "", "HLP_Gx00G0.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "</tbody>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table4_32_2S2e( true) ;
         }
         else
         {
            wb_table4_32_2S2e( false) ;
         }
      }
      ...
      protected void wb_table2_9_2S2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblockusu_cod_Internalname, 1, 1, 0, "CODIGO", "", "", "", 0, lblTextblockusu_cod_Jsonclick, "", StyleString, ClassString, "HLP_Gx00G0.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            ...
            ClassString = "TextBlock" ;
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblocksis_cod_Internalname, 1, 1, 0, "CODIGO", "", "", "", 0, lblTextblocksis_cod_Jsonclick, "", StyleString, ClassString, "HLP_Gx00G0.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            ...
            ClassString = "Attribute" ;
            StyleString = "" ;
            GxWebStd.gx_single_line_edit( context, edtavCsis_cod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV7cSIS_COD), 3, 0, ",", "")), "", 3, "chr", 1, "row", 3, 1, 1, 0, 0, 0, "", "", StyleString, ClassString, "", context.localUtil.Format( (decimal)(AV7cSIS_COD), "ZZ9"), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(19);\"", 0, edtavCsis_cod_Jsonclick, "", 0, 1, -1, true, "right", "HLP_Gx00G0.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "</tbody>") ;
            /* End of table */
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( Form.Jscriptsrc.Item(idxLst)), "?1182476");
            idxLst = (int)(idxLst+1) ;
         }
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx00g0.js", "?1182476");
      ...
      protected void sendrow_262( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_26_idx <= subGrid1_Recordsperpage( ) * 1 ) )
         {
            ...
            edtavLinkselection_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.RTrim( A6USU_COD))+"'"+", "+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A116SIS_COD), 3, 0, ",", "")))+"'"+"]);" ;
            ...
            StyleString = "" ;
            ROClassString = ClassString ;
            edtSIS_COD_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.RTrim( A6USU_COD))+"'"+", "+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A116SIS_COD), 3, 0, ",", "")))+"'"+"]);" ;
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Selection List SEG003" ;
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "" ;
         lV6cUSU_COD = "" ;
         H002S2_A116SIS_COD = new short[1] ;
         H002S2_A6USU_COD = new String[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx00g0__default(),
            new Object[][] {
                new Object[] {
               H002S2_A116SIS_COD, H002S2_A6USU_COD
               }
               , new Object[] {
      ...
      private short[] H002S2_A116SIS_COD ;
      private String[] H002S2_A6USU_COD ;
   ...
   public class gx00g0__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H002S2", "SELECT [SIS_COD], [USU_COD] FROM [SEG003] WITH (NOLOCK) WHERE ([USU_COD] like @AV6cUSU_COD) AND ([SIS_COD] >= @AV7cSIS_COD) ORDER BY [USU_COD], [SIS_COD]  OPTION (FAST 11)",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002S2,11,1,false,false )
             ,new CursorDef("H002S3", "SELECT COUNT(*) FROM [SEG003] WITH (NOLOCK) WHERE ([USU_COD] like @AV6cUSU_COD) AND ([SIS_COD] >= @AV7cSIS_COD) ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002S3,1,1,false,false )
          };
       }
    }
