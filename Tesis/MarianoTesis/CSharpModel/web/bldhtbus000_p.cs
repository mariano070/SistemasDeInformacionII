...
using System.IO;
public class bldhtbus000_p : GxBaseBuilder
{
   string cs_path = "." ;
   public bldhtbus000_p( ) : base()
   {
   }
   ...
   {
      bldhtbus000_p x = new bldhtbus000_p() ;
      x.SetMainSourceFile( "htbus000_p.cs");
   ...
   {
      ItemCollection sc = new ItemCollection() ;
      sc.Add( @"bin\htbus000_p.dll", cs_path + @"\htbus000_p.rsp");
      return sc ;
   }
