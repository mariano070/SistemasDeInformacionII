/*
               File: TBUS000_prompt
        Description: Búsqueda de Bien de Uso en Contabilidad
...
namespace GeneXus.Programs {
   public class tbus000_prompt : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      {
         return "Búsqueda de Bien de Uso en Contabilidad" ;
      }
      ...
      protected void START092( )
      {
         ...
         Form.Meta.addItem("Description", "Búsqueda de Bien de Uso en Contabilidad", 0) ;
         context.wjLoc = "" ;
      ...
      protected void wb_table2_9_092e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            if ( Grid1Container.GetWrapped() == 1 )
            {
               ...
               context.WriteHtmlTextNl( "</th>") ;
               context.WriteHtmlText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+subGrid1_Linesclass+"\" "+" style=\""+((-1==0) ? "display:none;" : "")+""+"\" "+">") ;
               context.SendWebValue( "ADQUISICIÓN") ;
               context.WriteHtmlTextNl( "</th>") ;
               context.WriteHtmlText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+subGrid1_Linesclass+"\" "+" style=\""+((-1==0) ? "display:none;" : "")+""+"\" "+">") ;
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Búsqueda de Bien de Uso en Contabilidad" ;
