/*
       ...
       Generated on: 4/2/2014 19:29:58.74
   ...
   public class tabbedview : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.WriteHtmlText( " "+"class=\"Form\""+" "+" style=\"-moz-opacity:0;opacity:0;white-space: nowrap;"+"\""+FormProcess+">") ;
            context.skipLines(1);
      ...
      protected void RenderHtmlCloseForm062( )
      {
         ...
         {
            context.AddJavascriptSource("tabbedview.js", "?19295876");
         }
      ...
      protected void S112( )
      {
         ...
         AV20TabTemplate = AV20TabTemplate + "<a id=\"%2\" %3 class=\"%4\">" ;
      ...
      protected void S122( )
      {
         ...
         AV6Found = false ;
         if ( StringUtil.StrCmp(AV15TabCode, "") != 0 )
         {
            AV8Index = 1 ;
            while ( AV8Index <= AV18Tabs.Count )
            {
               if ( StringUtil.StrCmp(((SdtTabOptions_TabOptionsItem)AV18Tabs.Item(AV8Index)).gxTpr_Code, AV15TabCode) == 0 )
               {
      ...
      protected void S142( )
      {
         ...
         {
            AV19TabsMarkup = AV19TabsMarkup + StringUtil.Format( AV20TabTemplate, "Tab", AV14Tab.gxTpr_Code, StringUtil.Format( "href=\"%1\"", AV14Tab.gxTpr_Link, "", "", "", "", "", "", "", ""), AV16TabLeftCls, AV17TabRightCls, AV14Tab.gxTpr_Description, "", "", "") ;
         }
      }
      ...
      protected void wb_table1_2_062( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            context.WriteHtmlText( "<div class=\"TabContainer\" id=\"TabContaienr\">") ;
            /* Text block */
            ClassString = "TextBlock" ;
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTabs_Internalname, 1, 1, 2, lblTabs_Caption, "", "", "", 0, lblTabs_Jsonclick, "", StyleString, ClassString, "HLP_TabbedView.htm");
            /* Static images/pictures */
            ClassString = "TabPagingPrevious" ;
            StyleString = "" ;
            GxWebStd.gx_bitmap( context, imgTabprevious_Internalname, "", context.GetImagePath( "23d403d6-d1e5-4c79-aab4-f073de218b70", "", "Modern"), "Modern", imgTabprevious_Visible, 1, "", "Previous Tab", 0, 0, 0, "", 0, "", 0, 0, "", "", 0, "", "", StyleString, ClassString, "", "", "", "", "HLP_TabbedView.htm");
            /* Static images/pictures */
            ClassString = "TabPagingNext" ;
            StyleString = "" ;
            GxWebStd.gx_bitmap( context, imgTabnext_Internalname, "", context.GetImagePath( "f12b6130-24bd-4bf1-be14-7f0779ca7d89", "", "Modern"), "Modern", imgTabnext_Visible, 1, "", "Next Tab", 0, 0, 0, "", 0, "", 0, 0, "", "", 0, "", "", StyleString, ClassString, "", "", "", "", "HLP_TabbedView.htm");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( Form.Jscriptsrc.Item(idxLst)), "?19295887");
            idxLst = (int)(idxLst+1) ;
         }
      ...
      {
         context.AddJavascriptSource("tabbedview.js", "?19295887");
      ...
      {
         AV18Tabs = new GxObjectCollection( context, "TabOptions.TabOptionsItem", "MarianoTesis", "SdtTabOptions_TabOptionsItem", "GeneXus.Programs");
         wcpOAV15TabCode = "" ;
         gxfirstwebparm = "" ;
         gxfirstwebparm_bkp = "" ;
         sPrefix = "" ;
