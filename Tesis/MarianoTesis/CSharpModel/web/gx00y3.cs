/*
       ...
       Generated on: 1/6/2014 11:8:12.40
...
namespace GeneXus.Programs {
   public class gx00y3 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public gx00y3( )
      {
      ...
      public gx00y3( IGxContext context )
      {
                           ...
                           out int aP3_pPRS_NRO )
      {
         ...
         this.AV12pPRG_COD = aP2_pPRG_COD;
         this.AV13pPRS_NRO = 0 ;
         executePrivate();
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
            {
               ...
               AV6cPRS_NRO = (int)(NumberUtil.Val( GetNextPar( ), ".")) ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV6cPRS_NRO", StringUtil.LTrim( StringUtil.Str( (decimal)(AV6cPRS_NRO), 8, 0)));
               AV7cPRS_INI = context.localUtil.ParseDTimeParm( GetNextPar( )) ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV7cPRS_INI", context.localUtil.TToC( AV7cPRS_INI, 8, 5, 0, 3, "/", ":", " "));
               AV8cPRS_UOB = GetNextPar( ) ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV8cPRS_UOB", AV8cPRS_UOB);
               AV9cPRS_CAD = context.localUtil.ParseDTimeParm( GetNextPar( )) ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV9cPRS_CAD", context.localUtil.TToC( AV9cPRS_CAD, 8, 5, 0, 3, "/", ":", " "));
               ...
               gxgrGrid1_refresh( Grid1_PageSize36, AV6cPRS_NRO, AV7cPRS_INI, AV8cPRS_UOB, AV9cPRS_CAD, AV10pUSU_COD, AV11pSIS_COD, AV12pPRG_COD) ;
               return  ;
            }
            else
            {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" onsubmit=\"try{return gx.csv.validForm()}catch(e){return true;}\" name=\"MAINFORM\" method=\"post\" action=\""+formatLink("gx00y3.aspx") + "?" + UrlEncode(StringUtil.RTrim(AV10pUSU_COD)) + "," + UrlEncode("" +AV11pSIS_COD) + "," + UrlEncode("" +AV12pPRG_COD) + "," + UrlEncode("" +AV13pPRS_NRO)+"\" class=\""+"Form"+"\">") ;
      ...
      public override void RenderHtmlCloseForm( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vCPRS_NRO", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6cPRS_NRO), 8, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "GXH_vCPRS_INI", context.localUtil.Format(AV7cPRS_INI, "99/99/99 99:99"));
         GxWebStd.gx_hidden_field( context, "GXH_vCPRS_UOB", StringUtil.RTrim( AV8cPRS_UOB));
         GxWebStd.gx_hidden_field( context, "GXH_vCPRS_CAD", context.localUtil.Format(AV9cPRS_CAD, "99/99/99 99:99"));
         /* Send saved values. */
      ...
      {
         return formatLink("gx00y3.aspx") + "?" + UrlEncode(StringUtil.RTrim(AV10pUSU_COD)) + "," + UrlEncode("" +AV11pSIS_COD) + "," + UrlEncode("" +AV12pPRG_COD) + "," + UrlEncode("" +AV13pPRS_NRO) ;
      }
      ...
      protected void WB4D0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_2_4D2( true) ;
         }
         else
         {
            wb_table1_2_4D2( false) ;
         }
         return  ;
      }

      protected void wb_table1_2_4D2e( bool wbgen )
      {
         if ( wbgen )
         {
         }
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            if ( String.IsNullOrEmpty(StringUtil.RTrim( context.wjLoc)) && ( context.nUserReturn != 1 ) && ! wbErr )
            {
               ...
               if ( StringUtil.Len( sEvt) > 0 )
               {
                  ...
                  if ( ( context.localUtil.CToN( cgiGet( "GXH_vCPRS_NRO"), ",", ".") != Convert.ToDecimal( AV6cPRS_NRO )) )
                  {
                     GRID1_nFirstRecordOnPage = 0 ;
                  }
                  if ( context.localUtil.CToT( cgiGet( "GXH_vCPRS_INI")) != AV7cPRS_INI )
                  {
                     GRID1_nFirstRecordOnPage = 0 ;
                  }
                  if ( StringUtil.StrCmp(cgiGet( "GXH_vCPRS_UOB"), AV8cPRS_UOB) != 0 )
                  {
                     GRID1_nFirstRecordOnPage = 0 ;
                  }
                  if ( context.localUtil.CToT( cgiGet( "GXH_vCPRS_CAD")) != AV9cPRS_CAD )
                  {
                     GRID1_nFirstRecordOnPage = 0 ;
                  }
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 4), "LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              edtPRS_INI_Internalname = "PRS_INI_"+sGXsfl_36_idx ;
                              edtPRS_UOB_Internalname = "PRS_UOB_"+sGXsfl_36_idx ;
                              edtPRS_CAD_Internalname = "PRS_CAD_"+sGXsfl_36_idx ;
                              edtPRS_UDE_Internalname = "PRS_UDE_"+sGXsfl_36_idx ;
      ...
      protected void gxgrGrid1_refresh( int Grid1_PageSize36 ,
                                        int AV6cPRS_NRO ,
                                        DateTime AV7cPRS_INI ,
                                        String AV8cPRS_UOB ,
                                        DateTime AV9cPRS_CAD ,
                                        String AV10pUSU_COD ,
                                        short AV11pSIS_COD ,
                                        short AV12pPRG_COD )
      {
      ...
      protected void RF4D2( )
      {
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( context.wjLoc)) && ( context.nUserReturn != 1 ) )
         {
            ...
            edtSIS_COD_Internalname = "SIS_COD_"+sGXsfl_36_idx ;
            edtPRG_COD_Internalname = "PRG_COD_"+sGXsfl_36_idx ;
            lV8cPRS_UOB = StringUtil.PadR( StringUtil.RTrim( AV8cPRS_UOB), 20, "%") ;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV8cPRS_UOB", AV8cPRS_UOB);
            /* Using cursor H004D2 */
            pr_default.execute(0, new Object[] {AV10pUSU_COD, AV11pSIS_COD, AV12pPRG_COD, AV6cPRS_NRO, AV7cPRS_INI, lV8cPRS_UOB, AV9cPRS_CAD});
            nGXsfl_36_idx = 1 ;
            GRID1_nEOF = 0 ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( 10 == 0 ) || ( GRID1_nCurrentRecord < GRID1_nFirstRecordOnPage + subGrid1_Recordsperpage( ) ) ) ) )
            {
               A126PRG_COD = H004D2_A126PRG_COD[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A126PRG_COD", StringUtil.LTrim( StringUtil.Str( (decimal)(A126PRG_COD), 4, 0)));
               A116SIS_COD = H004D2_A116SIS_COD[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A116SIS_COD", StringUtil.LTrim( StringUtil.Str( (decimal)(A116SIS_COD), 3, 0)));
               A6USU_COD = H004D2_A6USU_COD[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A6USU_COD", A6USU_COD);
               A405PRS_UDE = H004D2_A405PRS_UDE[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A405PRS_UDE", A405PRS_UDE);
               A165PRS_CAD = H004D2_A165PRS_CAD[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A165PRS_CAD", context.localUtil.TToC( A165PRS_CAD, 8, 5, 0, 3, "/", ":", " "));
               A404PRS_UOB = H004D2_A404PRS_UOB[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A404PRS_UOB", A404PRS_UOB);
               A166PRS_INI = H004D2_A166PRS_INI[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A166PRS_INI", context.localUtil.TToC( A166PRS_INI, 8, 5, 0, 3, "/", ":", " "));
               A118PRS_NRO = H004D2_A118PRS_NRO[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A118PRS_NRO", StringUtil.LTrim( StringUtil.Str( (decimal)(A118PRS_NRO), 8, 0)));
               /* Execute user event: E124D2 */
               E124D2 ();
      ...
      protected int subGrid1_Recordcount( )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV8cPRS_UOB", AV8cPRS_UOB);
         /* Using cursor H004D3 */
         pr_default.execute(1, new Object[] {AV10pUSU_COD, AV11pSIS_COD, AV12pPRG_COD, AV6cPRS_NRO, AV7cPRS_INI, lV8cPRS_UOB, AV9cPRS_CAD});
         GRID1_nRecordCount = H004D3_AGRID1_nRecordCount[0] ;
         pr_default.close(1);
      ...
      protected void STRUP4D0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            {
               AV6cPRS_NRO = (int)(context.localUtil.CToN( cgiGet( edtavCprs_nro_Internalname), ",", ".")) ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV6cPRS_NRO", StringUtil.LTrim( StringUtil.Str( (decimal)(AV6cPRS_NRO), 8, 0)));
            }
            if ( context.localUtil.VCDateTime( cgiGet( edtavCprs_ini_Internalname), 4, 0) == 0 )
            {
               ...
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "GX_FocusControl", GX_FocusControl);
               wbErr = true ;
               AV7cPRS_INI = (DateTime)(DateTime.MinValue) ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV7cPRS_INI", context.localUtil.TToC( AV7cPRS_INI, 8, 5, 0, 3, "/", ":", " "));
            }
            else
            {
               AV7cPRS_INI = context.localUtil.CToT( cgiGet( edtavCprs_ini_Internalname)) ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV7cPRS_INI", context.localUtil.TToC( AV7cPRS_INI, 8, 5, 0, 3, "/", ":", " "));
            }
            AV8cPRS_UOB = cgiGet( edtavCprs_uob_Internalname) ;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV8cPRS_UOB", AV8cPRS_UOB);
            if ( context.localUtil.VCDateTime( cgiGet( edtavCprs_cad_Internalname), 4, 0) == 0 )
            {
               ...
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "GX_FocusControl", GX_FocusControl);
               wbErr = true ;
               AV9cPRS_CAD = (DateTime)(DateTime.MinValue) ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV9cPRS_CAD", context.localUtil.TToC( AV9cPRS_CAD, 8, 5, 0, 3, "/", ":", " "));
            }
            else
            {
               AV9cPRS_CAD = context.localUtil.CToT( cgiGet( edtavCprs_cad_Internalname)) ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV9cPRS_CAD", context.localUtil.TToC( AV9cPRS_CAD, 8, 5, 0, 3, "/", ":", " "));
            }
            /* Read saved values. */
      ...
      protected void E134D2( )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV13pPRS_NRO", StringUtil.LTrim( StringUtil.Str( (decimal)(AV13pPRS_NRO), 8, 0)));
         context.setWebReturnParms(new Object[] {(int)AV13pPRS_NRO});
         context.nUserReturn = 1 ;
         returnInSub = true;
         if (true) return;
      }

      protected void wb_table1_2_4D2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table2_9_4D2( true) ;
         }
         else
         {
            wb_table2_9_4D2( false) ;
         }
         return  ;
      }

      protected void wb_table2_9_4D2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table3_33_4D2( true) ;
         }
         else
         {
            wb_table3_33_4D2( false) ;
         }
         return  ;
      }

      protected void wb_table3_33_4D2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</fieldset>") ;
            ...
            wb_table1_2_4D2e( true) ;
         }
         else
         {
            wb_table1_2_4D2e( false) ;
         }
      }

      protected void wb_table3_33_4D2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            else
            {
               ...
               Grid1Container.AddColumnProperties(Grid1Column);
               Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( )) ;
               Grid1Column.AddObjectProperty("Value", StringUtil.RTrim( A405PRS_UDE));
               Grid1Container.AddColumnProperties(Grid1Column);
               Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         ...
         if ( wbEnd == 36 )
         {
            ...
            wb_table4_48_4D2( true) ;
         }
         else
         {
            wb_table4_48_4D2( false) ;
         }
         return  ;
      }

      protected void wb_table4_48_4D2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_33_4D2e( true) ;
         }
         else
         {
            wb_table3_33_4D2e( false) ;
         }
      }

      protected void wb_table4_48_4D2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            StyleString = "" ;
            GxWebStd.gx_button_ctrl( context, context.GetButtonType( ), bttBtn_cancel_Internalname, "Cancelar", "Cancelar", "", StyleString, ClassString, 1, 1, "rounded", 1, bttBtn_cancel_Jsonclick, "ECANCEL.", TempTags, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(36), 3, 0)+","+"null"+");", "", "HLP_Gx00Y3.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "</tbody>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table4_48_4D2e( true) ;
         }
         else
         {
            wb_table4_48_4D2e( false) ;
         }
      }

      protected void wb_table2_9_4D2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblockprs_nro_Internalname, 1, 1, 0, "NRO DE SESION ASIGNADA", "", "", "", 0, lblTextblockprs_nro_Jsonclick, "", StyleString, ClassString, "HLP_Gx00Y3.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            ...
            StyleString = "" ;
            GxWebStd.gx_single_line_edit( context, edtavCprs_nro_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6cPRS_NRO), 8, 0, ",", "")), "", 8, "chr", 1, "row", 8, 1, 1, 0, 0, 0, "", "", StyleString, ClassString, "", context.localUtil.Format( (decimal)(AV6cPRS_NRO), "ZZZZZZZ9"), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(14);\"", 0, edtavCprs_nro_Jsonclick, "", 0, 1, -1, true, "right", "HLP_Gx00Y3.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            ...
            ClassString = "TextBlock" ;
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblockprs_ini_Internalname, 1, 1, 0, "MOMENTO DE INICIO SESION", "", "", "", 0, lblTextblockprs_ini_Jsonclick, "", StyleString, ClassString, "HLP_Gx00Y3.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            ...
            GxWebStd.gx_single_line_edit( context, edtavCprs_ini_Internalname, context.localUtil.Format(AV7cPRS_INI, "99/99/99 99:99"), "", 14, "chr", 1, "row", 14, 1, 1, 0, 0, 0, "", "", StyleString, ClassString, "", context.localUtil.Format( AV7cPRS_INI, "99/99/99 99:99"), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.date.valid_date(this, 8,'DMY',5,24,'spa',false,0);"+";gx.evt.onblur(19);\"", 0, edtavCprs_ini_Jsonclick, "", 0, 1, -1, true, "right", "HLP_Gx00Y3.htm");
            GxWebStd.gx_bitmap( context, edtavCprs_ini_Internalname+"_dp_trigger", "", "calendar-img.gif", "", ((1==0)||(1==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, "", "", 0, "", "", "cursor: pointer;vertical-align:text-bottom", "", "", "", "", "", "HLP_Gx00Y3.htm");
            ...
            ClassString = "TextBlock" ;
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblockprs_uob_Internalname, 1, 1, 0, "ULTIMO OBJETO", "", "", "", 0, lblTextblockprs_uob_Jsonclick, "", StyleString, ClassString, "HLP_Gx00Y3.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            ...
            ClassString = "Attribute" ;
            StyleString = "" ;
            GxWebStd.gx_single_line_edit( context, edtavCprs_uob_Internalname, StringUtil.RTrim( AV8cPRS_UOB), "", 20, "chr", 1, "row", 20, 1, 1, 0, 0, 0, "", "", StyleString, ClassString, "", StringUtil.RTrim( context.localUtil.Format( AV8cPRS_UOB, "XXXXXXXXXXXXXXXXXXXX")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(24);\"", 0, edtavCprs_uob_Jsonclick, "", 0, 1, -1, true, "left", "HLP_Gx00Y3.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            ...
            ClassString = "TextBlock" ;
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblockprs_cad_Internalname, 1, 1, 0, "MOMENTO CADUCIDAD SESION", "", "", "", 0, lblTextblockprs_cad_Jsonclick, "", StyleString, ClassString, "HLP_Gx00Y3.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            ...
            GxWebStd.gx_single_line_edit( context, edtavCprs_cad_Internalname, context.localUtil.Format(AV9cPRS_CAD, "99/99/99 99:99"), "", 14, "chr", 1, "row", 14, 1, 1, 0, 0, 0, "", "", StyleString, ClassString, "", context.localUtil.Format( AV9cPRS_CAD, "99/99/99 99:99"), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.date.valid_date(this, 8,'DMY',5,24,'spa',false,0);"+";gx.evt.onblur(29);\"", 0, edtavCprs_cad_Jsonclick, "", 0, 1, -1, true, "right", "HLP_Gx00Y3.htm");
            GxWebStd.gx_bitmap( context, edtavCprs_cad_Internalname+"_dp_trigger", "", "calendar-img.gif", "", ((1==0)||(1==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, "", "", 0, "", "", "cursor: pointer;vertical-align:text-bottom", "", "", "", "", "", "HLP_Gx00Y3.htm");
            context.WriteHtmlTextNl( "</div>") ;
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "</tbody>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_9_4D2e( true) ;
         }
         else
         {
            wb_table2_9_4D2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( Form.Jscriptsrc.Item(idxLst)), "?118137");
            idxLst = (int)(idxLst+1) ;
         }
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx00y3.js", "?118137");
      ...
      protected void sendrow_362( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_36_idx <= subGrid1_Recordsperpage( ) * 1 ) )
         {
            ...
            edtavLinkselection_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A118PRS_NRO), 8, 0, ",", "")))+"'"+"]);" ;
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "" ;
         lV8cPRS_UOB = "" ;
         H004D2_A126PRG_COD = new short[1] ;
         H004D2_A116SIS_COD = new short[1] ;
         H004D2_A6USU_COD = new String[] {""} ;
         H004D2_A405PRS_UDE = new String[] {""} ;
         H004D2_A165PRS_CAD = new DateTime[] {DateTime.MinValue} ;
         H004D2_A404PRS_UOB = new String[] {""} ;
         H004D2_A166PRS_INI = new DateTime[] {DateTime.MinValue} ;
         H004D2_A118PRS_NRO = new int[1] ;
         H004D3_AGRID1_nRecordCount = new int[1] ;
         sStyleString = "" ;
         ClassString = "" ;
         StyleString = "" ;
         subGrid1_Linesclass = "" ;
         ...
         ROClassString = "" ;
         GXt_char10 = "" ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx00y3__default(),
            new Object[][] {
                new Object[] {
               H004D2_A126PRG_COD, H004D2_A116SIS_COD, H004D2_A6USU_COD, H004D2_A405PRS_UDE, H004D2_A165PRS_CAD, H004D2_A404PRS_UOB, H004D2_A166PRS_INI, H004D2_A118PRS_NRO
               }
               , new Object[] {
               H004D3_AGRID1_nRecordCount
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private short wcpOAV12pPRG_COD ;
      ...
      private DateTime AV7cPRS_INI ;
      private DateTime AV9cPRS_CAD ;
      ...
      private short[] H004D2_A126PRG_COD ;
      private short[] H004D2_A116SIS_COD ;
      private String[] H004D2_A6USU_COD ;
      private String[] H004D2_A405PRS_UDE ;
      private DateTime[] H004D2_A165PRS_CAD ;
      private String[] H004D2_A404PRS_UOB ;
      private DateTime[] H004D2_A166PRS_INI ;
      private int[] H004D2_A118PRS_NRO ;
      private int[] H004D3_AGRID1_nRecordCount ;
   ...
   public class gx00y3__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV12pPRG_COD",SqlDbType.SmallInt,4,0} ,
          new Object[] {"@AV6cPRS_NRO",SqlDbType.Int,8,0} ,
          new Object[] {"@AV7cPRS_INI",SqlDbType.DateTime,8,5} ,
          new Object[] {"@AV8cPRS_UOB",SqlDbType.Char,20,0} ,
          new Object[] {"@AV9cPRS_CAD",SqlDbType.DateTime,8,5}
          } ;
          Object[] prmH004D3 ;
          ...
          def= new CursorDef[] {
              new CursorDef("H004D2", "SELECT [PRG_COD], [SIS_COD], [USU_COD], [PRS_UDE], [PRS_CAD], [PRS_UOB], [PRS_INI], [PRS_NRO] FROM [SEG006] WITH (NOLOCK) WHERE ([USU_COD] = @AV10pUSU_COD and [SIS_COD] = @AV11pSIS_COD and [PRG_COD] = @AV12pPRG_COD and [PRS_NRO] >= @AV6cPRS_NRO) AND ([PRS_INI] >= @AV7cPRS_INI) AND ([PRS_UOB] like @AV8cPRS_UOB) AND ([PRS_CAD] >= @AV9cPRS_CAD) ORDER BY [USU_COD], [SIS_COD], [PRG_COD], [PRS_NRO]  OPTION (FAST 11)",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004D2,11,1,false,false )
             ,new CursorDef("H004D3", "SELECT COUNT(*) FROM [SEG006] WITH (NOLOCK) WHERE ([USU_COD] = @AV10pUSU_COD and [SIS_COD] = @AV11pSIS_COD and [PRG_COD] = @AV12pPRG_COD and [PRS_NRO] >= @AV6cPRS_NRO) AND ([PRS_INI] >= @AV7cPRS_INI) AND ([PRS_UOB] like @AV8cPRS_UOB) AND ([PRS_CAD] >= @AV9cPRS_CAD) ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004D3,1,1,false,false )
          };
       }
    }
