/*
       ...
       Generated on: 4/2/2014 19:30:5.79
...
namespace GeneXus.Programs {
   public class ttbus002_det : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void CheckExtendedTable0A10( )
      {
         ...
         {
            GX_msglist.addItem("No existe 'Cabecera de Movimientos de Bienes de Uso'.", "ForeignKeyNotFound", 1, "TTBUS2_IDMOVIMIENTO");
            AnyError = 1 ;
            GX_FocusControl = edtTTBUS2_IdMovimiento_Internalname ;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "GX_FocusControl", GX_FocusControl);
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( Form.Jscriptsrc.Item(idxLst)), "?1930655");
            idxLst = (int)(idxLst+1) ;
         }
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("ttbus002_det.js", "?1930655");
