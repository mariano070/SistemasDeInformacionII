/*
       ...
       Generated on: 1/6/2014 11:8:32.73
...
namespace GeneXus.Programs {
   public class tseg002permisoswc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public tseg002permisoswc( )
      {
      ...
      public tseg002permisoswc( IGxContext context )
      {
         ...
         if ( StringUtil.Len( (String)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
               {
                  ...
                  gxgrGrid_refresh( Grid_PageSize12, AV7TTBUS7_CodUsuario, AV13Delete, AV12Update, sPrefix) ;
                  return  ;
               }
               else
               {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.WriteHtmlText( "TSEG002 Permisos WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" onsubmit=\"try{return gx.csv.validForm()}catch(e){return true;}\" name=\"MAINFORM\" method=\"post\" action=\""+formatLink("tseg002permisoswc.aspx") + "?" + UrlEncode(StringUtil.RTrim(AV7TTBUS7_CodUsuario))+"\" class=\""+"Form"+"\">") ;
      ...
      protected void RenderHtmlCloseForm0L2( )
      {
         ...
         {
            context.AddJavascriptSource("tseg002permisoswc.js", "?1183279");
         }
      ...
      protected void WB0L0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "tseg002permisoswc.aspx");
            }
      ...
      protected void START0L2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("Description", "TSEG002 Permisos WC", 0) ;
            context.wjLoc = "" ;
      ...
      protected void RF0L2( )
      {
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( context.wjLoc)) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A39TTBUS7_CodUsuario = H000L2_A39TTBUS7_CodUsuario[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A39TTBUS7_CodUsuario", A39TTBUS7_CodUsuario);
               A198TTBUS7_RSR = H000L2_A198TTBUS7_RSR[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A198TTBUS7_RSR", StringUtil.Str( (decimal)(A198TTBUS7_RSR), 1, 0));
               A36TTBUS7_DesResp = H000L2_A36TTBUS7_DesResp[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A36TTBUS7_DesResp", A36TTBUS7_DesResp);
               n36TTBUS7_DesResp = H000L2_n36TTBUS7_DesResp[0] ;
               A35TTBUS7_CodResp = H000L2_A35TTBUS7_CodResp[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A35TTBUS7_CodResp", A35TTBUS7_CodResp);
               A34TTBUS7_Des = H000L2_A34TTBUS7_Des[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A34TTBUS7_Des", A34TTBUS7_Des);
               n34TTBUS7_Des = H000L2_n34TTBUS7_Des[0] ;
               A33TTBUS7_Pos = H000L2_A33TTBUS7_Pos[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A33TTBUS7_Pos", StringUtil.LTrim( StringUtil.Str( (decimal)(A33TTBUS7_Pos), 3, 0)));
               A198TTBUS7_RSR = H000L2_A198TTBUS7_RSR[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A198TTBUS7_RSR", StringUtil.Str( (decimal)(A198TTBUS7_RSR), 1, 0));
               A35TTBUS7_CodResp = H000L2_A35TTBUS7_CodResp[0] ;
      ...
      protected void wb_table1_2_0L2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table2_5_0L2( true) ;
         }
         else
         {
            wb_table2_5_0L2( false) ;
         }
         return  ;
      }

      protected void wb_table2_5_0L2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
      ...
      protected void wb_table2_5_0L2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            StyleString = "" ;
            GxWebStd.gx_bitmap( context, imgInsert_Internalname, "", context.GetImagePath( "5649fbb8-8ce0-4810-a5ce-bd649ea83c3a", "", "Modern"), "Modern", 1, 1, "", "Agrega", 0, 0, 0, "", 0, "", 0, 0, "", "", 5, imgInsert_Jsonclick, sPrefix+"E\\'DOINSERT\\'.", StyleString, ClassString, "", ""+TempTags, "", "", "HLP_TSEG002PermisosWC.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
         ...
         if ( wbEnd == 12 )
         {
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_5_0L2e( true) ;
         }
         else
         {
            wb_table2_5_0L2e( false) ;
         }
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "tseg002permisoswc");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( Form.Jscriptsrc.Item(idxLst)), "?1183329");
            idxLst = (int)(idxLst+1) ;
         }
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("tseg002permisoswc.js", "?1183329");
         }
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "" ;
         H000L2_A39TTBUS7_CodUsuario = new String[] {""} ;
         H000L2_A198TTBUS7_RSR = new short[1] ;
         H000L2_A36TTBUS7_DesResp = new String[] {""} ;
         H000L2_n36TTBUS7_DesResp = new bool[] {false} ;
         H000L2_A35TTBUS7_CodResp = new String[] {""} ;
         H000L2_A34TTBUS7_Des = new String[] {""} ;
         H000L2_n34TTBUS7_Des = new bool[] {false} ;
         H000L2_A33TTBUS7_Pos = new short[1] ;
         H000L3_AGRID_nRecordCount = new int[1] ;
         AV10TrnContext = new SdtTransactionContext(context);
         ...
         ROClassString = "" ;
         GXt_char8 = "" ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.tseg002permisoswc__default(),
            new Object[][] {
                new Object[] {
               H000L2_A39TTBUS7_CodUsuario, H000L2_A198TTBUS7_RSR, H000L2_A36TTBUS7_DesResp, H000L2_n36TTBUS7_DesResp, H000L2_A35TTBUS7_CodResp, H000L2_A34TTBUS7_Des, H000L2_n34TTBUS7_Des, H000L2_A33TTBUS7_Pos
               }
               , new Object[] {
      ...
      private String[] H000L2_A39TTBUS7_CodUsuario ;
      private short[] H000L2_A198TTBUS7_RSR ;
      private String[] H000L2_A36TTBUS7_DesResp ;
      private bool[] H000L2_n36TTBUS7_DesResp ;
      private String[] H000L2_A35TTBUS7_CodResp ;
      private String[] H000L2_A34TTBUS7_Des ;
      private bool[] H000L2_n34TTBUS7_Des ;
      private short[] H000L2_A33TTBUS7_Pos ;
      private int[] H000L3_AGRID_nRecordCount ;
   ...
   public class tseg002permisoswc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000L2", "SELECT T1.[TTBUS7_CodUsuario], T2.[TTBUS7_RSR], T3.[USU_DES] AS TTBUS7_DesResp, T2.[TTBUS7_CodResp] AS TTBUS7_CodResp, T4.[W53DES] AS TTBUS7_Des, T1.[TTBUS7_Pos] AS TTBUS7_Pos FROM ((([TTBUS007Permisos] T1 WITH (NOLOCK) INNER JOIN [TTBUS007] T2 WITH (NOLOCK) ON T2.[TTBUS7_Pos] = T1.[TTBUS7_Pos]) INNER JOIN [SEG002] T3 WITH (NOLOCK) ON T3.[USU_COD] = T2.[TTBUS7_CodResp]) INNER JOIN [T53FPOS] T4 WITH (NOLOCK) ON T4.[W53POS] = T1.[TTBUS7_Pos]) WHERE T1.[TTBUS7_CodUsuario] = @AV7TTBUS7_CodUsuario ORDER BY T1.[TTBUS7_Pos], T1.[TTBUS7_CodUsuario] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000L2,11,0,true,false )
             ,new CursorDef("H000L3", "SELECT COUNT(*) FROM ((([TTBUS007Permisos] T1 WITH (NOLOCK) INNER JOIN [TTBUS007] T2 WITH (NOLOCK) ON T2.[TTBUS7_Pos] = T1.[TTBUS7_Pos]) INNER JOIN [SEG002] T3 WITH (NOLOCK) ON T3.[USU_COD] = T2.[TTBUS7_CodResp]) INNER JOIN [T53FPOS] T4 WITH (NOLOCK) ON T4.[W53POS] = T1.[TTBUS7_Pos]) WHERE T1.[TTBUS7_CodUsuario] = @AV7TTBUS7_CodUsuario ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000L3,1,0,true,false )
          };
       }
    }
