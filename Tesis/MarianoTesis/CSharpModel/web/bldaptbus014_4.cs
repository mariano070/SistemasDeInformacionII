...
using System.IO;
public class bldaptbus014_4 : GxBaseBuilder
{
   string cs_path = "." ;
   public bldaptbus014_4( ) : base()
   {
   }
   ...
   {
      bldaptbus014_4 x = new bldaptbus014_4() ;
      x.SetMainSourceFile( "aptbus014_4.cs");
   ...
   {
      ItemCollection sc = new ItemCollection() ;
      sc.Add( @"bin\aptbus014_4.dll", cs_path + @"\aptbus014_4.rsp");
      return sc ;
   }
