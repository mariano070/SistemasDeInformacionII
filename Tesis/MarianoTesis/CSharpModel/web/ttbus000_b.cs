/*
       ...
       Generated on: 4/2/2014 19:29:8.96
...
namespace GeneXus.Programs {
   public class ttbus000_b : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( Form.Jscriptsrc.Item(idxLst)), "?1929960");
            idxLst = (int)(idxLst+1) ;
         }
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("ttbus000_b.js", "?1929960");
