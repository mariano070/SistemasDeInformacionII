...
using System.IO;
public class bldaptbus014_3 : GxBaseBuilder
{
   string cs_path = "." ;
   public bldaptbus014_3( ) : base()
   {
   }
   ...
   {
      bldaptbus014_3 x = new bldaptbus014_3() ;
      x.SetMainSourceFile( "aptbus014_3.cs");
   ...
   {
      ItemCollection sc = new ItemCollection() ;
      sc.Add( @"bin\aptbus014_3.dll", cs_path + @"\aptbus014_3.rsp");
      return sc ;
   }
