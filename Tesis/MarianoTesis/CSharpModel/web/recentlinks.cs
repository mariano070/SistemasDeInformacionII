/*
       ...
       Generated on: 4/2/2014 19:29:58.50
...
namespace GeneXus.Programs {
   public class recentlinks : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
         ...
         if ( StringUtil.Len( (String)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Links") == 0 )
               {
                  ...
                  gxgrLinks_refresh( AV6FormCaption, AV7FormPgmName, AV11RecentLinksItems, sPrefix) ;
                  return  ;
               }
               else
               {
      ...
      protected void RenderHtmlCloseForm022( )
      {
         ...
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri(sPrefix, false, sPrefix+"vRECENTLINKSITEMS", (Object)(AV11RecentLinksItems));
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt(sPrefix+"vRECENTLINKSITEMS", (Object)(AV11RecentLinksItems));
         }
         if ( ( StringUtil.Len( sPrefix) != 0 ) && context.isAjaxRequest( ) )
         {
            context.AddJavascriptSource("recentlinks.js", "?19295853");
         }
      ...
      private void E11022( )
      {
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV7FormPgmName)) || ( StringUtil.StrCmp(StringUtil.Substring( AV7FormPgmName, 1, 1), "T") != 0 ) )
         {
            AV9i = 1 ;
            while ( AV9i <= AV11RecentLinksItems.Count )
            {
               AV12RecentLinksItem = ((SdtRecentLinksItems_RecentLinksItem)AV11RecentLinksItems.Item(AV9i)) ;
            ...
            AV12RecentLinksItem = new SdtRecentLinksItems_RecentLinksItem(context) ;
            ...
            AV8Session.Set("RecentLinks", AV11RecentLinksItems.ToXml(false, "RecentLinksItems", "MarianoTesis"));
         }
         AV9i = 1 ;
         while ( AV9i <= AV11RecentLinksItems.Count )
         {
      ...
      protected void wb_table1_2_022( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblRecenttext_Internalname, 1, 1, 0, "Recientes: ", "", "", "", 0, lblRecenttext_Jsonclick, "", StyleString, ClassString, "HLP_RecentLinks.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /*  Grid Control  */
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( Form.Jscriptsrc.Item(idxLst)), "?19295864");
            idxLst = (int)(idxLst+1) ;
         }
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("recentlinks.js", "?19295864");
         }
      ...
      public override void initialize( )
      {
         ...
         gxfirstwebparm_bkp = "" ;
         sPrefix = "" ;
         AV11RecentLinksItems = new GxObjectCollection( context, "RecentLinksItems.RecentLinksItem", "MarianoTesis", "SdtRecentLinksItems_RecentLinksItem", "GeneXus.Programs");
         sDynURL = "" ;
         FormProcess = "" ;
         GXt_char1 = "" ;
         GXt_char2 = "" ;
      ...
      [ObjectCollection(ItemType=typeof( SdtRecentLinksItems_RecentLinksItem ))]
      private IGxCollection AV11RecentLinksItems ;
      private SdtRecentLinksItems_RecentLinksItem AV12RecentLinksItem ;
   }
