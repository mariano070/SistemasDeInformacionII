/*
       ...
       Generated on: 12/17/2013 16:18:1.97
...
namespace GeneXus.Programs {
   public class gx0260 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" onsubmit=\"try{return gx.csv.validForm()}catch(e){return true;}\" name=\"MAINFORM\" method=\"post\" action=\""+formatLink("gx0260.aspx") +"\" class=\""+""+"\">") ;
      ...
      protected void START222( )
      {
         ...
         Form.Meta.addItem("Description", "Gx0260", 0) ;
         context.wjLoc = "" ;
      ...
      {
         AddThemeStyleSheetFile("", "GeneXusX.css", "?15413537");
         idxLst = 1 ;
         while ( idxLst <= Form.Jscriptsrc.Count )
         {
            context.AddJavascriptSource(StringUtil.RTrim( Form.Jscriptsrc.Item(idxLst)), "?161822");
            idxLst = (int)(idxLst+1) ;
         }
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("gx0260.js", "?161822");
         }
