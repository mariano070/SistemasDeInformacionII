...
using System.IO;
public class bldaptbus020 : GxBaseBuilder
{
   string cs_path = "." ;
   public bldaptbus020( ) : base()
   {
   }
   ...
   {
      bldaptbus020 x = new bldaptbus020() ;
      x.SetMainSourceFile( "aptbus020.cs");
   ...
   {
      ItemCollection sc = new ItemCollection() ;
      sc.Add( @"bin\aptbus020.dll", cs_path + @"\aptbus020.rsp");
      return sc ;
   }
