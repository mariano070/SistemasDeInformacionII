/*
       ...
       Generated on: 4/2/2014 19:29:11.94
...
namespace GeneXus.Programs {
   public class ttbus002_c : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( Form.Jscriptsrc.Item(idxLst)), "?19291236");
            idxLst = (int)(idxLst+1) ;
         }
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("ttbus002_c.js", "?19291236");
