/*
       ...
       Generated on: 4/2/2014 19:29:47.23
...
namespace GeneXus.Programs {
   public class hmaster_seg_p : GXMasterPage, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlCloseForm0E2( )
      {
         ...
         context.AddJavascriptSource("hmaster_seg_p.js", "?19294724");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( getDataAreaObject().GetForm().Jscriptsrc.Item(idxLst)), "?19294726");
            idxLst = (int)(idxLst+1) ;
         }
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("hmaster_seg_p.js", "?19294726");
         }
