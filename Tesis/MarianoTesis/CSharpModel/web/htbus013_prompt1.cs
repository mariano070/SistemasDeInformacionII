/*
       ...
       Generated on: 4/2/2014 19:29:25.87
...
namespace GeneXus.Programs {
   public class htbus013_prompt1 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( Form.Jscriptsrc.Item(idxLst)), "?19292630");
            idxLst = (int)(idxLst+1) ;
         }
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("htbus013_prompt1.js", "?19292631");
