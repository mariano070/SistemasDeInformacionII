...
using System.IO;
public class bldaptbus150 : GxBaseBuilder
{
   string cs_path = "." ;
   public bldaptbus150( ) : base()
   {
   }
   ...
   {
      bldaptbus150 x = new bldaptbus150() ;
      x.SetMainSourceFile( "aptbus150.cs");
   ...
   {
      ItemCollection sc = new ItemCollection() ;
      sc.Add( @"bin\aptbus150.dll", cs_path + @"\aptbus150.rsp");
      return sc ;
   }
