/*
               File: HTBUS011
        Description: Listado de bienes en envío no confirmado
             Author: GeneXus C# Generator version 10_1_5-42940
       Generated on: 3/17/2014 13:22:30.70
...
namespace GeneXus.Programs {
   public class htbus011 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public htbus011( )
      {
      ...
      public htbus011( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" onsubmit=\"try{return gx.csv.validForm()}catch(e){return true;}\" name=\"MAINFORM\" method=\"post\" action=\""+formatLink("htbus011.aspx") + "?" + UrlEncode(StringUtil.RTrim(AV7SISTEMA)) + "," + UrlEncode(StringUtil.RTrim(AV6USUARIO))+"\" class=\""+"Form"+"\">") ;
      ...
      {
         return "Listado de bienes en envío no confirmado" ;
      }
      ...
      {
         return formatLink("htbus011.aspx") + "?" + UrlEncode(StringUtil.RTrim(AV7SISTEMA)) + "," + UrlEncode(StringUtil.RTrim(AV6USUARIO)) ;
      }
      ...
      protected void START1A2( )
      {
         ...
         Form.Meta.addItem("Description", "Listado de bienes en envío no confirmado", 0) ;
         context.wjLoc = "" ;
      ...
      {
         /* Start Routine */
         new loadcontext(context ).execute( out  AV8Context) ;
         AV6USUARIO = AV8Context.gxTpr_User ;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV6USUARIO", AV6USUARIO);
      }
      ...
      protected void E121A2( )
      {
         ...
         context.wjLoc = formatLink("aptbus011.aspx") + "?" + UrlEncode(StringUtil.RTrim(AV6USUARIO)) + "," + UrlEncode(StringUtil.RTrim(AV5NOMBRE_REPORTE)) ;
      }
      ...
      protected void wb_table1_2_1A2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            sStyleString = sStyleString + " width: " + StringUtil.LTrim( StringUtil.Str( (decimal)(766), 10, 0)) + "px" + ";" ;
            ...
            ClassString = "Button" ;
            StyleString = "" ;
            GxWebStd.gx_button_ctrl( context, context.GetButtonType( ), bttButton1_Internalname, "Confirmar", "Confirmar", "", StyleString, ClassString, 1, 1, "rounded", 5, bttButton1_Jsonclick, "EENTER.", TempTags, "", "", "HLP_HTBUS011.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( Form.Jscriptsrc.Item(idxLst)), "?13223076");
            idxLst = (int)(idxLst+1) ;
         }
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("htbus011.js", "?13223076");
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Listado de bienes en envío no confirmado" ;
      ...
      public override void initialize( )
      {
         ...
         EvtRowId = "" ;
         sEvtType = "" ;
         AV8Context = new SdtContext(context);
         AV5NOMBRE_REPORTE = "" ;
         sStyleString = "" ;
         GXt_char3 = "" ;
         ClassString = "" ;
