/*
       ...
       Generated on: 2/26/2014 11:47:3.28
...
namespace GeneXus.Programs {
   public class hseg001_p : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( Form.Jscriptsrc.Item(idxLst)), "?1147347");
            idxLst = (int)(idxLst+1) ;
         }
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("hseg001_p.js", "?1147347");
