/*
       ...
       Generated on: 2/26/2014 11:47:13.88
...
namespace GeneXus.Programs {
   public class tabbedview : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlCloseForm062( )
      {
         ...
         {
            context.AddJavascriptSource("tabbedview.js", "?11471390");
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( Form.Jscriptsrc.Item(idxLst)), "?1147140");
            idxLst = (int)(idxLst+1) ;
         }
      ...
      {
         context.AddJavascriptSource("tabbedview.js", "?1147140");
