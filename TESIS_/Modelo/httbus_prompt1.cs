/*
       ...
       Generated on: 3/17/2014 13:22:5.51
...
namespace GeneXus.Programs {
   public class httbus_prompt1 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( Form.Jscriptsrc.Item(idxLst)), "?1322595");
            idxLst = (int)(idxLst+1) ;
         }
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("httbus_prompt1.js", "?1322595");
