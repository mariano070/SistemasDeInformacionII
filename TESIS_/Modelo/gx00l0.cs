/*
       ...
       Generated on: 2/5/2014 11:30:50.14
...
namespace GeneXus.Programs {
   public class gx00l0 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
                           ...
                           out short aP2_pPRG_COD )
      {
         ...
         this.AV14pPRG_COD = 0 ;
         executePrivate();
         aP0_pUSU_COD=this.AV12pUSU_COD;
         aP1_pSIS_COD=this.AV13pSIS_COD;
         aP2_pPRG_COD=this.AV14pPRG_COD;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
            {
               ...
               gxgrGrid1_refresh( Grid1_PageSize31, AV6cUSU_COD, AV7cSIS_COD, AV8cPRG_COD) ;
               return  ;
            }
            else
            {
            ...
            if ( ! entryPointCalled )
            {
               AV12pUSU_COD = gxfirstwebparm ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV12pUSU_COD", AV12pUSU_COD);
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  AV13pSIS_COD = (short)(NumberUtil.Val( GetNextPar( ), ".")) ;
                  context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV13pSIS_COD", StringUtil.LTrim( StringUtil.Str( (decimal)(AV13pSIS_COD), 3, 0)));
                  AV14pPRG_COD = (short)(NumberUtil.Val( GetNextPar( ), ".")) ;
                  context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV14pPRG_COD", StringUtil.LTrim( StringUtil.Str( (decimal)(AV14pPRG_COD), 4, 0)));
               }
            }
         }
         context.SetTheme("Modern");
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" onsubmit=\"try{return gx.csv.validForm()}catch(e){return true;}\" name=\"MAINFORM\" method=\"post\" action=\""+formatLink("gx00l0.aspx") + "?" + UrlEncode(StringUtil.RTrim(AV12pUSU_COD)) + "," + UrlEncode("" +AV13pSIS_COD) + "," + UrlEncode("" +AV14pPRG_COD)+"\" class=\""+"Form"+"\">") ;
      ...
      public override void RenderHtmlCloseForm( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vPUSU_COD", StringUtil.RTrim( AV12pUSU_COD));
         GxWebStd.gx_hidden_field( context, "vPSIS_COD", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV13pSIS_COD), 3, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "vPPRG_COD", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV14pPRG_COD), 4, 0, ",", "")));
      ...
      {
         return formatLink("gx00l0.aspx") + "?" + UrlEncode(StringUtil.RTrim(AV12pUSU_COD)) + "," + UrlEncode("" +AV13pSIS_COD) + "," + UrlEncode("" +AV14pPRG_COD) ;
      }
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 4), "LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              edtUSU_COD_Internalname = "USU_COD_"+sGXsfl_31_idx ;
      ...
      protected void RF2N2( )
      {
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( context.wjLoc)) && ( context.nUserReturn != 1 ) )
         {
            ...
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV6cUSU_COD", AV6cUSU_COD);
            /* Using cursor H002N2 */
            pr_default.execute(0, new Object[] {lV6cUSU_COD, AV7cSIS_COD, AV8cPRG_COD});
            nGXsfl_31_idx = 1 ;
            GRID1_nEOF = 0 ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( 10 == 0 ) || ( GRID1_nCurrentRecord < GRID1_nFirstRecordOnPage + subGrid1_Recordsperpage( ) ) ) ) )
            {
               A126PRG_COD = H002N2_A126PRG_COD[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A126PRG_COD", StringUtil.LTrim( StringUtil.Str( (decimal)(A126PRG_COD), 4, 0)));
               A116SIS_COD = H002N2_A116SIS_COD[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A116SIS_COD", StringUtil.LTrim( StringUtil.Str( (decimal)(A116SIS_COD), 3, 0)));
               A6USU_COD = H002N2_A6USU_COD[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A6USU_COD", A6USU_COD);
               /* Execute user event: E122N2 */
               E122N2 ();
      ...
      protected int subGrid1_Recordcount( )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV6cUSU_COD", AV6cUSU_COD);
         /* Using cursor H002N3 */
         pr_default.execute(1, new Object[] {lV6cUSU_COD, AV7cSIS_COD, AV8cPRG_COD});
      ...
      protected void STRUP2N0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV12pUSU_COD = cgiGet( "vPUSU_COD") ;
            AV13pSIS_COD = (short)(context.localUtil.CToN( cgiGet( "vPSIS_COD"), ",", ".")) ;
            AV14pPRG_COD = (short)(context.localUtil.CToN( cgiGet( "vPPRG_COD"), ",", ".")) ;
      ...
      {
         /* Enter Routine */
         AV12pUSU_COD = A6USU_COD ;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV12pUSU_COD", AV12pUSU_COD);
         AV13pSIS_COD = A116SIS_COD ;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV13pSIS_COD", StringUtil.LTrim( StringUtil.Str( (decimal)(AV13pSIS_COD), 3, 0)));
         AV14pPRG_COD = A126PRG_COD ;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV14pPRG_COD", StringUtil.LTrim( StringUtil.Str( (decimal)(AV14pPRG_COD), 4, 0)));
         context.setWebReturnParms(new Object[] {(String)AV12pUSU_COD,(short)AV13pSIS_COD,(short)AV14pPRG_COD});
      ...
      protected void wb_table1_2_2N2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table2_9_2N2( true) ;
         }
         else
         {
            wb_table2_9_2N2( false) ;
         }
         return  ;
      }

      protected void wb_table2_9_2N2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table3_28_2N2( true) ;
         }
         else
         {
            wb_table3_28_2N2( false) ;
         }
         return  ;
      }

      protected void wb_table3_28_2N2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</fieldset>") ;
      ...
      protected void wb_table3_28_2N2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
         ...
         if ( wbEnd == 31 )
         {
            ...
            wb_table4_38_2N2( true) ;
         }
         else
         {
            wb_table4_38_2N2( false) ;
         }
         return  ;
      }

      protected void wb_table4_38_2N2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_28_2N2e( true) ;
         }
         else
         {
            wb_table3_28_2N2e( false) ;
         }
      }

      protected void wb_table4_38_2N2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            StyleString = "" ;
            GxWebStd.gx_button_ctrl( context, context.GetButtonType( ), bttBtn_cancel_Internalname, "Cancelar", "Cancelar", "", StyleString, ClassString, 1, 1, "rounded", 1, bttBtn_cancel_Jsonclick, "ECANCEL.", TempTags, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(31), 3, 0)+","+"null"+");", "", "HLP_Gx00L0.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "</tbody>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table4_38_2N2e( true) ;
         }
         else
         {
            wb_table4_38_2N2e( false) ;
         }
      }

      protected void wb_table2_9_2N2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblockusu_cod_Internalname, 1, 1, 0, "CODIGO", "", "", "", 0, lblTextblockusu_cod_Jsonclick, "", StyleString, ClassString, "HLP_Gx00L0.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            ...
            ClassString = "TextBlock" ;
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblocksis_cod_Internalname, 1, 1, 0, "CODIGO", "", "", "", 0, lblTextblocksis_cod_Jsonclick, "", StyleString, ClassString, "HLP_Gx00L0.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            ...
            ClassString = "Attribute" ;
            StyleString = "" ;
            GxWebStd.gx_single_line_edit( context, edtavCsis_cod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV7cSIS_COD), 3, 0, ",", "")), "", 3, "chr", 1, "row", 3, 1, 1, 0, 0, 0, "", "", StyleString, ClassString, "", context.localUtil.Format( (decimal)(AV7cSIS_COD), "ZZ9"), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(19);\"", 0, edtavCsis_cod_Jsonclick, "", 0, 1, -1, true, "right", "HLP_Gx00L0.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            ...
            ClassString = "TextBlock" ;
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblockprg_cod_Internalname, 1, 1, 0, "CODIGO", "", "", "", 0, lblTextblockprg_cod_Jsonclick, "", StyleString, ClassString, "HLP_Gx00L0.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            ...
            ClassString = "Attribute" ;
            StyleString = "" ;
            GxWebStd.gx_single_line_edit( context, edtavCprg_cod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8cPRG_COD), 4, 0, ",", "")), "", 4, "chr", 1, "row", 4, 1, 1, 0, 0, 0, "", "", StyleString, ClassString, "", context.localUtil.Format( (decimal)(AV8cPRG_COD), "ZZZ9"), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(24);\"", 0, edtavCprg_cod_Jsonclick, "", 0, 1, -1, true, "right", "HLP_Gx00L0.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "</tbody>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_9_2N2e( true) ;
         }
         else
         {
            wb_table2_9_2N2e( false) ;
         }
      }
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV12pUSU_COD = (String)getParm(obj,0) ;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV12pUSU_COD", AV12pUSU_COD);
         AV13pSIS_COD = Convert.ToInt16(getParm(obj,1)) ;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV13pSIS_COD", StringUtil.LTrim( StringUtil.Str( (decimal)(AV13pSIS_COD), 3, 0)));
         AV14pPRG_COD = Convert.ToInt16(getParm(obj,2)) ;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV14pPRG_COD", StringUtil.LTrim( StringUtil.Str( (decimal)(AV14pPRG_COD), 4, 0)));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( Form.Jscriptsrc.Item(idxLst)), "?11305043");
            idxLst = (int)(idxLst+1) ;
         }
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx00l0.js", "?11305043");
      ...
      protected void sendrow_312( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_31_idx <= subGrid1_Recordsperpage( ) * 1 ) )
         {
            ...
            edtavLinkselection_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.RTrim( A6USU_COD))+"'"+", "+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A116SIS_COD), 3, 0, ",", "")))+"'"+", "+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A126PRG_COD), 4, 0, ",", "")))+"'"+"]);" ;
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "" ;
         lV6cUSU_COD = "" ;
         H002N2_A126PRG_COD = new short[1] ;
         H002N2_A116SIS_COD = new short[1] ;
         H002N2_A6USU_COD = new String[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx00l0__default(),
            new Object[][] {
                new Object[] {
               H002N2_A126PRG_COD, H002N2_A116SIS_COD, H002N2_A6USU_COD
               }
               , new Object[] {
      ...
      private short AV13pSIS_COD ;
      private short AV14pPRG_COD ;
      ...
      private short[] H002N2_A126PRG_COD ;
      private short[] H002N2_A116SIS_COD ;
      private String[] H002N2_A6USU_COD ;
   ...
   public class gx00l0__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H002N2", "SELECT [PRG_COD], [SIS_COD], [USU_COD] FROM [SEG004] WITH (NOLOCK) WHERE ([USU_COD] like @AV6cUSU_COD) AND ([SIS_COD] >= @AV7cSIS_COD) AND ([PRG_COD] >= @AV8cPRG_COD) ORDER BY [USU_COD], [SIS_COD], [PRG_COD]  OPTION (FAST 11)",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002N2,11,1,false,false )
             ,new CursorDef("H002N3", "SELECT COUNT(*) FROM [SEG004] WITH (NOLOCK) WHERE ([USU_COD] like @AV6cUSU_COD) AND ([SIS_COD] >= @AV7cSIS_COD) AND ([PRG_COD] >= @AV8cPRG_COD) ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002N3,1,1,false,false )
          };
       }
    }
