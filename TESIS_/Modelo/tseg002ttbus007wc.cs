/*
       ...
       Generated on: 1/6/2014 11:8:32.2
...
namespace GeneXus.Programs {
   public class tseg002ttbus007wc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public tseg002ttbus007wc( )
      {
      ...
      public tseg002ttbus007wc( IGxContext context )
      {
      ...
      public void execute( String aP0_TTBUS7_CodResp )
      {
         this.AV7TTBUS7_CodResp = aP0_TTBUS7_CodResp;
         executePrivate();
      }
         ...
         if ( StringUtil.Len( (String)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV7TTBUS7_CodResp = GetNextPar( ) ;
                  componentprepare(new Object[] {(String)sCompPrefix,(String)sSFPrefix,(String)AV7TTBUS7_CodResp});
                  componentstart();
               ...
               {
                  /* GeneXus formulas. */
                  AV16Pgmname = "TSEG002TTBUS007WC" ;
                  context.Gx_err = 0 ;
                  GXCCtl = "TTBUS7_RSR_" + sGXsfl_12_idx ;
                  cmbTTBUS7_RSR.Name = GXCCtl ;
                  cmbTTBUS7_RSR.WebTags = "" ;
                  cmbTTBUS7_RSR.addItem("1", "HARDWARE", 0);
                  cmbTTBUS7_RSR.addItem("2", "BIENES DE USO (CONTABILIDAD)", 0);
                  if ( ( cmbTTBUS7_RSR.ItemCount > 0 ) && (0==A198TTBUS7_RSR) )
                  {
                     A198TTBUS7_RSR = (short)(NumberUtil.Val( cmbTTBUS7_RSR.getItemValue(1), ".")) ;
                     context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A198TTBUS7_RSR", StringUtil.Str( (decimal)(A198TTBUS7_RSR), 1, 0));
                  }
                  Grid_PageSize12 = (int)(NumberUtil.Val( GetNextPar( ), ".")) ;
                  AV7TTBUS7_CodResp = GetNextPar( ) ;
                  context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "AV7TTBUS7_CodResp", AV7TTBUS7_CodResp);
                  edtavDelete_Tooltiptext = GetNextPar( ) ;
                  context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavDelete_Internalname, "Tooltiptext", edtavDelete_Tooltiptext);
                  AV13Delete = GetNextPar( ) ;
                  context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavDelete_Internalname, "Bitmap", context.convertURL( AV13Delete));
                  ...
                  gxgrGrid_refresh( Grid_PageSize12, AV7TTBUS7_CodResp, AV13Delete, AV12Update, sPrefix) ;
                  return  ;
               }
               else
               {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.WriteHtmlText( "TSEG002 TTBUS007 WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" onsubmit=\"try{return gx.csv.validForm()}catch(e){return true;}\" name=\"MAINFORM\" method=\"post\" action=\""+formatLink("tseg002ttbus007wc.aspx") + "?" + UrlEncode(StringUtil.RTrim(AV7TTBUS7_CodResp))+"\" class=\""+"Form"+"\">") ;
      ...
      protected void RenderHtmlCloseForm0K2( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV7TTBUS7_CodResp", StringUtil.RTrim( wcpOAV7TTBUS7_CodResp));
         GxWebStd.gx_hidden_field( context, sPrefix+"vTTBUS7_CODRESP", StringUtil.RTrim( AV7TTBUS7_CodResp));
         ...
         {
            context.AddJavascriptSource("tseg002ttbus007wc.js", "?118328");
         }
      ...
      protected void WB0K0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "tseg002ttbus007wc.aspx");
            }
      ...
      protected void wb_table1_2_0K2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            StyleString = "" ;
            GxWebStd.gx_single_line_edit( context, edtTTBUS7_CodResp_Internalname, StringUtil.RTrim( A35TTBUS7_CodResp), "", 16, "chr", 1, "row", 16, edtTTBUS7_CodResp_Visible, 0, 0, 0, 0, "", "", StyleString, ClassString, "", StringUtil.RTrim( context.localUtil.Format( A35TTBUS7_CodResp, "@!")), "", 0, edtTTBUS7_CodResp_Jsonclick, "", 0, 1, 1, true, "left", "HLP_TSEG002TTBUS007WC.htm");
         }
         wbLoad = true ;
      }
      ...
      protected void START0K2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("Description", "TSEG002 TTBUS007 WC", 0) ;
            context.wjLoc = "" ;
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 10), "'DOINSERT'") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              cmbTTBUS7_RSR_Internalname = sPrefix+"TTBUS7_RSR_"+sGXsfl_12_idx ;
                              ...
                              cmbTTBUS7_RSR.Name = cmbTTBUS7_RSR_Internalname ;
                              cmbTTBUS7_RSR.CurrentValue = cgiGet( cmbTTBUS7_RSR_Internalname) ;
                              A198TTBUS7_RSR = (short)(NumberUtil.Val( cgiGet( cmbTTBUS7_RSR_Internalname), ".")) ;
                              context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A198TTBUS7_RSR", StringUtil.Str( (decimal)(A198TTBUS7_RSR), 1, 0));
                              sEvtType = StringUtil.Right( sEvt, 1) ;
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
      ...
      protected void RF0K2( )
      {
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( context.wjLoc)) && ( context.nUserReturn != 1 ) )
         {
            ...
            cmbTTBUS7_RSR_Internalname = sPrefix+"TTBUS7_RSR_"+sGXsfl_12_idx ;
            /* Using cursor H000K2 */
            pr_default.execute(0, new Object[] {AV7TTBUS7_CodResp});
            nGXsfl_12_idx = 1 ;
            GRID_nEOF = 0 ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < GRID_nFirstRecordOnPage + subGrid_Recordsperpage( ) ) ) ) )
            {
               A35TTBUS7_CodResp = H000K2_A35TTBUS7_CodResp[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A35TTBUS7_CodResp", A35TTBUS7_CodResp);
               A198TTBUS7_RSR = H000K2_A198TTBUS7_RSR[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A198TTBUS7_RSR", StringUtil.Str( (decimal)(A198TTBUS7_RSR), 1, 0));
               A34TTBUS7_Des = H000K2_A34TTBUS7_Des[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A34TTBUS7_Des", A34TTBUS7_Des);
               n34TTBUS7_Des = H000K2_n34TTBUS7_Des[0] ;
               A33TTBUS7_Pos = H000K2_A33TTBUS7_Pos[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A33TTBUS7_Pos", StringUtil.LTrim( StringUtil.Str( (decimal)(A33TTBUS7_Pos), 3, 0)));
               A34TTBUS7_Des = H000K2_A34TTBUS7_Des[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A34TTBUS7_Des", A34TTBUS7_Des);
               n34TTBUS7_Des = H000K2_n34TTBUS7_Des[0] ;
      ...
      {
         /* Using cursor H000K3 */
         pr_default.execute(1, new Object[] {AV7TTBUS7_CodResp});
      ...
      protected void STRUP0K0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV7TTBUS7_CodResp = cgiGet( sPrefix+"wcpOAV7TTBUS7_CodResp") ;
      ...
      protected void E120K2( )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavDelete_Internalname, "Tooltiptext", edtavDelete_Tooltiptext);
         edtTTBUS7_CodResp_Visible = 0 ;
         context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtTTBUS7_CodResp_Internalname, "Visible", StringUtil.LTrim( StringUtil.Str( (decimal)(edtTTBUS7_CodResp_Visible), 5, 0)));
      ...
      {
         /* Grid_Load Routine */
         edtavUpdate_Link = formatLink("ttbus007.aspx") + "?" + UrlEncode(StringUtil.RTrim("UPD")) + "," + UrlEncode("" +A33TTBUS7_Pos) ;
         context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavUpdate_Internalname, "Link", edtavUpdate_Link);
         edtavDelete_Link = formatLink("ttbus007.aspx") + "?" + UrlEncode(StringUtil.RTrim("DLT")) + "," + UrlEncode("" +A33TTBUS7_Pos) ;
      ...
      {
         /* 'DoInsert' Routine */
         context.wjLoc = formatLink("ttbus007.aspx") + "?" + UrlEncode(StringUtil.RTrim("INS")) + "," + UrlEncode("" +0) ;
      }
      ...
      protected void wb_table2_5_0K2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            StyleString = "" ;
            GxWebStd.gx_bitmap( context, imgInsert_Internalname, "", context.GetImagePath( "5649fbb8-8ce0-4810-a5ce-bd649ea83c3a", "", "Modern"), "Modern", 1, 1, "", "Agrega", 0, 0, 0, "", 0, "", 0, 0, "", "", 5, imgInsert_Jsonclick, sPrefix+"E\\'DOINSERT\\'.", StyleString, ClassString, "", ""+TempTags, "", "", "HLP_TSEG002TTBUS007WC.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            ...
            if ( GridContainer.GetWrapped() == 1 )
            {
               ...
               context.WriteHtmlTextNl( "</th>") ;
               context.WriteHtmlText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+subGrid_Linesclass+"\" "+" style=\""+((-1==0) ? "display:none;" : "")+""+"\" "+">") ;
               context.SendWebValue( "Sistema Relacionado") ;
               context.WriteHtmlTextNl( "</th>") ;
            ...
            else
            {
               ...
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
               GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A198TTBUS7_RSR), 1, 0, ".", "")));
               GridContainer.AddColumnProperties(GridColumn);
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV7TTBUS7_CodResp = (String)getParm(obj,0) ;
         context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "AV7TTBUS7_CodResp", AV7TTBUS7_CodResp);
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV7TTBUS7_CodResp = (String)((String)getParm(obj,0)) ;
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "tseg002ttbus007wc");
         ...
         {
            AV7TTBUS7_CodResp = (String)getParm(obj,2) ;
            context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "AV7TTBUS7_CodResp", AV7TTBUS7_CodResp);
         }
         wcpOAV7TTBUS7_CodResp = cgiGet( sPrefix+"wcpOAV7TTBUS7_CodResp") ;
         if ( ! GetJustCreated( ) && ( ( StringUtil.StrCmp(AV7TTBUS7_CodResp, wcpOAV7TTBUS7_CodResp) != 0 ) ) )
         {
            setjustcreated();
         }
         wcpOAV7TTBUS7_CodResp = AV7TTBUS7_CodResp ;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlAV7TTBUS7_CodResp = cgiGet( sPrefix+"AV7TTBUS7_CodResp_CTRL") ;
         if ( StringUtil.Len( sCtrlAV7TTBUS7_CodResp) > 0 )
         {
            AV7TTBUS7_CodResp = cgiGet( sCtrlAV7TTBUS7_CodResp) ;
            context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "AV7TTBUS7_CodResp", AV7TTBUS7_CodResp);
         }
         else
         {
            AV7TTBUS7_CodResp = cgiGet( sPrefix+"AV7TTBUS7_CodResp_PARM") ;
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV7TTBUS7_CodResp_PARM", StringUtil.RTrim( AV7TTBUS7_CodResp));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV7TTBUS7_CodResp)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV7TTBUS7_CodResp_CTRL", StringUtil.RTrim( sCtrlAV7TTBUS7_CodResp));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( Form.Jscriptsrc.Item(idxLst)), "?1183244");
            idxLst = (int)(idxLst+1) ;
         }
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("tseg002ttbus007wc.js", "?1183244");
         }
      ...
      protected void sendrow_122( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_12_idx <= subGrid_Recordsperpage( ) * 1 ) )
         {
            ...
            /* ComboBox */
            GridRow.AddColumnProperties("combobox", 2, isAjaxCallMode( ), new Object[] {(GXCombobox)cmbTTBUS7_RSR,(String)cmbTTBUS7_RSR_Internalname,StringUtil.Str( (decimal)(A198TTBUS7_RSR), 1, 0),(String)"",(String)"int",(short)-1,(short)0,(short)0,(short)1,(short)0,(short)0,(String)"px",(short)0,(String)"",(String)StyleString,(String)ClassString,(String)"",(short)0,(String)cmbTTBUS7_RSR_Jsonclick,(String)"",(String)"",(bool)true});
            cmbTTBUS7_RSR.CurrentValue = StringUtil.Str( (decimal)(A198TTBUS7_RSR), 1, 0) ;
            context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, cmbTTBUS7_RSR_Internalname, "Values", (String)(cmbTTBUS7_RSR.ToJavascriptSource()));
      ...
      protected void init_default_properties( )
      {
         ...
         edtTTBUS7_CodResp_Internalname = sPrefix+"TTBUS7_CODRESP" ;
      ...
      public override void initialize( )
      {
         ...
         cmbTTBUS7_RSR_Internalname = "" ;
         A34TTBUS7_Des = "" ;
         GridContainer = new GXWebGrid( context);
         scmdbuf = "" ;
         H000K2_A35TTBUS7_CodResp = new String[] {""} ;
         H000K2_A198TTBUS7_RSR = new short[1] ;
         H000K2_A34TTBUS7_Des = new String[] {""} ;
         H000K2_n34TTBUS7_Des = new bool[] {false} ;
         H000K2_A33TTBUS7_Pos = new short[1] ;
         H000K3_AGRID_nRecordCount = new int[1] ;
         AV10TrnContext = new SdtTransactionContext(context);
         ...
         sCtrlAV7TTBUS7_CodResp = "" ;
         GridRow = new GXWebRow();
         ROClassString = "" ;
         GXt_char7 = "" ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.tseg002ttbus007wc__default(),
            new Object[][] {
                new Object[] {
               H000K2_A35TTBUS7_CodResp, H000K2_A198TTBUS7_RSR, H000K2_A34TTBUS7_Des, H000K2_n34TTBUS7_Des, H000K2_A33TTBUS7_Pos
               }
               , new Object[] {
      ...
      private int edtTTBUS7_CodResp_Visible ;
      ...
      private String wcpOAV7TTBUS7_CodResp ;
      ...
      private String cmbTTBUS7_RSR_Internalname ;
      ...
      private GXCombobox cmbTTBUS7_RSR ;
      private IDataStoreProvider pr_default ;
      private String[] H000K2_A35TTBUS7_CodResp ;
      private short[] H000K2_A198TTBUS7_RSR ;
      private String[] H000K2_A34TTBUS7_Des ;
      private bool[] H000K2_n34TTBUS7_Des ;
      private short[] H000K2_A33TTBUS7_Pos ;
      private int[] H000K3_AGRID_nRecordCount ;
   ...
   public class tseg002ttbus007wc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV7TTBUS7_CodResp",SqlDbType.Char,16,0}
          } ;
          Object[] prmH000K3 ;
          ...
          def= new CursorDef[] {
              new CursorDef("H000K2", "SELECT T1.[TTBUS7_CodResp], T1.[TTBUS7_RSR], T2.[W53DES] AS TTBUS7_Des, T1.[TTBUS7_Pos] AS TTBUS7_Pos FROM ([TTBUS007] T1 WITH (NOLOCK) INNER JOIN [T53FPOS] T2 WITH (NOLOCK) ON T2.[W53POS] = T1.[TTBUS7_Pos]) WHERE T1.[TTBUS7_CodResp] = @AV7TTBUS7_CodResp ORDER BY T1.[TTBUS7_Pos] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000K2,11,0,true,false )
             ,new CursorDef("H000K3", "SELECT COUNT(*) FROM ([TTBUS007] T1 WITH (NOLOCK) INNER JOIN [T53FPOS] T2 WITH (NOLOCK) ON T2.[W53POS] = T1.[TTBUS7_Pos]) WHERE T1.[TTBUS7_CodResp] = @AV7TTBUS7_CodResp ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000K3,1,0,true,false )
          };
       }
    }
