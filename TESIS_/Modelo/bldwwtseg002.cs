...
using System.IO;
public class bldwwtseg002 : GxBaseBuilder
{
   string cs_path = "." ;
   public bldwwtseg002( ) : base()
   {
   }
   ...
   {
      bldwwtseg002 x = new bldwwtseg002() ;
      x.SetMainSourceFile( "wwtseg002.cs");
   ...
   {
      ItemCollection sc = new ItemCollection() ;
      sc.Add( @"bin\wwtseg002.dll", cs_path + @"\wwtseg002.rsp");
      return sc ;
   }
