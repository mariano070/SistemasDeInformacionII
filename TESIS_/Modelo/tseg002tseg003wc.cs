/*
       ...
       Generated on: 1/6/2014 11:8:27.55
...
namespace GeneXus.Programs {
   public class tseg002tseg003wc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public tseg002tseg003wc( )
      {
      ...
      public tseg002tseg003wc( IGxContext context )
      {
         ...
         if ( StringUtil.Len( (String)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  componentprepare(new Object[] {(String)sCompPrefix,(String)sSFPrefix,(String)AV7USU_COD});
                  componentstart();
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
               {
                  ...
                  gxgrGrid_refresh( Grid_PageSize12, AV7USU_COD, AV13Delete, AV12Update, sPrefix) ;
                  return  ;
               }
               else
               {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.WriteHtmlText( "TSEG002 TSEG003 WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" onsubmit=\"try{return gx.csv.validForm()}catch(e){return true;}\" name=\"MAINFORM\" method=\"post\" action=\""+formatLink("tseg002tseg003wc.aspx") + "?" + UrlEncode(StringUtil.RTrim(AV7USU_COD))+"\" class=\""+"Form"+"\">") ;
      ...
      protected void RenderHtmlCloseForm0H2( )
      {
         ...
         {
            context.AddJavascriptSource("tseg002tseg003wc.js", "?1182760");
         }
      ...
      protected void WB0H0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "tseg002tseg003wc.aspx");
            }
      ...
      protected void wb_table1_2_0H2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            StyleString = "" ;
            GxWebStd.gx_single_line_edit( context, edtUSU_COD_Internalname, StringUtil.RTrim( A6USU_COD), "", 16, "chr", 1, "row", 16, edtUSU_COD_Visible, 0, 0, 0, 0, "", "", StyleString, ClassString, "", StringUtil.RTrim( context.localUtil.Format( A6USU_COD, "@!")), "", 0, edtUSU_COD_Jsonclick, "", 0, 1, 1, true, "left", "HLP_TSEG002TSEG003WC.htm");
         }
         wbLoad = true ;
      }
      ...
      protected void START0H2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("Description", "TSEG002 TSEG003 WC", 0) ;
            context.wjLoc = "" ;
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 10), "'DOINSERT'") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              edtSIS_COD_Internalname = sPrefix+"SIS_COD_"+sGXsfl_12_idx ;
                              edtSIS_DES_Internalname = sPrefix+"SIS_DES_"+sGXsfl_12_idx ;
      ...
      protected void RF0H2( )
      {
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( context.wjLoc)) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A6USU_COD = H000H2_A6USU_COD[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A6USU_COD", A6USU_COD);
               A259SIS_DES = H000H2_A259SIS_DES[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A259SIS_DES", A259SIS_DES);
               A116SIS_COD = H000H2_A116SIS_COD[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A116SIS_COD", StringUtil.LTrim( StringUtil.Str( (decimal)(A116SIS_COD), 3, 0)));
               A259SIS_DES = H000H2_A259SIS_DES[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A259SIS_DES", A259SIS_DES);
               /* Execute user event: E130H2 */
      ...
      {
         /* Using cursor H000H3 */
         pr_default.execute(1, new Object[] {AV7USU_COD});
      ...
      private void E130H2( )
      {
         ...
         GXEncryptionTmp = UrlEncode(StringUtil.RTrim("UPD")) + "," + UrlEncode(StringUtil.RTrim(AV7USU_COD)) + "," + UrlEncode("" +A116SIS_COD) ;
         ...
         GXKey = Crypto.Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( )) ;
         GXEncryptionTmp = UrlEncode(StringUtil.RTrim("DLT")) + "," + UrlEncode(StringUtil.RTrim(AV7USU_COD)) + "," + UrlEncode("" +A116SIS_COD) ;
      ...
      protected void E110H2( )
      {
         ...
         GXKey = Crypto.Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( )) ;
         GXEncryptionTmp = UrlEncode(StringUtil.RTrim("INS")) + "," + UrlEncode(StringUtil.RTrim(AV7USU_COD)) + "," + UrlEncode("" +0) ;
      ...
      protected void wb_table1_2_0H2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table2_5_0H2( true) ;
         }
         else
         {
            wb_table2_5_0H2( false) ;
         }
         return  ;
      }

      protected void wb_table2_5_0H2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
      ...
      protected void wb_table2_5_0H2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            StyleString = "" ;
            GxWebStd.gx_bitmap( context, imgInsert_Internalname, "", context.GetImagePath( "5649fbb8-8ce0-4810-a5ce-bd649ea83c3a", "", "Modern"), "Modern", 1, 1, "", "Agrega", 0, 0, 0, "", 0, "", 0, 0, "", "", 5, imgInsert_Jsonclick, sPrefix+"E\\'DOINSERT\\'.", StyleString, ClassString, "", ""+TempTags, "", "", "HLP_TSEG002TSEG003WC.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
         ...
         if ( wbEnd == 12 )
         {
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_5_0H2e( true) ;
         }
         else
         {
            wb_table2_5_0H2e( false) ;
         }
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "tseg002tseg003wc");
         ...
         wcpOAV7USU_COD = cgiGet( sPrefix+"wcpOAV7USU_COD") ;
         if ( ! GetJustCreated( ) && ( ( StringUtil.StrCmp(AV7USU_COD, wcpOAV7USU_COD) != 0 ) ) )
         {
            setjustcreated();
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( Form.Jscriptsrc.Item(idxLst)), "?1182795");
            idxLst = (int)(idxLst+1) ;
         }
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("tseg002tseg003wc.js", "?1182795");
         }
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "" ;
         H000H2_A6USU_COD = new String[] {""} ;
         H000H2_A259SIS_DES = new String[] {""} ;
         H000H2_A116SIS_COD = new short[1] ;
         H000H3_AGRID_nRecordCount = new int[1] ;
         GXKey = "" ;
         GXEncryptionTmp = "" ;
         AV10TrnContext = new SdtTransactionContext(context);
         ...
         ROClassString = "" ;
         GXt_char7 = "" ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.tseg002tseg003wc__default(),
            new Object[][] {
                new Object[] {
               H000H2_A6USU_COD, H000H2_A259SIS_DES, H000H2_A116SIS_COD
               }
               , new Object[] {
      ...
      private String[] H000H2_A6USU_COD ;
      private String[] H000H2_A259SIS_DES ;
      private short[] H000H2_A116SIS_COD ;
      private int[] H000H3_AGRID_nRecordCount ;
   ...
   public class tseg002tseg003wc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000H2", "SELECT T1.[USU_COD], T2.[SIS_DES], T1.[SIS_COD] FROM ([SEG003] T1 WITH (NOLOCK) INNER JOIN [SEG000] T2 WITH (NOLOCK) ON T2.[SIS_COD] = T1.[SIS_COD]) WHERE T1.[USU_COD] = @AV7USU_COD ORDER BY T1.[USU_COD], T1.[SIS_COD] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000H2,11,1,true,false )
             ,new CursorDef("H000H3", "SELECT COUNT(*) FROM ([SEG003] T1 WITH (NOLOCK) INNER JOIN [SEG000] T2 WITH (NOLOCK) ON T2.[SIS_COD] = T1.[SIS_COD]) WHERE T1.[USU_COD] = @AV7USU_COD ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000H3,1,1,true,false )
          };
       }
    }
