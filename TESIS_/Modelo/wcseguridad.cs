/*
       ...
       Generated on: 3/17/2014 13:22:53.40
...
namespace GeneXus.Programs {
   public class wcseguridad : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlCloseForm252( )
      {
         ...
         {
            context.AddJavascriptSource("wcseguridad.js", "?13225342");
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( Form.Jscriptsrc.Item(idxLst)), "?13225363");
            idxLst = (int)(idxLst+1) ;
         }
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wcseguridad.js", "?13225363");
