/*
       ...
       Generated on: 2/26/2014 11:46:8.17
...
namespace GeneXus.Programs {
   public class hseg102_pos : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlCloseForm5F2( )
      {
         ...
         {
            context.AddJavascriptSource("hseg102_pos.js", "?1146824");
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( Form.Jscriptsrc.Item(idxLst)), "?1146848");
            idxLst = (int)(idxLst+1) ;
         }
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("hseg102_pos.js", "?1146848");
         }
