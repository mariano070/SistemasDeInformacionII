/*
       ...
       Generated on: 3/17/2014 13:22:44.67
...
namespace GeneXus.Programs {
   public class mptrazabilidad : GXMasterPage, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlCloseForm012( )
      {
         ...
         context.AddJavascriptSource("mptrazabilidad.js", "?13224471");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( getDataAreaObject().GetForm().Jscriptsrc.Item(idxLst)), "?13224512");
            idxLst = (int)(idxLst+1) ;
         }
      ...
      {
         context.AddJavascriptSource("mptrazabilidad.js", "?13224512");
         context.AddJavascriptSource("DropDownTabsMenu/dropdowntabs.js", "");
         context.AddJavascriptSource("DropDownTabsMenu/DropDownTabsMenuRender.js", "");
