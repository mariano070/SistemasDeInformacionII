...
namespace GeneXus.Programs {
   public class GxWebStd
   {
      ...
      static public void gx_single_line_edit1_wml( IGxContext context ,
                                                   ...
                                                   String sCallerPgm )
      {
         gx_single_line_edit_wml( context, sCtrlName, sValue, sTooltipText, nWidth, nWidthUnit, nHeight, nHeightUnit, nLength, nVisible, nEnabled, nRTEnabled, nIsPassword, nFormat, sLinkURL, sLinkTarget, sStyleString, sClassString, sROClassString, sFormatedValue, sTags, nJScriptCode, sUserOnClickCode, sEventName, nParentId, bHasTheme, nAutoComplete, bSendHidden, "", sCallerPgm) ;
      }
      ...
      static public void gx_combobox_ctrl_wml( IGxContext context ,
                                               ...
                                               String sCallerPgm )
      {
         gx_combobox_ctrl1_wml( context, cmbCObjCtrl, sCtrlName, sValue, sTooltipText, sType, nVisible, nEnabled, nRTEnabled, nRows, nFormat, nWidth, nWidthUnit, nHeight, nHeightUnit, sStyleString, sClassString, sFormatedValue, nJScriptCode, sUserOnClickCode, sEventName, sTags, true, sCallerPgm) ;
      }
      ...
      static public void gx_listbox_ctrl_wml( IGxContext context ,
                                              ...
                                              String sCallerPgm )
      {
         gx_listbox_ctrl1_wml( context, lstLObjCtrl, sCtrlName, sValue, sTooltipText, sType, nVisible, nEnabled, nRTEnabled, nRows, nFormat, nWidth, nWidthUnit, nHeight, nHeightUnit, sStyleString, sClassString, sFormatedValue, nJScriptCode, sUserOnClickCode, sEventName, sTags, true, sCallerPgm) ;
      }
