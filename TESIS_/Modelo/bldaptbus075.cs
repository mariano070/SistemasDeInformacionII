...
using System.IO;
public class bldaptbus075 : GxBaseBuilder
{
   string cs_path = "." ;
   public bldaptbus075( ) : base()
   {
   }
   ...
   {
      bldaptbus075 x = new bldaptbus075() ;
      x.SetMainSourceFile( "aptbus075.cs");
   ...
   {
      ItemCollection sc = new ItemCollection() ;
      sc.Add( @"bin\aptbus075.dll", cs_path + @"\aptbus075.rsp");
      return sc ;
   }
