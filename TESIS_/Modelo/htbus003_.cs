/*
       ...
       Generated on: 3/17/2014 13:22:18.48
...
namespace GeneXus.Programs {
   public class htbus003_ : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlCloseForm1O2( )
      {
         ...
         {
            context.AddJavascriptSource("htbus003_.js", "?13221856");
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( Form.Jscriptsrc.Item(idxLst)), "?13221930");
            idxLst = (int)(idxLst+1) ;
         }
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("htbus003_.js", "?13221930");
         }
