/*
       ...
       Generated on: 2/26/2014 11:46:57.59
   ...
   public class gettabimage : GXProcedure
   {
      ...
      void executePrivate( )
      {
         ...
         if ( AV12IsLastTab )
         {
            if ( AV10IsSelected )
            {
               AV8Bitmap = context.GetImagePath( "0424c12e-f1b1-4123-889e-b2966eb27e93", "", "Modern") ;
            }
            else
            {
               AV8Bitmap = context.GetImagePath( "a46a2602-a799-4dab-a329-130bd24fbbb4", "", "Modern") ;
            }
         }
         else
         {
            if ( AV10IsSelected )
            {
               if ( AV9IsFirstTab )
               {
                  AV8Bitmap = context.GetImagePath( "f4a0965f-129d-45fc-bdfe-107944e516c0", "", "Modern") ;
               }
               else
               {
                  AV8Bitmap = context.GetImagePath( "a908a75c-9ebf-4d01-bcda-9711089e0493", "", "Modern") ;
               }
            }
            else
            {
               if ( AV9IsFirstTab )
               {
                  AV8Bitmap = context.GetImagePath( "014ad39b-4d50-4343-92ef-0117c86e1b16", "", "Modern") ;
               }
               else
               {
                  if ( AV11IsBeforeTabSelected )
                  {
                     AV8Bitmap = context.GetImagePath( "3e28b5a8-f17c-43b3-8850-2e932e706b48", "", "Modern") ;
                  }
                  else
                  {
                     AV8Bitmap = context.GetImagePath( "ce463bdd-5a79-4a33-a6e5-8b0b7cb85bcd", "", "Modern") ;
                  }
               }
            }
         }
