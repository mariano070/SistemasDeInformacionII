...
using System.IO;
public class bldaptbus005 : GxBaseBuilder
{
   string cs_path = "." ;
   public bldaptbus005( ) : base()
   {
   }
   ...
   {
      bldaptbus005 x = new bldaptbus005() ;
      x.SetMainSourceFile( "aptbus005.cs");
   ...
   {
      ItemCollection sc = new ItemCollection() ;
      sc.Add( @"bin\aptbus005.exe", cs_path + @"\aptbus005.rsp");
      return sc ;
   }
