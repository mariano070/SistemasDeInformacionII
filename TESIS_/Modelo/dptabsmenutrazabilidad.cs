/*
               File: DPTabsMenuTrazabilidad
        Description: DPTabs Menu Trazabilidad
             Author: GeneXus C# Generator version 10_1_5-42940
       Generated on: 3/17/2014 13:22:33.16
...
namespace GeneXus.Programs {
   public class dptabsmenutrazabilidad : GXProcedure
   {
      public dptabsmenutrazabilidad( )
      {
      ...
      public dptabsmenutrazabilidad( IGxContext context )
      {
      ...
      public void executeSubmit( String aP0_SISTEMA ,
                                 ...
                                 out IGxCollection aP2_Gxm2rootcol )
      {
         dptabsmenutrazabilidad objdptabsmenutrazabilidad;
         objdptabsmenutrazabilidad = new dptabsmenutrazabilidad();
         objdptabsmenutrazabilidad.AV5SISTEMA = aP0_SISTEMA;
         objdptabsmenutrazabilidad.AV6USUARIO = aP1_USUARIO;
         objdptabsmenutrazabilidad.Gxm2rootcol = new GxObjectCollection( context, "TabsMenuData.TabsMenuDataItem", "MarianoTesis", "SdtTabsMenuData_TabsMenuDataItem", "GeneXus.Programs") ;
         objdptabsmenutrazabilidad.initialize();
         ThreadPool.QueueUserWorkItem( new WaitCallback( objdptabsmenutrazabilidad.executePrivateCatch ));
         aP2_Gxm2rootcol=this.Gxm2rootcol;
      }
      ...
      void executePrivate( )
      {
         ...
         Gxm1tabsmenudata.gxTpr_Sections.Add(Gxm3tabsmenudata_sections, 0);
         Gxm3tabsmenudata_sections.gxTpr_Sectionid = 4 ;
         Gxm3tabsmenudata_sections.gxTpr_Sectiontitle = "Posiciones" ;
         Gxm3tabsmenudata_sections.gxTpr_Sectiondescription = "Posiciones" ;
         Gxm3tabsmenudata_sections.gxTpr_Sectionurl = "htbus053.aspx"+ "?" + GXUtil.UrlEncode(StringUtil.RTrim(AV5SISTEMA)) + "," + GXUtil.UrlEncode(StringUtil.RTrim(AV6USUARIO)) ;
         Gxm3tabsmenudata_sections = new SdtTabsMenuData_TabsMenuDataItem_SectionsItem(context) ;
         Gxm1tabsmenudata.gxTpr_Sections.Add(Gxm3tabsmenudata_sections, 0);
         Gxm3tabsmenudata_sections.gxTpr_Sectionid = 5 ;
         Gxm3tabsmenudata_sections.gxTpr_Sectiontitle = "Usuarios" ;
         Gxm3tabsmenudata_sections.gxTpr_Sectiondescription = "Usuarios" ;
         Gxm3tabsmenudata_sections.gxTpr_Sectionurl = "hseg102.aspx"+ "?" + GXUtil.UrlEncode(StringUtil.RTrim(AV5SISTEMA)) + "," + GXUtil.UrlEncode(StringUtil.RTrim(AV6USUARIO)) ;
         Gxm3tabsmenudata_sections = new SdtTabsMenuData_TabsMenuDataItem_SectionsItem(context) ;
         Gxm1tabsmenudata.gxTpr_Sections.Add(Gxm3tabsmenudata_sections, 0);
         Gxm3tabsmenudata_sections.gxTpr_Sectionid = 6 ;
         Gxm3tabsmenudata_sections.gxTpr_Sectiontitle = "Administradores" ;
         Gxm3tabsmenudata_sections.gxTpr_Sectiondescription = "Administradores" ;
         Gxm3tabsmenudata_sections.gxTpr_Sectionurl = "htbus008.aspx"+ "?" + GXUtil.UrlEncode(StringUtil.RTrim(AV5SISTEMA)) + "," + GXUtil.UrlEncode(StringUtil.RTrim(AV6USUARIO)) ;
         Gxm3tabsmenudata_sections = new SdtTabsMenuData_TabsMenuDataItem_SectionsItem(context) ;
         Gxm1tabsmenudata.gxTpr_Sections.Add(Gxm3tabsmenudata_sections, 0);
         Gxm3tabsmenudata_sections.gxTpr_Sectionid = 7 ;
         Gxm3tabsmenudata_sections.gxTpr_Sectiontitle = "Responsables" ;
         Gxm3tabsmenudata_sections.gxTpr_Sectiondescription = "Responsables" ;
         Gxm3tabsmenudata_sections.gxTpr_Sectionurl = "htbus007.aspx"+ "?" + GXUtil.UrlEncode(StringUtil.RTrim(AV5SISTEMA)) + "," + GXUtil.UrlEncode(StringUtil.RTrim(AV6USUARIO)) ;
         Gxm3tabsmenudata_sections = new SdtTabsMenuData_TabsMenuDataItem_SectionsItem(context) ;
         Gxm1tabsmenudata.gxTpr_Sections.Add(Gxm3tabsmenudata_sections, 0);
         Gxm3tabsmenudata_sections.gxTpr_Sectionid = 8 ;
         Gxm3tabsmenudata_sections.gxTpr_Sectiontitle = "Permisos" ;
         Gxm3tabsmenudata_sections.gxTpr_Sectiondescription = "Permisos" ;
         Gxm3tabsmenudata_sections.gxTpr_Sectionurl = "htbus007_p.aspx"+ "?" + GXUtil.UrlEncode(StringUtil.RTrim(AV5SISTEMA)) + "," + GXUtil.UrlEncode(StringUtil.RTrim(AV6USUARIO)) ;
         this.cleanup();
      }
