...
using System.IO;
public class bldwwtbus000 : GxBaseBuilder
{
   string cs_path = "." ;
   public bldwwtbus000( ) : base()
   {
   }
   ...
   {
      bldwwtbus000 x = new bldwwtbus000() ;
      x.SetMainSourceFile( "wwtbus000.cs");
   ...
   {
      ItemCollection sc = new ItemCollection() ;
      sc.Add( @"bin\wwtbus000.dll", cs_path + @"\wwtbus000.rsp");
      return sc ;
   }
