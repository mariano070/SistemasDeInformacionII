/*
               File: HTBUS001_prev
        Description: Setea variables de sesión para HTBUS001
             Author: GeneXus C# Generator version 10_1_5-42940
       Generated on: 3/17/2014 13:22:28.50
...
namespace GeneXus.Programs {
   public class htbus001_prev : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public htbus001_prev( )
      {
      ...
      public htbus001_prev( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" onsubmit=\"try{return gx.csv.validForm()}catch(e){return true;}\" name=\"MAINFORM\" method=\"post\" action=\""+formatLink("htbus001_prev.aspx") + "?" + UrlEncode(StringUtil.RTrim(AV5SISTEMA)) + "," + UrlEncode(StringUtil.RTrim(AV6USUARIO))+"\" class=\""+""+"\">") ;
      ...
      {
         return "HTBUS001_prev" ;
      }

      public override String GetPgmdesc( )
      {
         return "Setea variables de sesión para HTBUS001" ;
      }
      ...
      {
         return formatLink("htbus001_prev.aspx") + "?" + UrlEncode(StringUtil.RTrim(AV5SISTEMA)) + "," + UrlEncode(StringUtil.RTrim(AV6USUARIO)) ;
      }
      ...
      protected void START0B2( )
      {
         ...
         Form.Meta.addItem("Description", "Setea variables de sesión para HTBUS001", 0) ;
         context.wjLoc = "" ;
      ...
      {
         /* Start Routine */
         AV8SESION.Set("Inicio", "0");
         new loadcontext(context ).execute( out  AV7Context) ;
         AV6USUARIO = AV7Context.gxTpr_User ;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV6USUARIO", AV6USUARIO);
         context.wjLoc = formatLink("htbus001.aspx") + "?" + UrlEncode(StringUtil.RTrim(AV5SISTEMA)) + "," + UrlEncode(StringUtil.RTrim(AV6USUARIO)) ;
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( Form.Jscriptsrc.Item(idxLst)), "?13222855");
            idxLst = (int)(idxLst+1) ;
         }
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("htbus001_prev.js", "?13222855");
         }
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Setea variables de sesión para HTBUS001" ;
      }
