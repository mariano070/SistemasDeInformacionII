/*
       ...
       Generated on: 2/26/2014 11:47:0.58
...
namespace GeneXus.Programs {
   public class gx0160 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      {
         /* Start Routine */
         Form.Caption = StringUtil.Format( "Lista de Selección %1", "ACT. USUARIOS", "", "", "", "", "", "", "", "") ;
      ...
      protected void wb_table2_9_5J2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblockusu_cod__Internalname, 1, 1, 0, "CÓDIGO DE USUARIO", "", "", "", 0, lblTextblockusu_cod__Jsonclick, "", StyleString, ClassString, "HLP_Gx0160.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( Form.Jscriptsrc.Item(idxLst)), "?1147088");
            idxLst = (int)(idxLst+1) ;
         }
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx0160.js", "?1147088");
