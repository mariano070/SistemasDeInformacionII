/*
       ...
       Generated on: 1/6/2014 11:8:33.71
...
namespace GeneXus.Programs {
   public class appmastersd : GXMasterPage, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlCloseForm072( )
      {
         ...
         context.AddJavascriptSource("appmastersd.js", "?1183372");
      ...
      {
         AddThemeStyleSheetFile("", "GeneXusXSD.css", "?19542424");
         idxLst = 1 ;
         while ( idxLst <= getDataAreaObject().GetForm().Jscriptsrc.Count )
         {
            context.AddJavascriptSource(StringUtil.RTrim( getDataAreaObject().GetForm().Jscriptsrc.Item(idxLst)), "?1183379");
            idxLst = (int)(idxLst+1) ;
         }
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("appmastersd.js", "?1183379");
         }
