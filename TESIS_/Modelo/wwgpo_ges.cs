/*
               File: WWGPO_GES
        Description: Work With Gestores por Grupo
             Author: GeneXus C# Generator version 10_1_5-42940
       Generated on: 1/2/2014 19:19:9.91
...
namespace GeneXus.Programs {
   public class wwgpo_ges : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public wwgpo_ges( )
      {
      ...
      public wwgpo_ges( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               /* GeneXus formulas. */
               AV18Pgmname = "WWGPO_GES" ;
               context.Gx_err = 0 ;
               Grid_PageSize24 = (int)(NumberUtil.Val( GetNextPar( ), ".")) ;
               AV13Grupo_Des = GetNextPar( ) ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV13Grupo_Des", AV13Grupo_Des);
               edtavDelete_Tooltiptext = GetNextPar( ) ;
               context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavDelete_Internalname, "Tooltiptext", edtavDelete_Tooltiptext);
               AV15Delete = GetNextPar( ) ;
               context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavDelete_Internalname, "Bitmap", context.convertURL( AV15Delete));
               ...
               gxgrGrid_refresh( Grid_PageSize24, AV13Grupo_Des, AV15Delete, AV14Update) ;
               return  ;
            }
            else
            {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" onsubmit=\"try{return gx.csv.validForm()}catch(e){return true;}\" name=\"MAINFORM\" method=\"post\" action=\""+formatLink("wwgpo_ges.aspx") +"\" class=\""+"Form"+"\">") ;
      ...
      public override void RenderHtmlCloseForm( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vGRUPO_DES", StringUtil.RTrim( AV13Grupo_Des));
         /* Send saved values. */
      ...
      {
         return "Work With Gestores por Grupo" ;
      }
      ...
      {
         return formatLink("wwgpo_ges.aspx")  ;
      }
      ...
      protected void START102( )
      {
         ...
         Form.Meta.addItem("Description", "Work With Gestores por Grupo", 0) ;
         context.wjLoc = "" ;
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            if ( String.IsNullOrEmpty(StringUtil.RTrim( context.wjLoc)) && ( context.nUserReturn != 1 ) && ! wbErr )
            {
               ...
               if ( StringUtil.Len( sEvt) > 0 )
               {
                  ...
                  if ( StringUtil.StrCmp(cgiGet( "GXH_vGRUPO_DES"), AV13Grupo_Des) != 0 )
                  {
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 10), "'DOINSERT'") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              edtGrupo_Cod_Internalname = "GRUPO_COD_"+sGXsfl_24_idx ;
                              edtGrupo_Des_Internalname = "GRUPO_DES_"+sGXsfl_24_idx ;
                              edtGes_Cod_Internalname = "GES_COD_"+sGXsfl_24_idx ;
                              edtGes_Des_Internalname = "GES_DES_"+sGXsfl_24_idx ;
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    {
                                       Rfr0gs = false ;
                                       /* Set Refresh If Grupo_des Changed */
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vGRUPO_DES"), AV13Grupo_Des) != 0 )
                                       {
                                          Rfr0gs = true ;
                                       }
      ...
      protected void PA102( )
      {
         if ( nDonePA == 0 )
         {
            GX_FocusControl = edtavGrupo_des_Internalname ;
      ...
      protected void RF102( )
      {
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( context.wjLoc)) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV13Grupo_Des = StringUtil.PadR( StringUtil.RTrim( AV13Grupo_Des), 20, "%") ;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV13Grupo_Des", AV13Grupo_Des);
            /* Using cursor H00102 */
            pr_default.execute(0, new Object[] {lV13Grupo_Des});
            nGXsfl_24_idx = 1 ;
            GRID_nEOF = 0 ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < GRID_nFirstRecordOnPage + subGrid_Recordsperpage( ) ) ) ) )
            {
               A277Ges_Des = H00102_A277Ges_Des[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A277Ges_Des", A277Ges_Des);
               n277Ges_Des = H00102_n277Ges_Des[0] ;
               A270Ges_Cod = H00102_A270Ges_Cod[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A270Ges_Cod", A270Ges_Cod);
               A273Grupo_Des = H00102_A273Grupo_Des[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A273Grupo_Des", A273Grupo_Des);
               A271Grupo_Cod = H00102_A271Grupo_Cod[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A271Grupo_Cod", StringUtil.LTrim( StringUtil.Str( (decimal)(A271Grupo_Cod), 4, 0)));
               A277Ges_Des = H00102_A277Ges_Des[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A277Ges_Des", A277Ges_Des);
               n277Ges_Des = H00102_n277Ges_Des[0] ;
      ...
      protected int subGrid_Recordcount( )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV13Grupo_Des", AV13Grupo_Des);
         /* Using cursor H00103 */
         pr_default.execute(1, new Object[] {lV13Grupo_Des});
      ...
      protected void STRUP100( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV13Grupo_Des = cgiGet( edtavGrupo_des_Internalname) ;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV13Grupo_Des", AV13Grupo_Des);
            /* Read saved values. */
      ...
      {
         /* Grid_Load Routine */
         edtavUpdate_Link = formatLink("gpo_ges.aspx") + "?" + UrlEncode(StringUtil.RTrim("UPD")) + "," + UrlEncode("" +A271Grupo_Cod) + "," + UrlEncode(StringUtil.RTrim(A270Ges_Cod)) ;
         context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavUpdate_Internalname, "Link", edtavUpdate_Link);
         edtavDelete_Link = formatLink("gpo_ges.aspx") + "?" + UrlEncode(StringUtil.RTrim("DLT")) + "," + UrlEncode("" +A271Grupo_Cod) + "," + UrlEncode(StringUtil.RTrim(A270Ges_Cod)) ;
      ...
      {
         /* 'DoInsert' Routine */
         context.wjLoc = formatLink("gpo_ges.aspx") + "?" + UrlEncode(StringUtil.RTrim("INS")) + "," + UrlEncode("" +0) + "," + UrlEncode(StringUtil.RTrim("")) ;
      }
      ...
      protected void S122( )
      {
         ...
         if ( StringUtil.StrCmp(AV8HTTPRequest.Method, "GET") == 0 )
         {
            ...
            {
               AV13Grupo_Des = ((SdtGridState_FilterValue)AV9GridState.gxTpr_Filtervalues.Item(1)).gxTpr_Value ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV13Grupo_Des", AV13Grupo_Des);
            }
      ...
      protected void S132( )
      {
         ...
         AV10GridStateFilterValue.gxTpr_Value = AV13Grupo_Des ;
      ...
      protected void S112( )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "AV11TrnContext", (Object)(AV11TrnContext));
         AV11TrnContext.gxTpr_Transactionname = "GPO_GES" ;
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "AV11TrnContext", (Object)(AV11TrnContext));
      ...
      protected void wb_table2_5_102e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            wb_table3_17_102( true) ;
         }
         else
         {
            wb_table3_17_102( false) ;
         }
         return  ;
      }

      protected void wb_table3_17_102e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
      ...
      protected void wb_table3_17_102( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            StyleString = "" ;
            GxWebStd.gx_bitmap( context, imgInsert_Internalname, "", context.GetImagePath( "5649fbb8-8ce0-4810-a5ce-bd649ea83c3a", "", "Modern"), "Modern", 1, 1, "", "Agrega", 0, 0, 0, "", 0, "", 0, 0, "", "", 5, imgInsert_Jsonclick, "E\\'DOINSERT\\'.", StyleString, ClassString, "", ""+TempTags, "", "", "HLP_WWGPO_GES.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            ...
            if ( GridContainer.GetWrapped() == 1 )
            {
               ...
               context.WriteHtmlText( "<th align=\""+""+"\" "+" nowrap=\"nowrap\" "+" class=\""+subGrid_Linesclass+"\" "+" style=\""+"display:none;"+"background:#4682B4; font-family:'Verdana'; font-size:8.0pt; font-weight:bold; font-style:normal; color:#FFFFFF"+"\" "+">") ;
               context.SendWebValue( "") ;
               context.WriteHtmlTextNl( "</th>") ;
               context.WriteHtmlText( "<th align=\""+""+"\" "+" nowrap=\"nowrap\" "+" class=\""+subGrid_Linesclass+"\" "+" style=\""+((-1==0) ? "display:none;" : "")+"background:#4682B4; font-family:'Verdana'; font-size:8.0pt; font-weight:bold; font-style:normal; color:#FFFFFF"+"\" "+">") ;
               context.SendWebValue( "") ;
               context.WriteHtmlTextNl( "</th>") ;
               context.WriteHtmlText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+subGrid_Linesclass+"\" "+" style=\""+((-1==0) ? "display:none;" : "")+"background:#4682B4; font-family:'Verdana'; font-size:8.0pt; font-weight:bold; font-style:normal; color:#FFFFFF"+"\" "+">") ;
               context.SendWebValue( "Grupo") ;
               context.WriteHtmlTextNl( "</th>") ;
               context.WriteHtmlText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+subGrid_Linesclass+"\" "+" style=\""+((-1==0) ? "display:none;" : "")+"background:#4682B4; font-family:'Verdana'; font-size:8.0pt; font-weight:bold; font-style:normal; color:#FFFFFF"+"\" "+">") ;
               context.SendWebValue( "") ;
               context.WriteHtmlTextNl( "</th>") ;
               context.WriteHtmlText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+subGrid_Linesclass+"\" "+" style=\""+((-1==0) ? "display:none;" : "")+"background:#4682B4; font-family:'Verdana'; font-size:8.0pt; font-weight:bold; font-style:normal; color:#FFFFFF"+"\" "+">") ;
            ...
            else
            {
               ...
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
               GridColumn.AddObjectProperty("Value", StringUtil.RTrim( A270Ges_Cod));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
               GridColumn.AddObjectProperty("Value", StringUtil.RTrim( A277Ges_Des));
               GridContainer.AddColumnProperties(GridColumn);
         ...
         if ( wbEnd == 24 )
         {
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_17_102e( true) ;
         }
         else
         {
            wb_table3_17_102e( false) ;
         }
      }
      ...
      protected void wb_table2_5_102( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            GxWebStd.gx_label_ctrl( context, lblFiltertextgrupo_des_Internalname, 1, 1, 0, "Grupo de Gestión", "", "", "", 0, lblFiltertextgrupo_des_Jsonclick, "", StyleString, ClassString, "HLP_WWGPO_GES.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            ...
            GxWebStd.gx_single_line_edit( context, edtavGrupo_des_Internalname, StringUtil.RTrim( AV13Grupo_Des), "", 20, "chr", 1, "row", 20, 1, 1, 0, 0, 0, "", "", StyleString, ClassString, "", StringUtil.RTrim( context.localUtil.Format( AV13Grupo_Des, "XXXXXXXXXXXXXXXXXXXX")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(10);\"", 0, edtavGrupo_des_Jsonclick, "", 0, 1, -1, true, "left", "HLP_WWGPO_GES.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            ...
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTableseparator_Internalname, 1, 1, 0, " ", "", "", "", 0, lblTableseparator_Jsonclick, "", StyleString, ClassString, "HLP_WWGPO_GES.htm");
            /* Text block */
            ClassString = "TextBlock" ;
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblSeteo_Internalname, 1, 1, 1, lblSeteo_Caption, "", "", "", 0, lblSeteo_Jsonclick, "", StyleString, ClassString, "HLP_WWGPO_GES.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "</tbody>") ;
            /* End of table */
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( Form.Jscriptsrc.Item(idxLst)), "?19191040");
            idxLst = (int)(idxLst+1) ;
         }
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwgpo_ges.js", "?19191041");
         }
      ...
      protected void sendrow_242( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_24_idx <= subGrid_Recordsperpage( ) * 1 ) )
         {
            ...
            StyleString = "font-family:'Verdana'; font-size:8.0pt; font-weight:normal; font-style:normal" ;
            ROClassString = ClassString ;
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtGes_Des_Internalname,StringUtil.RTrim( A277Ges_Des),(String)"",(short)0,(String)"px",(short)17,(String)"",(short)50,(short)-1,(short)0,(short)0,(short)0,(short)0,(String)"",(String)"",(String)StyleString,(String)ClassString,(String)ROClassString,StringUtil.RTrim( context.localUtil.Format( A277Ges_Des, "@!")),(String)"",(short)0,(String)edtGes_Des_Jsonclick,(String)"",(short)24,(short)1,(short)1,(bool)true,(String)"left"});
      ...
      {
         lblFiltertextgrupo_des_Internalname = "FILTERTEXTGRUPO_DES" ;
         edtavGrupo_des_Internalname = "vGRUPO_DES" ;
      ...
      public override void initialize_properties( )
      {
         ...
         edtavGrupo_des_Jsonclick = "" ;
         subGrid_Linesfont = "font-family:Verdana;font-size:8pt;" ;
         subGrid_Titleforecolor = (int)(0xFFFFFF) ;
         subGrid_Titlefont = "font-family:Verdana;font-size:8pt;font-weight:bold;" ;
         ...
         Form.Caption = "Work With Gestores por Grupo" ;
         edtavUpdate_Tooltiptext = "Modifica" ;
         edtavDelete_Tooltiptext = "Eliminar" ;
      }
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "" ;
         lV13Grupo_Des = "" ;
         H00102_A277Ges_Des = new String[] {""} ;
         H00102_n277Ges_Des = new bool[] {false} ;
         H00102_A270Ges_Cod = new String[] {""} ;
         H00102_A273Grupo_Des = new String[] {""} ;
         H00102_A271Grupo_Cod = new short[1] ;
         H00103_AGRID_nRecordCount = new int[1] ;
         ...
         GXt_char6 = "" ;
         lblFiltertextgrupo_des_Jsonclick = "" ;
         ...
         ROClassString = "" ;
         GXt_char7 = "" ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwgpo_ges__default(),
            new Object[][] {
                new Object[] {
               H00102_A277Ges_Des, H00102_n277Ges_Des, H00102_A270Ges_Cod, H00102_A273Grupo_Des, H00102_A271Grupo_Cod
               }
               , new Object[] {
      ...
      private String edtavGrupo_des_Internalname ;
      private String scmdbuf ;
      private String lV13Grupo_Des ;
      ...
      private String lblFiltertextgrupo_des_Internalname ;
      private String lblFiltertextgrupo_des_Jsonclick ;
      private String edtavGrupo_des_Jsonclick ;
      ...
      private String[] H00102_A277Ges_Des ;
      private bool[] H00102_n277Ges_Des ;
      private String[] H00102_A270Ges_Cod ;
      private String[] H00102_A273Grupo_Des ;
      private short[] H00102_A271Grupo_Cod ;
      private int[] H00103_AGRID_nRecordCount ;
   ...
   public class wwgpo_ges__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H00102( String AV13Grupo_Des ,
                                             String A273Grupo_Des )
      {
         String sWhereString = "" ;
         String scmdbuf ;
         short[] GXv_int8 ;
         ...
         scmdbuf = "SELECT T2.[USU_DES] AS Ges_Des, T1.[Ges_Cod] AS Ges_Cod, T1.[Grupo_Des], T1.[Grupo_Cod] FROM ([GPO_GES] T1 WITH (NOLOCK) INNER JOIN [SEG002] T2 WITH (NOLOCK) ON T2.[USU_COD] = T1.[Ges_Cod])" ;
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV13Grupo_Des)) )
         {
            if ( StringUtil.StrCmp("", sWhereString) != 0 )
            {
               sWhereString = sWhereString + " and (UPPER(T1.[Grupo_Des]) like '%' + UPPER(@AV13Grupo_Des))" ;
            }
            else
            {
               sWhereString = sWhereString + " (UPPER(T1.[Grupo_Des]) like '%' + UPPER(@AV13Grupo_Des))" ;
            }
         }
         else
         {
         ...
         scmdbuf = scmdbuf + " ORDER BY T1.[Grupo_Cod]" ;
         GXv_Object9[0] = scmdbuf ;
         GXv_Object9[1] = (Object)(GXv_int8) ;
         return GXv_Object9 ;
      }

      protected Object[] conditional_H00103( String AV13Grupo_Des ,
                                             String A273Grupo_Des )
      {
         String sWhereString = "" ;
         String scmdbuf ;
         ...
         scmdbuf = "SELECT COUNT(*) FROM ([GPO_GES] T1 WITH (NOLOCK) INNER JOIN [SEG002] T2 WITH (NOLOCK) ON T2.[USU_COD] = T1.[Ges_Cod])" ;
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV13Grupo_Des)) )
         {
            if ( StringUtil.StrCmp("", sWhereString) != 0 )
            {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00102( (String)dynConstraints[0] , (String)dynConstraints[1] );
               case 1 :
                     return conditional_H00103( (String)dynConstraints[0] , (String)dynConstraints[1] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV13Grupo_Des",SqlDbType.Char,20,0}
          } ;
          Object[] prmH00103 ;
