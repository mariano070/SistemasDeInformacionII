...
using System.IO;
public class bldgpo_ges : GxBaseBuilder
{
   string cs_path = "." ;
   public bldgpo_ges( ) : base()
   {
   }
   ...
   {
      bldgpo_ges x = new bldgpo_ges() ;
      x.SetMainSourceFile( "gpo_ges.cs");
   ...
   {
      ItemCollection sc = new ItemCollection() ;
      sc.Add( @"bin\gpo_ges.dll", cs_path + @"\gpo_ges.rsp");
      return sc ;
   }
