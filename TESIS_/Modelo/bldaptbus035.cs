...
using System.IO;
public class bldaptbus035 : GxBaseBuilder
{
   string cs_path = "." ;
   public bldaptbus035( ) : base()
   {
   }
   ...
   {
      bldaptbus035 x = new bldaptbus035() ;
      x.SetMainSourceFile( "aptbus035.cs");
   ...
   {
      ItemCollection sc = new ItemCollection() ;
      sc.Add( @"bin\aptbus035.dll", cs_path + @"\aptbus035.rsp");
      return sc ;
   }
