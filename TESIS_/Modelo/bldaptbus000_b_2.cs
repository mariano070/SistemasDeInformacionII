...
using System.IO;
public class bldaptbus000_b_2 : GxBaseBuilder
{
   string cs_path = "." ;
   public bldaptbus000_b_2( ) : base()
   {
   }
   ...
   {
      bldaptbus000_b_2 x = new bldaptbus000_b_2() ;
      x.SetMainSourceFile( "aptbus000_b_2.cs");
   ...
   {
      ItemCollection sc = new ItemCollection() ;
      sc.Add( @"bin\aptbus000_b_2.exe", cs_path + @"\aptbus000_b_2.rsp");
      return sc ;
   }
