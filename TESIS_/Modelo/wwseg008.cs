/*
               File: WWSEG008
        Description: Work With INFO MENUES X
             Author: GeneXus C# Generator version 10_1_5-42940
       Generated on: 1/6/2014 11:20:23.6
...
namespace GeneXus.Programs {
   public class wwseg008 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public wwseg008( )
      {
      ...
      public wwseg008( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               /* GeneXus formulas. */
               AV18Pgmname = "WWSEG008" ;
               context.Gx_err = 0 ;
               Grid_PageSize26 = (int)(NumberUtil.Val( GetNextPar( ), ".")) ;
               AV13MNU_NID = GetNextPar( ) ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV13MNU_NID", AV13MNU_NID);
               edtavDelete_Tooltiptext = GetNextPar( ) ;
               context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavDelete_Internalname, "Tooltiptext", edtavDelete_Tooltiptext);
               AV15Delete = GetNextPar( ) ;
               context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavDelete_Internalname, "Bitmap", context.convertURL( AV15Delete));
               ...
               gxgrGrid_refresh( Grid_PageSize26, AV13MNU_NID, AV15Delete, AV14Update) ;
               return  ;
            }
            else
            {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" onsubmit=\"try{return gx.csv.validForm()}catch(e){return true;}\" name=\"MAINFORM\" method=\"post\" action=\""+formatLink("wwseg008.aspx") +"\" class=\""+"Form"+"\">") ;
      ...
      public override void RenderHtmlCloseForm( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vMNU_NID", StringUtil.RTrim( AV13MNU_NID));
         /* Send saved values. */
      ...
      {
         return "Work With INFO MENUES X" ;
      }
      ...
      {
         return formatLink("wwseg008.aspx")  ;
      }
      ...
      protected void START342( )
      {
         ...
         Form.Meta.addItem("Description", "Work With INFO MENUES X", 0) ;
         context.wjLoc = "" ;
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            if ( String.IsNullOrEmpty(StringUtil.RTrim( context.wjLoc)) && ( context.nUserReturn != 1 ) && ! wbErr )
            {
               ...
               if ( StringUtil.Len( sEvt) > 0 )
               {
                  ...
                  if ( StringUtil.StrCmp(cgiGet( "GXH_vMNU_NID"), AV13MNU_NID) != 0 )
                  {
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 10), "'DOINSERT'") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              edtMNU_NIV_Internalname = "MNU_NIV_"+sGXsfl_26_idx ;
                              edtMNU_NID_Internalname = "MNU_NID_"+sGXsfl_26_idx ;
                              edtMNU_LINK_Internalname = "MNU_LINK_"+sGXsfl_26_idx ;
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    {
                                       Rfr0gs = false ;
                                       /* Set Refresh If Mnu_nid Changed */
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vMNU_NID"), AV13MNU_NID) != 0 )
                                       {
                                          Rfr0gs = true ;
                                       }
      ...
      protected void PA342( )
      {
         if ( nDonePA == 0 )
         {
            GX_FocusControl = edtavMnu_nid_Internalname ;
      ...
      protected void RF342( )
      {
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( context.wjLoc)) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV13MNU_NID = StringUtil.PadR( StringUtil.RTrim( AV13MNU_NID), 100, "%") ;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV13MNU_NID", AV13MNU_NID);
            /* Using cursor H00342 */
            pr_default.execute(0, new Object[] {lV13MNU_NID});
            nGXsfl_26_idx = 1 ;
            GRID_nEOF = 0 ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < GRID_nFirstRecordOnPage + subGrid_Recordsperpage( ) ) ) ) )
            {
               A362MNU_LINK = H00342_A362MNU_LINK[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A362MNU_LINK", A362MNU_LINK);
               A129MNU_NID = H00342_A129MNU_NID[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A129MNU_NID", A129MNU_NID);
               A361MNU_NIV = H00342_A361MNU_NIV[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A361MNU_NIV", StringUtil.LTrim( StringUtil.Str( (decimal)(A361MNU_NIV), 6, 0)));
               A127PRG_DES = H00342_A127PRG_DES[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A127PRG_DES", A127PRG_DES);
               A126PRG_COD = H00342_A126PRG_COD[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A126PRG_COD", StringUtil.LTrim( StringUtil.Str( (decimal)(A126PRG_COD), 4, 0)));
               A127PRG_DES = H00342_A127PRG_DES[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A127PRG_DES", A127PRG_DES);
               /* Execute user event: E14342 */
      ...
      protected int subGrid_Recordcount( )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV13MNU_NID", AV13MNU_NID);
         /* Using cursor H00343 */
         pr_default.execute(1, new Object[] {lV13MNU_NID});
      ...
      protected void STRUP340( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV13MNU_NID = cgiGet( edtavMnu_nid_Internalname) ;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV13MNU_NID", AV13MNU_NID);
            /* Read saved values. */
      ...
      protected void E12342( )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavDelete_Internalname, "Tooltiptext", edtavDelete_Tooltiptext);
         Form.Caption = "Work With INFO MENUES XS" ;
      ...
      {
         /* Grid_Load Routine */
         edtavUpdate_Link = formatLink("seg008.aspx") + "?" + UrlEncode(StringUtil.RTrim("UPD")) + "," + UrlEncode("" +A126PRG_COD) + "," + UrlEncode("" +A361MNU_NIV) ;
         context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavUpdate_Internalname, "Link", edtavUpdate_Link);
         edtavDelete_Link = formatLink("seg008.aspx") + "?" + UrlEncode(StringUtil.RTrim("DLT")) + "," + UrlEncode("" +A126PRG_COD) + "," + UrlEncode("" +A361MNU_NIV) ;
      ...
      {
         /* 'DoInsert' Routine */
         context.wjLoc = formatLink("seg008.aspx") + "?" + UrlEncode(StringUtil.RTrim("INS")) + "," + UrlEncode("" +0) + "," + UrlEncode("" +0) ;
      }
      ...
      protected void S122( )
      {
         ...
         if ( StringUtil.StrCmp(AV8HTTPRequest.Method, "GET") == 0 )
         {
            ...
            {
               AV13MNU_NID = ((SdtGridState_FilterValue)AV9GridState.gxTpr_Filtervalues.Item(1)).gxTpr_Value ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV13MNU_NID", AV13MNU_NID);
            }
      ...
      protected void S132( )
      {
         ...
         AV10GridStateFilterValue.gxTpr_Value = AV13MNU_NID ;
      ...
      protected void S112( )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "AV11TrnContext", (Object)(AV11TrnContext));
         AV11TrnContext.gxTpr_Transactionname = "SEG008" ;
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "AV11TrnContext", (Object)(AV11TrnContext));
      ...
      protected void wb_table1_2_342( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            ClassString = "" ;
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, 1, 1, 0, "Work With INFO MENUES XS", "", "", "", 0, lblTitletext_Jsonclick, "", StyleString, ClassString, "HLP_WWSEG008.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            wb_table2_8_342( true) ;
         }
         else
         {
            wb_table2_8_342( false) ;
         }
         return  ;
      }

      protected void wb_table2_8_342e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            wb_table3_19_342( true) ;
         }
         else
         {
            wb_table3_19_342( false) ;
         }
         return  ;
      }

      protected void wb_table3_19_342e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
      ...
      protected void wb_table3_19_342( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            StyleString = "" ;
            GxWebStd.gx_bitmap( context, imgInsert_Internalname, "", context.GetImagePath( "5649fbb8-8ce0-4810-a5ce-bd649ea83c3a", "", "Modern"), "Modern", 1, 1, "", "Agrega", 0, 0, 0, "", 0, "", 0, 0, "", "", 5, imgInsert_Jsonclick, "E\\'DOINSERT\\'.", StyleString, ClassString, "", ""+TempTags, "", "", "HLP_WWSEG008.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            ...
            else
            {
               ...
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
               GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A361MNU_NIV), 6, 0, ".", "")));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
               GridColumn.AddObjectProperty("Value", StringUtil.RTrim( A129MNU_NID));
               GridColumn.AddObjectProperty("Link", StringUtil.RTrim( edtMNU_NID_Link));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
               GridColumn.AddObjectProperty("Value", StringUtil.RTrim( A362MNU_LINK));
               GridContainer.AddColumnProperties(GridColumn);
         ...
         if ( wbEnd == 26 )
         {
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_19_342e( true) ;
         }
         else
         {
            wb_table3_19_342e( false) ;
         }
      }

      protected void wb_table2_8_342( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblFiltertextmnu_nid_Internalname, 1, 1, 0, "TITULO", "", "", "", 0, lblFiltertextmnu_nid_Jsonclick, "", StyleString, ClassString, "HLP_WWSEG008.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            ...
            StyleString = "" ;
            GxWebStd.gx_single_line_edit( context, edtavMnu_nid_Internalname, StringUtil.RTrim( AV13MNU_NID), "", 80, "chr", 1, "row", 100, 1, 1, 0, 0, 0, "", "", StyleString, ClassString, "", StringUtil.RTrim( context.localUtil.Format( AV13MNU_NID, "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(13);\"", 0, edtavMnu_nid_Jsonclick, "", 0, 1, -1, true, "left", "HLP_WWSEG008.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            ...
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTableseparator_Internalname, 1, 1, 0, " ", "", "", "", 0, lblTableseparator_Jsonclick, "", StyleString, ClassString, "HLP_WWSEG008.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "</tbody>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_8_342e( true) ;
         }
         else
         {
            wb_table2_8_342e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( Form.Jscriptsrc.Item(idxLst)), "?11202356");
            idxLst = (int)(idxLst+1) ;
         }
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwseg008.js", "?11202356");
         }
      ...
      protected void sendrow_262( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_26_idx <= subGrid_Recordsperpage( ) * 1 ) )
         {
            ...
            StyleString = "" ;
            ROClassString = ClassString ;
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtMNU_NIV_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A361MNU_NIV), 6, 0, ",", "")),(String)"",(short)0,(String)"px",(short)17,(String)"",(short)6,(short)-1,(short)0,(short)0,(short)0,(short)0,(String)"",(String)"",(String)StyleString,(String)ClassString,(String)ROClassString,context.localUtil.Format( (decimal)(A361MNU_NIV), "ZZZZZ9"),(String)"",(short)0,(String)edtMNU_NIV_Jsonclick,(String)"",(short)26,(short)1,(short)1,(bool)true,(String)"right"});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+((-1==0) ? "display:none;" : "")+"\">") ;
            ...
            StyleString = "" ;
            ROClassString = ClassString ;
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtMNU_LINK_Internalname,StringUtil.RTrim( A362MNU_LINK),(String)"",(short)0,(String)"px",(short)17,(String)"",(short)256,(short)0,(short)0,(short)0,(short)0,(short)0,(String)"",(String)"",(String)StyleString,(String)ClassString,(String)ROClassString,StringUtil.RTrim( context.localUtil.Format( A362MNU_LINK, "")),(String)"",(short)0,(String)edtMNU_LINK_Jsonclick,(String)"",(short)26,(short)1,(short)1,(bool)true,(String)"left"});
      ...
      protected void init_default_properties( )
      {
         ...
         lblFiltertextmnu_nid_Internalname = "FILTERTEXTMNU_NID" ;
         edtavMnu_nid_Internalname = "vMNU_NID" ;
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Work With INFO MENUES X" ;
         edtavUpdate_Tooltiptext = "Modifica" ;
         edtavDelete_Tooltiptext = "Eliminar" ;
      }
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "" ;
         lV13MNU_NID = "" ;
         H00342_A362MNU_LINK = new String[] {""} ;
         H00342_A129MNU_NID = new String[] {""} ;
         H00342_A361MNU_NIV = new int[1] ;
         H00342_A127PRG_DES = new String[] {""} ;
         H00342_A126PRG_COD = new short[1] ;
         H00343_AGRID_nRecordCount = new int[1] ;
         ...
         GXt_char7 = "" ;
         lblFiltertextmnu_nid_Jsonclick = "" ;
         ...
         ROClassString = "" ;
         GXt_char8 = "" ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwseg008__default(),
            new Object[][] {
                new Object[] {
               H00342_A362MNU_LINK, H00342_A129MNU_NID, H00342_A361MNU_NIV, H00342_A127PRG_DES, H00342_A126PRG_COD
               }
               , new Object[] {
      ...
      private String edtavMnu_nid_Internalname ;
      private String scmdbuf ;
      private String lV13MNU_NID ;
      ...
      private String lblFiltertextmnu_nid_Internalname ;
      private String lblFiltertextmnu_nid_Jsonclick ;
      private String edtavMnu_nid_Jsonclick ;
      ...
      private String edtMNU_LINK_Jsonclick ;
      ...
      private String[] H00342_A362MNU_LINK ;
      private String[] H00342_A129MNU_NID ;
      private int[] H00342_A361MNU_NIV ;
      private String[] H00342_A127PRG_DES ;
      private short[] H00342_A126PRG_COD ;
      private int[] H00343_AGRID_nRecordCount ;
   ...
   public class wwseg008__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H00342( String AV13MNU_NID ,
                                             String A129MNU_NID )
      {
         String sWhereString = "" ;
         String scmdbuf ;
         ...
         scmdbuf = "SELECT T1.[MNU_LINK], T1.[MNU_NID], T1.[MNU_NIV], T2.[PRG_DES], T1.[PRG_COD] FROM ([SEG008] T1 WITH (NOLOCK) INNER JOIN [SEG001] T2 WITH (NOLOCK) ON T2.[PRG_COD] = T1.[PRG_COD])" ;
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV13MNU_NID)) )
         {
            if ( StringUtil.StrCmp("", sWhereString) != 0 )
            {
               sWhereString = sWhereString + " and (T1.[MNU_NID] like @AV13MNU_NID)" ;
            }
            else
            {
               sWhereString = sWhereString + " (T1.[MNU_NID] like @AV13MNU_NID)" ;
            }
         }
         else
         {
         ...
         scmdbuf = scmdbuf + " ORDER BY T1.[MNU_NID]" ;
         GXv_Object10[0] = scmdbuf ;
         GXv_Object10[1] = (Object)(GXv_int9) ;
         return GXv_Object10 ;
      }

      protected Object[] conditional_H00343( String AV13MNU_NID ,
                                             String A129MNU_NID )
      {
         String sWhereString = "" ;
         String scmdbuf ;
         ...
         scmdbuf = "SELECT COUNT(*) FROM ([SEG008] T1 WITH (NOLOCK) INNER JOIN [SEG001] T2 WITH (NOLOCK) ON T2.[PRG_COD] = T1.[PRG_COD])" ;
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV13MNU_NID)) )
         {
            if ( StringUtil.StrCmp("", sWhereString) != 0 )
            {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00342( (String)dynConstraints[0] , (String)dynConstraints[1] );
               case 1 :
                     return conditional_H00343( (String)dynConstraints[0] , (String)dynConstraints[1] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV13MNU_NID",SqlDbType.Char,100,0}
          } ;
          Object[] prmH00343 ;
          ...
          def= new CursorDef[] {
              new CursorDef("H00342", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00342,11,1,true,false )
             ,new CursorDef("H00343", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00343,1,1,true,false )
          };
       }
    }
