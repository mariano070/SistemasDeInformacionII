/*
       ...
       Generated on: 1/6/2014 11:19:4.67
...
namespace GeneXus.Programs {
   public class htbus030_2 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public htbus030_2( )
      {
      ...
      public htbus030_2( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxSuggest"+"_"+"vFTTBUS_DESCRIPCION") == 0 )
            {
               ...
               GXSGVvFTTBUS_DESCRIPCION1Z0( A12TTBUS_Descripcion) ;
               return  ;
            }
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxSuggest"+"_"+"vGTTBUS_DESCRIPCION") == 0 )
            {
               ...
               GXSGVvGTTBUS_DESCRIPCION1Z0( A12TTBUS_Descripcion) ;
               return  ;
            }
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
            {
               ...
               {
                  dynavFididentificador.addItem(StringUtil.Str( (decimal)(H001Z2_A20TTBUS5_IdIdentificador[0]), 8, 0), H001Z2_A21TTBUS5_DescIdentificador[0], 0);
               ...
               if ( ( cmbavGttbus_empresa.ItemCount > 0 ) && (0==AV63gTTBUS_Empresa) )
               {
                  AV63gTTBUS_Empresa = (short)(NumberUtil.Val( cmbavGttbus_empresa.getItemValue(1), ".")) ;
                  context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV63gTTBUS_Empresa", StringUtil.Str( (decimal)(AV63gTTBUS_Empresa), 1, 0));
               }
               ...
               {
                  dynavGididentificador.addItem(StringUtil.Str( (decimal)(H001Z3_A20TTBUS5_IdIdentificador[0]), 8, 0), H001Z3_A21TTBUS5_DescIdentificador[0], 0);
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" onsubmit=\"try{return gx.csv.validForm()}catch(e){return true;}\" name=\"MAINFORM\" method=\"post\" action=\""+formatLink("htbus030_2.aspx") + "?" + UrlEncode("" +AV61pTTBUS_Id)+"\" class=\""+"Form"+"\">") ;
      ...
      {
         return formatLink("htbus030_2.aspx") + "?" + UrlEncode("" +AV61pTTBUS_Id) ;
      }
      ...
      protected void WB1Z0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_3_1Z2( true) ;
         }
         else
         {
            wb_table1_3_1Z2( false) ;
         }
         return  ;
      }

      protected void wb_table1_3_1Z2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</p>") ;
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 15), "'VISUALIZACION'") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 10), "GRID1.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 13), "'MOVIMIENTOS'") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 20), "'LISTAR MOVIMIENTOS'") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 8), "'BUSCAR'") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 15), "'VISUALIZACION'") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) )
                           {
                              ...
                              AV62gNro_serie = cgiGet( edtavGnro_serie_Internalname) ;
                              context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV62gNro_serie", AV62gNro_serie);
                              ...
                              AV63gTTBUS_Empresa = (short)(NumberUtil.Val( cgiGet( cmbavGttbus_empresa_Internalname), ".")) ;
                              context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV63gTTBUS_Empresa", StringUtil.Str( (decimal)(AV63gTTBUS_Empresa), 1, 0));
      ...
      protected void PA1Z2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            {
               dynavFididentificador.addItem(StringUtil.Str( (decimal)(H001Z4_A20TTBUS5_IdIdentificador[0]), 8, 0), H001Z4_A21TTBUS5_DescIdentificador[0], 0);
            ...
            {
               dynavGididentificador.addItem(StringUtil.Str( (decimal)(H001Z5_A20TTBUS5_IdIdentificador[0]), 8, 0), H001Z5_A21TTBUS5_DescIdentificador[0], 0);
      ...
      protected void GXSGVvFTTBUS_DESCRIPCION1Z0( String A12TTBUS_Descripcion )
      {
         if ( ! context.isAjaxRequest( ) )
         {
            context.GX_webresponse.AppendHeader("Cache-Control", "max-age=0");
         ...
         GXSGVvFTTBUS_DESCRIPCION_data1Z0( A12TTBUS_Descripcion) ;
         gxdynajaxindex = 1 ;
      ...
      protected void GXSGVvFTTBUS_DESCRIPCION_data1Z0( String A12TTBUS_Descripcion )
      {
         ...
         {
            gxdynajaxctrlcodr.Add(StringUtil.RTrim( H001Z6_A12TTBUS_Descripcion[0]));
            gxdynajaxctrldescr.Add(StringUtil.RTrim( H001Z6_A12TTBUS_Descripcion[0]));
            pr_default.readNext(4);
         }
         pr_default.close(4);
      }

      protected void GXSGVvGTTBUS_DESCRIPCION1Z0( String A12TTBUS_Descripcion )
      {
         if ( ! context.isAjaxRequest( ) )
         {
            context.GX_webresponse.AppendHeader("Cache-Control", "max-age=0");
         ...
         context.GX_webresponse.AddString("(new Array( new Array(");
         GXSGVvGTTBUS_DESCRIPCION_data1Z0( A12TTBUS_Descripcion) ;
         gxdynajaxindex = 1 ;
         while ( gxdynajaxindex <= gxdynajaxctrlcodr.Count )
         {
            context.GX_webresponse.AddString(gxwrpcisep+"{c:\""+GXUtil.EncodeJSConstant( gxdynajaxctrlcodr.Item(gxdynajaxindex))+"\",d:\""+GXUtil.EncodeJSConstant( gxdynajaxctrldescr.Item(gxdynajaxindex))+"\"}");
      ...
      protected void GXSGVvGTTBUS_DESCRIPCION_data1Z0( String A12TTBUS_Descripcion )
      {
         l12TTBUS_Descripcion = StringUtil.PadR( StringUtil.RTrim( A12TTBUS_Descripcion), 50, "%") ;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A12TTBUS_Descripcion", A12TTBUS_Descripcion);
         /* Using cursor H001Z7 */
         ...
         {
            gxdynajaxctrlcodr.Add(StringUtil.RTrim( H001Z7_A12TTBUS_Descripcion[0]));
            gxdynajaxctrldescr.Add(StringUtil.RTrim( H001Z7_A12TTBUS_Descripcion[0]));
      ...
      private void E161Z2( )
      {
         ...
         pr_default.dynParam(6, new Object[]{ new Object[]{
                                              ...
                                              TypeConstants.STRING, TypeConstants.STRING, TypeConstants.DATE, TypeConstants.BOOLEAN, TypeConstants.SHORT, TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.INT, TypeConstants.INT
                                              }
         });
         ...
         {
            A11TTBUS_Id = H001Z8_A11TTBUS_Id[0] ;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A11TTBUS_Id", StringUtil.LTrim( StringUtil.Str( (decimal)(A11TTBUS_Id), 8, 0)));
            A37TTBUS_CodPosicion = H001Z8_A37TTBUS_CodPosicion[0] ;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A37TTBUS_CodPosicion", StringUtil.LTrim( StringUtil.Str( (decimal)(A37TTBUS_CodPosicion), 3, 0)));
            A15NumeroIdentificador = H001Z8_A15NumeroIdentificador[0] ;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A15NumeroIdentificador", A15NumeroIdentificador);
            A14IdIdentificador = H001Z8_A14IdIdentificador[0] ;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A14IdIdentificador", StringUtil.LTrim( StringUtil.Str( (decimal)(A14IdIdentificador), 8, 0)));
            A10HARDWARE_ID = H001Z8_A10HARDWARE_ID[0] ;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A10HARDWARE_ID", StringUtil.LTrim( StringUtil.Str( (decimal)(A10HARDWARE_ID), 4, 0)));
            n10HARDWARE_ID = H001Z8_n10HARDWARE_ID[0] ;
            A17TTBUS_RubroBien = H001Z8_A17TTBUS_RubroBien[0] ;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A17TTBUS_RubroBien", StringUtil.LTrim( StringUtil.Str( (decimal)(A17TTBUS_RubroBien), 4, 0)));
            A13TTBUS_FechaCarga = H001Z8_A13TTBUS_FechaCarga[0] ;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A13TTBUS_FechaCarga", context.localUtil.Format(A13TTBUS_FechaCarga, "99/99/9999"));
            A12TTBUS_Descripcion = H001Z8_A12TTBUS_Descripcion[0] ;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A12TTBUS_Descripcion", A12TTBUS_Descripcion);
            A23TTBUS_Estado = H001Z8_A23TTBUS_Estado[0] ;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A23TTBUS_Estado", StringUtil.Str( (decimal)(A23TTBUS_Estado), 1, 0));
            A16TTBUS_FechaBaja = H001Z8_A16TTBUS_FechaBaja[0] ;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A16TTBUS_FechaBaja", context.localUtil.Format(A16TTBUS_FechaBaja, "99/99/9999"));
            n16TTBUS_FechaBaja = H001Z8_n16TTBUS_FechaBaja[0] ;
            A3BUS_COD = H001Z8_A3BUS_COD[0] ;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A3BUS_COD", StringUtil.LTrim( StringUtil.Str( (decimal)(A3BUS_COD), 4, 0)));
            n3BUS_COD = H001Z8_n3BUS_COD[0] ;
            A8BUS_EMP = H001Z8_A8BUS_EMP[0] ;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A8BUS_EMP", A8BUS_EMP);
            n8BUS_EMP = H001Z8_n8BUS_EMP[0] ;
            A4BUS_PAR = H001Z8_A4BUS_PAR[0] ;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A4BUS_PAR", StringUtil.LTrim( StringUtil.Str( (decimal)(A4BUS_PAR), 2, 0)));
            n4BUS_PAR = H001Z8_n4BUS_PAR[0] ;
            A1BUS_RUB = H001Z8_A1BUS_RUB[0] ;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A1BUS_RUB", StringUtil.LTrim( StringUtil.Str( (decimal)(A1BUS_RUB), 4, 0)));
            n1BUS_RUB = H001Z8_n1BUS_RUB[0] ;
            A29TTBUS_Alquilado = H001Z8_A29TTBUS_Alquilado[0] ;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A29TTBUS_Alquilado", StringUtil.Str( (decimal)(A29TTBUS_Alquilado), 1, 0));
            A27TTBUS_CodProveedor = H001Z8_A27TTBUS_CodProveedor[0] ;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A27TTBUS_CodProveedor", StringUtil.LTrim( StringUtil.Str( (decimal)(A27TTBUS_CodProveedor), 8, 0)));
            n27TTBUS_CodProveedor = H001Z8_n27TTBUS_CodProveedor[0] ;
            A38TTBUS_DesPosicion = H001Z8_A38TTBUS_DesPosicion[0] ;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A38TTBUS_DesPosicion", A38TTBUS_DesPosicion);
            A30TTBUS_DesProveedor = H001Z8_A30TTBUS_DesProveedor[0] ;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A30TTBUS_DesProveedor", A30TTBUS_DesProveedor);
            A18TTBUS_RubroDesc = H001Z8_A18TTBUS_RubroDesc[0] ;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A18TTBUS_RubroDesc", A18TTBUS_RubroDesc);
            n18TTBUS_RubroDesc = H001Z8_n18TTBUS_RubroDesc[0] ;
            A41TTBUS_Empresa = H001Z8_A41TTBUS_Empresa[0] ;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A41TTBUS_Empresa", StringUtil.Str( (decimal)(A41TTBUS_Empresa), 1, 0));
            A42TTBUS_NroSerie = H001Z8_A42TTBUS_NroSerie[0] ;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A42TTBUS_NroSerie", A42TTBUS_NroSerie);
            A37TTBUS_CodPosicion = H001Z8_A37TTBUS_CodPosicion[0] ;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A37TTBUS_CodPosicion", StringUtil.LTrim( StringUtil.Str( (decimal)(A37TTBUS_CodPosicion), 3, 0)));
            A10HARDWARE_ID = H001Z8_A10HARDWARE_ID[0] ;
            ...
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV6gNumeroIdentificador", AV6gNumeroIdentificador);
            AV63gTTBUS_Empresa = A41TTBUS_Empresa ;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV63gTTBUS_Empresa", StringUtil.Str( (decimal)(AV63gTTBUS_Empresa), 1, 0));
            AV62gNro_serie = A42TTBUS_NroSerie ;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV62gNro_serie", AV62gNro_serie);
            if ( A23TTBUS_Estado == 1 )
            {
               ...
               {
                  A33TTBUS7_Pos = H001Z9_A33TTBUS7_Pos[0] ;
                  context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A33TTBUS7_Pos", StringUtil.LTrim( StringUtil.Str( (decimal)(A33TTBUS7_Pos), 3, 0)));
                  A35TTBUS7_CodResp = H001Z9_A35TTBUS7_CodResp[0] ;
                  context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A35TTBUS7_CodResp", A35TTBUS7_CodResp);
                  A36TTBUS7_DesResp = H001Z9_A36TTBUS7_DesResp[0] ;
                  context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A36TTBUS7_DesResp", A36TTBUS7_DesResp);
                  n36TTBUS7_DesResp = H001Z9_n36TTBUS7_DesResp[0] ;
                  A36TTBUS7_DesResp = H001Z9_A36TTBUS7_DesResp[0] ;
                  context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A36TTBUS7_DesResp", A36TTBUS7_DesResp);
                  n36TTBUS7_DesResp = H001Z9_n36TTBUS7_DesResp[0] ;
            ...
            {
               /* Using cursor H001Z10 */
               pr_default.execute(8, new Object[] {A11TTBUS_Id});
               while ( (pr_default.getStatus(8) != 101) )
               {
                  A22TTBUS2_IdBien = H001Z10_A22TTBUS2_IdBien[0] ;
                  ...
                  A26TTBUS2_EstadoEnvio = H001Z10_A26TTBUS2_EstadoEnvio[0] ;
                  ...
                  A24TTBUS2_RespDesde = H001Z10_A24TTBUS2_RespDesde[0] ;
                  context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A24TTBUS2_RespDesde", A24TTBUS2_RespDesde);
                  A25TTBUS2_RespHacia = H001Z10_A25TTBUS2_RespHacia[0] ;
                  context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A25TTBUS2_RespHacia", A25TTBUS2_RespHacia);
      ...
      protected void S112( )
      {
         ...
         AV8band = 0 ;
         /* Using cursor H001Z11 */
         pr_default.execute(9, new Object[] {AV53USUARIO});
         while ( (pr_default.getStatus(9) != 101) )
         {
            A40TTBUS8_CodUsuario = H001Z11_A40TTBUS8_CodUsuario[0] ;
      ...
      protected void S125( )
      {
         ...
         /* Using cursor H001Z14 */
         pr_default.execute(12, new Object[] {AV48TTBUS2_RespDesde});
         while ( (pr_default.getStatus(12) != 101) )
         {
            A6USU_COD = H001Z14_A6USU_COD[0] ;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A6USU_COD", A6USU_COD);
            A7USU_DES = H001Z14_A7USU_DES[0] ;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A7USU_DES", A7USU_DES);
         ...
         pr_default.close(12);
         /* Using cursor H001Z15 */
         pr_default.execute(13, new Object[] {AV49TTBUS2_RespHacia});
         while ( (pr_default.getStatus(13) != 101) )
         {
            A6USU_COD = H001Z15_A6USU_COD[0] ;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A6USU_COD", A6USU_COD);
            A7USU_DES = H001Z15_A7USU_DES[0] ;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A7USU_DES", A7USU_DES);
      ...
      protected void wb_table1_3_1Z2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
      ...
      protected void wb_table2_9_1Z2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            else
            {
               ...
               Grid1Container.AddColumnProperties(Grid1Column);
               Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( )) ;
               Grid1Column.AddObjectProperty("Value", StringUtil.RTrim( AV62gNro_serie));
               Grid1Column.AddObjectProperty("Enabled", StringUtil.LTrim( StringUtil.NToC( (decimal)(edtavGnro_serie_Enabled), 5, 0, ".", "")));
               Grid1Container.AddColumnProperties(Grid1Column);
               Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( )) ;
               Grid1Column.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV63gTTBUS_Empresa), 1, 0, ".", "")));
         ...
         if ( wbEnd == 57 )
         {
            ...
            ClassString = "Button" ;
            StyleString = "" ;
            GxWebStd.gx_button_ctrl( context, context.GetButtonType( ), bttButton1_Internalname, "Ver Movimientos del Bien", "Ver Movimientos del Bien", "", StyleString, ClassString, 1, 1, "rounded", 5, bttButton1_Jsonclick, "E\\'MOVIMIENTOS\\'.", TempTags, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(57), 3, 0)+","+"null"+");", "", "HLP_HTBUS030_2.htm");
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 85,'',false,'',0)\"" ;
            ClassString = "Button" ;
            StyleString = "" ;
            GxWebStd.gx_button_ctrl( context, context.GetButtonType( ), bttButton4_Internalname, "Listar Movimientos del Bien", "Listar Movimientos del Bien", "", StyleString, ClassString, 1, 1, "rounded", 5, bttButton4_Jsonclick, "E\\'LISTAR MOVIMIENTOS\\'.", TempTags, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(57), 3, 0)+","+"null"+");", "", "HLP_HTBUS030_2.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "</tbody>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_3_1Z2e( true) ;
         }
         else
         {
            wb_table1_3_1Z2e( false) ;
         }
      }
      ...
      protected void wb_table2_9_1Z2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblock7_Internalname, 1, 1, 0, "Tipo Identificador:", "", "", "", 0, lblTextblock7_Jsonclick, "", StyleString, ClassString, "HLP_HTBUS030_2.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            ...
            ClassString = "TextBlock" ;
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblock1_Internalname, 1, 1, 0, "Nº Bien:", "", "", "", 0, lblTextblock1_Jsonclick, "", StyleString, ClassString, "HLP_HTBUS030_2.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            ...
            ClassString = "TextBlock" ;
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblock8_Internalname, 1, 1, 0, "Cód. Identificador:", "", "", "", 0, lblTextblock8_Jsonclick, "", StyleString, ClassString, "HLP_HTBUS030_2.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            ...
            ClassString = "TextBlock" ;
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblock6_Internalname, 1, 1, 0, "Fecha de Carga:", "", "", "", 0, lblTextblock6_Jsonclick, "", StyleString, ClassString, "HLP_HTBUS030_2.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            ...
            GxWebStd.gx_single_line_edit( context, edtavTtbus_fechacarga_Internalname, context.localUtil.Format(AV46TTBUS_FechaCarga, "99/99/9999"), "", 10, "chr", 1, "row", 10, 1, 1, 0, 0, 0, "", "", StyleString, ClassString, "", context.localUtil.Format( AV46TTBUS_FechaCarga, "99/99/9999"), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.date.valid_date(this, 10,'DMY',0,24,'spa',false,0);"+";gx.evt.onblur(29);\"", 0, edtavTtbus_fechacarga_Jsonclick, "", 0, 1, -1, true, "right", "HLP_HTBUS030_2.htm");
            GxWebStd.gx_bitmap( context, edtavTtbus_fechacarga_Internalname+"_dp_trigger", "", "calendar-img.gif", "", ((1==0)||(1==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, "", "", 0, "", "", "cursor: pointer;vertical-align:text-bottom", "", "", "", "", "", "HLP_HTBUS030_2.htm");
            ...
            ClassString = "TextBlock" ;
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblock5_Internalname, 1, 1, 0, "Descripción:", "", "", "", 0, lblTextblock5_Jsonclick, "", StyleString, ClassString, "HLP_HTBUS030_2.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            ...
            ClassString = "TextBlock" ;
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblock9_Internalname, 1, 1, 0, "Rubro", "", "", "", 0, lblTextblock9_Jsonclick, "", StyleString, ClassString, "HLP_HTBUS030_2.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            ...
            ClassString = "Attribute" ;
            StyleString = "" ;
            GxWebStd.gx_single_line_edit( context, edtavFttbus_rubrobien_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV60fTTBUS_RubroBien), 4, 0, ",", "")), "", 4, "chr", 1, "row", 4, 1, 1, 0, 0, 0, "", "", StyleString, ClassString, "", context.localUtil.Format( (decimal)(AV60fTTBUS_RubroBien), "ZZZ9"), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(39);\"", 0, edtavFttbus_rubrobien_Jsonclick, "", 0, 1, -1, true, "right", "HLP_HTBUS030_2.htm");
            /* Static images/pictures */
            ClassString = "Image" ;
            StyleString = "" ;
            GxWebStd.gx_bitmap( context, imgprompt_Fttbus_rubrobien_Internalname, "", "prompt.gif", "Modern", 1, 1, "", "", 0, 0, 0, "", 0, "", 0, 0, imgprompt_Fttbus_rubrobien_Link, "", 0, "", "", StyleString, ClassString, "", "", "''", "", "HLP_HTBUS030_2.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            ...
            ClassString = "TextBlock" ;
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblock4_Internalname, 1, 1, 0, "Posición:", "", "", "", 0, lblTextblock4_Jsonclick, "", StyleString, ClassString, "HLP_HTBUS030_2.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            ClassString = "Attribute" ;
            StyleString = "" ;
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavTtbus7_pos, cmbavTtbus7_pos_Internalname, StringUtil.Str( (decimal)(AV51TTBUS7_Pos), 3, 0), "", "int", 1, 1, 0, 1, 0, 3, "chr", 0, "", StyleString, ClassString, "", 0, cmbavTtbus7_pos_Jsonclick, "", TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(44);\"", true, "HLP_HTBUS030_2.htm");
            ...
            ClassString = "Button" ;
            StyleString = "" ;
            GxWebStd.gx_button_ctrl( context, context.GetButtonType( ), bttButton3_Internalname, "Buscar", "Buscar", "", StyleString, ClassString, 1, 1, "rounded", 5, bttButton3_Jsonclick, "E\\'BUSCAR\\'.", TempTags, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(57), 3, 0)+","+"null"+");", "", "HLP_HTBUS030_2.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( Form.Jscriptsrc.Item(idxLst)), "?1119694");
            idxLst = (int)(idxLst+1) ;
         }
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("htbus030_2.js", "?1119694");
      ...
      protected void sendrow_572( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_57_idx <= subGrid1_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            TempTags = " " + ((edtavGttbus_rubrodesc_Enabled!=0)&&(edtavGttbus_rubrodesc_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 64,'',false,'"+sGXsfl_57_idx+"',57)\"" : " ") ;
            ClassString = "Attribute" ;
            StyleString = "" ;
            ROClassString = ClassString ;
            Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtavGttbus_rubrodesc_Internalname,StringUtil.RTrim( AV58gTTBUS_RubroDesc),(String)"",(short)0,(String)"px",(short)17,(String)"",(short)30,(short)-1,(int)edtavGttbus_rubrodesc_Enabled,(short)0,(short)0,(short)0,(String)"",(String)"",(String)StyleString,(String)ClassString,(String)ROClassString,StringUtil.RTrim( context.localUtil.Format( AV58gTTBUS_RubroDesc, "@!")),TempTags+((edtavGttbus_rubrodesc_Enabled!=0)&&(edtavGttbus_rubrodesc_Visible!=0) ? " onchange=\"gx.evt.onchange(this)\" " : " ")+((edtavGttbus_rubrodesc_Enabled!=0)&&(edtavGttbus_rubrodesc_Visible!=0) ? " onblur=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onblur(64);\"" : " "),(short)0,(String)edtavGttbus_rubrodesc_Jsonclick,(String)"",(short)57,(short)1,(short)1,(bool)true,(String)"left"});
            /* Subfile cell */
            if ( Grid1Container.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+"display:none;"+"\">") ;
            ...
            /* Single line edit */
            TempTags = " " + ((edtavGnro_serie_Enabled!=0)&&(edtavGnro_serie_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 68,'',false,'"+sGXsfl_57_idx+"',57)\"" : " ") ;
            ClassString = "Attribute" ;
            StyleString = "" ;
            ROClassString = ClassString ;
            Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtavGnro_serie_Internalname,StringUtil.RTrim( AV62gNro_serie),(String)"",(short)0,(String)"px",(short)17,(String)"",(short)20,(short)-1,(int)edtavGnro_serie_Enabled,(short)0,(short)0,(short)0,(String)"",(String)"",(String)StyleString,(String)ClassString,(String)ROClassString,StringUtil.RTrim( context.localUtil.Format( AV62gNro_serie, "")),TempTags+((edtavGnro_serie_Enabled!=0)&&(edtavGnro_serie_Visible!=0) ? " onchange=\"gx.evt.onchange(this)\" " : " ")+((edtavGnro_serie_Enabled!=0)&&(edtavGnro_serie_Visible!=0) ? " onblur=\""+""+";gx.evt.onblur(68);\"" : " "),(short)0,(String)edtavGnro_serie_Jsonclick,(String)"",(short)57,(short)1,(short)1,(bool)true,(String)"left"});
            /* Subfile cell */
            if ( Grid1Container.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+((-1==0) ? "display:none;" : "")+"\">") ;
            ...
            ClassString = "Attribute" ;
            StyleString = "" ;
            TempTags = " " + ((cmbavGttbus_empresa.Enabled!=0)&&(cmbavGttbus_empresa.Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 69,'',false,'"+sGXsfl_57_idx+"',57)\"" : " ") ;
            ...
            /* ComboBox */
            Grid1Row.AddColumnProperties("combobox", 2, isAjaxCallMode( ), new Object[] {(GXCombobox)cmbavGttbus_empresa,(String)cmbavGttbus_empresa_Internalname,StringUtil.Str( (decimal)(AV63gTTBUS_Empresa), 1, 0),(String)"",(String)"int",(short)-1,cmbavGttbus_empresa.Enabled,(short)0,(short)1,(short)0,(short)0,(String)"px",(short)0,(String)"",(String)StyleString,(String)ClassString,(String)"",(short)0,(String)cmbavGttbus_empresa_Jsonclick,(String)"",TempTags+((cmbavGttbus_empresa.Enabled!=0)&&(cmbavGttbus_empresa.Visible!=0) ? " onchange=\"gx.evt.onchange(this)\" " : " ")+((cmbavGttbus_empresa.Enabled!=0)&&(cmbavGttbus_empresa.Visible!=0) ? " onblur=\""+""+";gx.evt.onblur(69);\"" : " "),(bool)true});
            cmbavGttbus_empresa.CurrentValue = StringUtil.Str( (decimal)(AV63gTTBUS_Empresa), 1, 0) ;
            ...
            /* Single line edit */
            TempTags = " " + ((edtavGttbus_desproveedor_Enabled!=0)&&(edtavGttbus_desproveedor_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 70,'',false,'"+sGXsfl_57_idx+"',57)\"" : " ") ;
            ClassString = "Attribute" ;
            StyleString = "" ;
            ROClassString = ClassString ;
            Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtavGttbus_desproveedor_Internalname,StringUtil.RTrim( AV27gTTBUS_DesProveedor),(String)"",(short)0,(String)"px",(short)17,(String)"",(short)30,(short)0,(int)edtavGttbus_desproveedor_Enabled,(short)0,(short)0,(short)0,(String)"",(String)"",(String)StyleString,(String)ClassString,(String)ROClassString,StringUtil.RTrim( context.localUtil.Format( AV27gTTBUS_DesProveedor, "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXX")),TempTags+((edtavGttbus_desproveedor_Enabled!=0)&&(edtavGttbus_desproveedor_Visible!=0) ? " onchange=\"gx.evt.onchange(this)\" " : " ")+((edtavGttbus_desproveedor_Enabled!=0)&&(edtavGttbus_desproveedor_Visible!=0) ? " onblur=\""+""+";gx.evt.onblur(70);\"" : " "),(short)0,(String)edtavGttbus_desproveedor_Jsonclick,(String)"",(short)57,(short)1,(short)1,(bool)true,(String)"left"});
            /* Subfile cell */
            if ( Grid1Container.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+((-1==0) ? "display:none;" : "")+"\">") ;
            ...
            ClassString = "Attribute" ;
            StyleString = "" ;
            TempTags = " " + ((cmbavGttbus_estado.Enabled!=0)&&(cmbavGttbus_estado.Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 71,'',false,'"+sGXsfl_57_idx+"',57)\"" : " ") ;
            if ( ( nGXsfl_57_idx == 1 ) && isAjaxCallMode( ) )
            {
               GXCCtl = "vGTTBUS_ESTADO_" + sGXsfl_57_idx ;
               cmbavGttbus_estado.Name = GXCCtl ;
            ...
            /* Single line edit */
            TempTags = " " + ((edtavGttbus_codposicion_Enabled!=0)&&(edtavGttbus_codposicion_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 72,'',false,'"+sGXsfl_57_idx+"',57)\"" : " ") ;
            ClassString = "Attribute" ;
            StyleString = "" ;
            ROClassString = ClassString ;
            Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtavGttbus_codposicion_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(AV23gTTBUS_CodPosicion), 3, 0, ",", "")),(String)"",(short)0,(String)"px",(short)17,(String)"",(short)3,(short)0,(int)edtavGttbus_codposicion_Enabled,(short)0,(short)0,(short)0,(String)"",(String)"",(String)StyleString,(String)ClassString,(String)ROClassString,context.localUtil.Format( (decimal)(AV23gTTBUS_CodPosicion), "ZZ9"),TempTags+((edtavGttbus_codposicion_Enabled!=0)&&(edtavGttbus_codposicion_Visible!=0) ? " onchange=\"gx.evt.onchange(this)\" " : " ")+((edtavGttbus_codposicion_Enabled!=0)&&(edtavGttbus_codposicion_Visible!=0) ? " onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(72);\"" : " "),(short)0,(String)edtavGttbus_codposicion_Jsonclick,(String)"",(short)57,(short)1,(short)1,(bool)true,(String)"right"});
            /* Subfile cell */
            if ( Grid1Container.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+((-1==0) ? "display:none;" : "")+"\">") ;
            ...
            /* Single line edit */
            TempTags = " " + ((edtavGbus_rub_Enabled!=0)&&(edtavGbus_rub_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 77,'',false,'"+sGXsfl_57_idx+"',57)\"" : " ") ;
            ClassString = "Attribute" ;
            StyleString = "" ;
            ROClassString = ClassString ;
            Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtavGbus_rub_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(AV19gBUS_RUB), 4, 0, ",", "")),(String)"",(short)0,(String)"px",(short)17,(String)"",(short)4,(short)0,(int)edtavGbus_rub_Enabled,(short)0,(short)0,(short)0,(String)"",(String)"",(String)StyleString,(String)ClassString,(String)ROClassString,context.localUtil.Format( (decimal)(AV19gBUS_RUB), "ZZZ9"),TempTags+((edtavGbus_rub_Enabled!=0)&&(edtavGbus_rub_Visible!=0) ? " onchange=\"gx.evt.onchange(this)\" " : " ")+((edtavGbus_rub_Enabled!=0)&&(edtavGbus_rub_Visible!=0) ? " onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(77);\"" : " "),(short)0,(String)edtavGbus_rub_Jsonclick,(String)"",(short)57,(short)1,(short)1,(bool)true,(String)"right"});
            /* Subfile cell */
            if ( Grid1Container.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+"display:none;"+"\">") ;
            ...
            /* Single line edit */
            TempTags = " " + ((edtavGbus_cod_Enabled!=0)&&(edtavGbus_cod_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 78,'',false,'"+sGXsfl_57_idx+"',57)\"" : " ") ;
            ClassString = "Attribute" ;
            StyleString = "" ;
            ROClassString = ClassString ;
            Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtavGbus_cod_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(AV16gBUS_COD), 4, 0, ",", "")),(String)"",(short)0,(String)"px",(short)17,(String)"",(short)4,(short)0,(int)edtavGbus_cod_Enabled,(short)0,(short)0,(short)0,(String)"",(String)"",(String)StyleString,(String)ClassString,(String)ROClassString,context.localUtil.Format( (decimal)(AV16gBUS_COD), "ZZZ9"),TempTags+((edtavGbus_cod_Enabled!=0)&&(edtavGbus_cod_Visible!=0) ? " onchange=\"gx.evt.onchange(this)\" " : " ")+((edtavGbus_cod_Enabled!=0)&&(edtavGbus_cod_Visible!=0) ? " onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(78);\"" : " "),(short)0,(String)edtavGbus_cod_Jsonclick,(String)"",(short)57,(short)1,(short)1,(bool)true,(String)"right"});
            /* Subfile cell */
            if ( Grid1Container.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+"display:none;"+"\">") ;
            ...
            /* Single line edit */
            TempTags = " " + ((edtavGbus_par_Enabled!=0)&&(edtavGbus_par_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 79,'',false,'"+sGXsfl_57_idx+"',57)\"" : " ") ;
            ClassString = "Attribute" ;
            StyleString = "" ;
            ROClassString = ClassString ;
            Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtavGbus_par_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(AV18gBUS_PAR), 2, 0, ",", "")),(String)"",(short)0,(String)"px",(short)17,(String)"",(short)2,(short)0,(int)edtavGbus_par_Enabled,(short)0,(short)0,(short)0,(String)"",(String)"",(String)StyleString,(String)ClassString,(String)ROClassString,context.localUtil.Format( (decimal)(AV18gBUS_PAR), "Z9"),TempTags+((edtavGbus_par_Enabled!=0)&&(edtavGbus_par_Visible!=0) ? " onchange=\"gx.evt.onchange(this)\" " : " ")+((edtavGbus_par_Enabled!=0)&&(edtavGbus_par_Visible!=0) ? " onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(79);\"" : " "),(short)0,(String)edtavGbus_par_Jsonclick,(String)"",(short)57,(short)1,(short)1,(bool)true,(String)"right"});
            /* Subfile cell */
            if ( Grid1Container.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+"display:none;"+"\">") ;
            ...
            if ( ( nGXsfl_57_idx == 1 ) && isAjaxCallMode( ) )
            {
               ...
               dynavGididentificador.WebTags = "" ;
               dynavGididentificador.removeAllItems();
               /* Using cursor H001Z16 */
               pr_default.execute(14);
               while ( (pr_default.getStatus(14) != 101) )
               {
                  dynavGididentificador.addItem(StringUtil.Str( (decimal)(H001Z16_A20TTBUS5_IdIdentificador[0]), 8, 0), H001Z16_A21TTBUS5_DescIdentificador[0], 0);
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "" ;
         H001Z2_A20TTBUS5_IdIdentificador = new int[1] ;
         H001Z2_A21TTBUS5_DescIdentificador = new String[] {""} ;
         GXCCtl = "" ;
         AV28gTTBUS_Estado = 1 ;
         H001Z3_A20TTBUS5_IdIdentificador = new int[1] ;
         H001Z3_A21TTBUS5_DescIdentificador = new String[] {""} ;
         A7USU_DES = "" ;
         A6USU_COD = "" ;
         A25TTBUS2_RespHacia = "" ;
         A24TTBUS2_RespDesde = "" ;
         ...
         AV38SEC_DRE = "" ;
         AV17gBUS_EMP = "" ;
         H001Z4_A20TTBUS5_IdIdentificador = new int[1] ;
         H001Z4_A21TTBUS5_DescIdentificador = new String[] {""} ;
         H001Z5_A20TTBUS5_IdIdentificador = new int[1] ;
         H001Z5_A21TTBUS5_DescIdentificador = new String[] {""} ;
         gxdynajaxctrlcodr = new GeneXus.Utils.GxStringCollection();
         gxdynajaxctrldescr = new GeneXus.Utils.GxStringCollection();
         gxwrpcisep = "" ;
         l12TTBUS_Descripcion = "" ;
         H001Z6_A12TTBUS_Descripcion = new String[] {""} ;
         H001Z7_A12TTBUS_Descripcion = new String[] {""} ;
         ...
         H001Z8_A11TTBUS_Id = new int[1] ;
         H001Z8_A37TTBUS_CodPosicion = new short[1] ;
         H001Z8_A15NumeroIdentificador = new String[] {""} ;
         H001Z8_A14IdIdentificador = new int[1] ;
         H001Z8_A10HARDWARE_ID = new short[1] ;
         H001Z8_n10HARDWARE_ID = new bool[] {false} ;
         H001Z8_A17TTBUS_RubroBien = new short[1] ;
         H001Z8_A13TTBUS_FechaCarga = new DateTime[] {DateTime.MinValue} ;
         H001Z8_A12TTBUS_Descripcion = new String[] {""} ;
         H001Z8_A23TTBUS_Estado = new short[1] ;
         H001Z8_A16TTBUS_FechaBaja = new DateTime[] {DateTime.MinValue} ;
         H001Z8_n16TTBUS_FechaBaja = new bool[] {false} ;
         H001Z8_A3BUS_COD = new short[1] ;
         H001Z8_n3BUS_COD = new bool[] {false} ;
         H001Z8_A8BUS_EMP = new String[] {""} ;
         H001Z8_n8BUS_EMP = new bool[] {false} ;
         H001Z8_A4BUS_PAR = new short[1] ;
         H001Z8_n4BUS_PAR = new bool[] {false} ;
         H001Z8_A1BUS_RUB = new short[1] ;
         H001Z8_n1BUS_RUB = new bool[] {false} ;
         H001Z8_A29TTBUS_Alquilado = new short[1] ;
         H001Z8_A27TTBUS_CodProveedor = new int[1] ;
         H001Z8_n27TTBUS_CodProveedor = new bool[] {false} ;
         H001Z8_A38TTBUS_DesPosicion = new String[] {""} ;
         H001Z8_A30TTBUS_DesProveedor = new String[] {""} ;
         H001Z8_A18TTBUS_RubroDesc = new String[] {""} ;
         H001Z8_n18TTBUS_RubroDesc = new bool[] {false} ;
         H001Z8_A41TTBUS_Empresa = new short[1] ;
         H001Z8_A42TTBUS_NroSerie = new String[] {""} ;
         H001Z9_A33TTBUS7_Pos = new short[1] ;
         H001Z9_A35TTBUS7_CodResp = new String[] {""} ;
         H001Z9_A36TTBUS7_DesResp = new String[] {""} ;
         H001Z9_n36TTBUS7_DesResp = new bool[] {false} ;
         H001Z10_A52TTBUS2_IdMovimiento = new long[1] ;
         H001Z10_A22TTBUS2_IdBien = new int[1] ;
         H001Z10_A26TTBUS2_EstadoEnvio = new short[1] ;
         H001Z10_A24TTBUS2_RespDesde = new String[] {""} ;
         H001Z10_A25TTBUS2_RespHacia = new String[] {""} ;
         AV48TTBUS2_RespDesde = "" ;
         AV49TTBUS2_RespHacia = "" ;
         AV11dUSU_DES = "" ;
         AV32hUSU_DES = "" ;
         AV34NOMBRE_REPORTE = "" ;
         H001Z11_A40TTBUS8_CodUsuario = new String[] {""} ;
         A40TTBUS8_CodUsuario = "" ;
         H001Z12_A31W53POS = new short[1] ;
         H001Z12_A32W53DES = new String[] {""} ;
         A32W53DES = "" ;
         H001Z13_A33TTBUS7_Pos = new short[1] ;
         H001Z13_A34TTBUS7_Des = new String[] {""} ;
         H001Z13_n34TTBUS7_Des = new bool[] {false} ;
         A34TTBUS7_Des = "" ;
         H001Z14_A6USU_COD = new String[] {""} ;
         H001Z14_A7USU_DES = new String[] {""} ;
         H001Z15_A6USU_COD = new String[] {""} ;
         H001Z15_A7USU_DES = new String[] {""} ;
         sStyleString = "" ;
         ClassString = "" ;
         StyleString = "" ;
         subGrid1_Linesclass = "" ;
         ...
         ROClassString = "" ;
         GXt_char23 = "" ;
         H001Z16_A20TTBUS5_IdIdentificador = new int[1] ;
         H001Z16_A21TTBUS5_DescIdentificador = new String[] {""} ;
         GXt_char24 = "" ;
         GXt_char25 = "" ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.htbus030_2__default(),
            new Object[][] {
                new Object[] {
               H001Z2_A20TTBUS5_IdIdentificador, H001Z2_A21TTBUS5_DescIdentificador
               }
               , new Object[] {
               H001Z3_A20TTBUS5_IdIdentificador, H001Z3_A21TTBUS5_DescIdentificador
               }
               , new Object[] {
               H001Z4_A20TTBUS5_IdIdentificador, H001Z4_A21TTBUS5_DescIdentificador
               }
               , new Object[] {
               H001Z5_A20TTBUS5_IdIdentificador, H001Z5_A21TTBUS5_DescIdentificador
               }
               , new Object[] {
               H001Z6_A12TTBUS_Descripcion
               }
               , new Object[] {
               H001Z7_A12TTBUS_Descripcion
               }
               , new Object[] {
               H001Z8_A11TTBUS_Id, H001Z8_A37TTBUS_CodPosicion, H001Z8_A15NumeroIdentificador, H001Z8_A14IdIdentificador, H001Z8_A10HARDWARE_ID, H001Z8_n10HARDWARE_ID, H001Z8_A17TTBUS_RubroBien, H001Z8_A13TTBUS_FechaCarga, H001Z8_A12TTBUS_Descripcion, H001Z8_A23TTBUS_Estado,
               H001Z8_A16TTBUS_FechaBaja, H001Z8_n16TTBUS_FechaBaja, H001Z8_A3BUS_COD, H001Z8_n3BUS_COD, H001Z8_A8BUS_EMP, H001Z8_n8BUS_EMP, H001Z8_A4BUS_PAR, H001Z8_n4BUS_PAR, H001Z8_A1BUS_RUB, H001Z8_n1BUS_RUB,
               H001Z8_A29TTBUS_Alquilado, H001Z8_A27TTBUS_CodProveedor, H001Z8_n27TTBUS_CodProveedor, H001Z8_A38TTBUS_DesPosicion, H001Z8_A30TTBUS_DesProveedor, H001Z8_A18TTBUS_RubroDesc, H001Z8_n18TTBUS_RubroDesc, H001Z8_A41TTBUS_Empresa, H001Z8_A42TTBUS_NroSerie
               }
               , new Object[] {
               H001Z9_A33TTBUS7_Pos, H001Z9_A35TTBUS7_CodResp, H001Z9_A36TTBUS7_DesResp, H001Z9_n36TTBUS7_DesResp
               }
               , new Object[] {
               H001Z10_A52TTBUS2_IdMovimiento, H001Z10_A22TTBUS2_IdBien, H001Z10_A26TTBUS2_EstadoEnvio, H001Z10_A24TTBUS2_RespDesde, H001Z10_A25TTBUS2_RespHacia
               }
               , new Object[] {
               H001Z11_A40TTBUS8_CodUsuario
               }
               , new Object[] {
               H001Z12_A31W53POS, H001Z12_A32W53DES
               }
               , new Object[] {
               H001Z13_A33TTBUS7_Pos, H001Z13_A34TTBUS7_Des, H001Z13_n34TTBUS7_Des
               }
               , new Object[] {
               H001Z14_A6USU_COD, H001Z14_A7USU_DES
               }
               , new Object[] {
               H001Z15_A6USU_COD, H001Z15_A7USU_DES
               }
               , new Object[] {
               H001Z16_A20TTBUS5_IdIdentificador, H001Z16_A21TTBUS5_DescIdentificador
               }
            }
         );
         AV13fIdIdentificador = 1 ;
      ...
      private short AV63gTTBUS_Empresa ;
      ...
      private int[] H001Z2_A20TTBUS5_IdIdentificador ;
      private String[] H001Z2_A21TTBUS5_DescIdentificador ;
      private int[] H001Z3_A20TTBUS5_IdIdentificador ;
      private String[] H001Z3_A21TTBUS5_DescIdentificador ;
      private int[] H001Z4_A20TTBUS5_IdIdentificador ;
      private String[] H001Z4_A21TTBUS5_DescIdentificador ;
      private int[] H001Z5_A20TTBUS5_IdIdentificador ;
      private String[] H001Z5_A21TTBUS5_DescIdentificador ;
      private String[] H001Z6_A12TTBUS_Descripcion ;
      private String[] H001Z7_A12TTBUS_Descripcion ;
      private int[] H001Z8_A11TTBUS_Id ;
      private short[] H001Z8_A37TTBUS_CodPosicion ;
      private String[] H001Z8_A15NumeroIdentificador ;
      private int[] H001Z8_A14IdIdentificador ;
      private short[] H001Z8_A10HARDWARE_ID ;
      private bool[] H001Z8_n10HARDWARE_ID ;
      private short[] H001Z8_A17TTBUS_RubroBien ;
      private DateTime[] H001Z8_A13TTBUS_FechaCarga ;
      private String[] H001Z8_A12TTBUS_Descripcion ;
      private short[] H001Z8_A23TTBUS_Estado ;
      private DateTime[] H001Z8_A16TTBUS_FechaBaja ;
      private bool[] H001Z8_n16TTBUS_FechaBaja ;
      private short[] H001Z8_A3BUS_COD ;
      private bool[] H001Z8_n3BUS_COD ;
      private String[] H001Z8_A8BUS_EMP ;
      private bool[] H001Z8_n8BUS_EMP ;
      private short[] H001Z8_A4BUS_PAR ;
      private bool[] H001Z8_n4BUS_PAR ;
      private short[] H001Z8_A1BUS_RUB ;
      private bool[] H001Z8_n1BUS_RUB ;
      private short[] H001Z8_A29TTBUS_Alquilado ;
      private int[] H001Z8_A27TTBUS_CodProveedor ;
      private bool[] H001Z8_n27TTBUS_CodProveedor ;
      private String[] H001Z8_A38TTBUS_DesPosicion ;
      private String[] H001Z8_A30TTBUS_DesProveedor ;
      private String[] H001Z8_A18TTBUS_RubroDesc ;
      private bool[] H001Z8_n18TTBUS_RubroDesc ;
      private short[] H001Z8_A41TTBUS_Empresa ;
      private String[] H001Z8_A42TTBUS_NroSerie ;
      private short[] H001Z9_A33TTBUS7_Pos ;
      private String[] H001Z9_A35TTBUS7_CodResp ;
      private String[] H001Z9_A36TTBUS7_DesResp ;
      private bool[] H001Z9_n36TTBUS7_DesResp ;
      private long[] H001Z10_A52TTBUS2_IdMovimiento ;
      private int[] H001Z10_A22TTBUS2_IdBien ;
      private short[] H001Z10_A26TTBUS2_EstadoEnvio ;
      private String[] H001Z10_A24TTBUS2_RespDesde ;
      private String[] H001Z10_A25TTBUS2_RespHacia ;
      private String[] H001Z11_A40TTBUS8_CodUsuario ;
      private short[] H001Z12_A31W53POS ;
      private String[] H001Z12_A32W53DES ;
      private short[] H001Z13_A33TTBUS7_Pos ;
      private String[] H001Z13_A34TTBUS7_Des ;
      private bool[] H001Z13_n34TTBUS7_Des ;
      private String[] H001Z14_A6USU_COD ;
      private String[] H001Z14_A7USU_DES ;
      private String[] H001Z15_A6USU_COD ;
      private String[] H001Z15_A7USU_DES ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private int[] H001Z16_A20TTBUS5_IdIdentificador ;
      private String[] H001Z16_A21TTBUS5_DescIdentificador ;
      private int aP0_pTTBUS_Id ;
      private GXWebForm Form ;
      private SdtContext AV10Context ;
   }

   public class htbus030_2__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H001Z8( short AV51TTBUS7_Pos ,
                                             ...
                                             int AV13fIdIdentificador )
      {
         ...
         scmdbuf = "SELECT T1.[TTBUS_Id], T2.[TTBUS_CodPosicion], T1.[NumeroIdentificador], T1.[IdIdentificador], T2.[HARDWARE_ID], T2.[TTBUS_RubroBien] AS TTBUS_RubroBien, T2.[TTBUS_FechaCarga], T2.[TTBUS_Descripcion], T2.[TTBUS_Estado], T2.[TTBUS_FechaBaja], T2.[BUS_COD], T2.[BUS_EMP], T2.[BUS_PAR], T2.[BUS_RUB], T2.[TTBUS_Alquilado], T2.[TTBUS_CodProveedor], T2.[TTBUS_DesPosicion], T2.[TTBUS_DesProveedor], T3.[RBR_DES] AS TTBUS_RubroDesc, T2.[TTBUS_Empresa], T2.[TTBUS_NroSerie] FROM (([TTBUS000Identificadores] T1 WITH (NOLOCK) INNER JOIN [TTBUS000] T2 WITH (NOLOCK) ON T2.[TTBUS_Id] = T1.[TTBUS_Id]) INNER JOIN [BUS002] T3 WITH (NOLOCK) ON T3.[RBR_COD] = T2.[TTBUS_RubroBien])" ;
         ...
         scmdbuf = scmdbuf + " and (T2.[HARDWARE_ID] = 0)" ;
         if ( AV51TTBUS7_Pos != -1 )
         {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 6 :
                     return conditional_H001Z8( (short)dynConstraints[0] , (String)dynConstraints[1] , (DateTime)dynConstraints[2] , (short)dynConstraints[3] , (String)dynConstraints[4] , (short)dynConstraints[5] , (String)dynConstraints[6] , (String)dynConstraints[7] , (DateTime)dynConstraints[8] , (short)dynConstraints[9] , (String)dynConstraints[10] , (String)dynConstraints[11] , (DateTime)dynConstraints[12] , (short)dynConstraints[13] , (short)dynConstraints[14] , (int)dynConstraints[15] , (int)dynConstraints[16] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H001Z2", "SELECT [TTBUS5_IdIdentificador], [TTBUS5_DescIdentificador] FROM [TTBUS005] WITH (NOLOCK) ORDER BY [TTBUS5_DescIdentificador] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001Z2,0,0,true,false )
             ,new CursorDef("H001Z3", "SELECT [TTBUS5_IdIdentificador], [TTBUS5_DescIdentificador] FROM [TTBUS005] WITH (NOLOCK) ORDER BY [TTBUS5_DescIdentificador] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001Z3,0,0,true,false )
             ,new CursorDef("H001Z4", "SELECT [TTBUS5_IdIdentificador], [TTBUS5_DescIdentificador] FROM [TTBUS005] WITH (NOLOCK) ORDER BY [TTBUS5_DescIdentificador] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001Z4,0,0,true,false )
             ,new CursorDef("H001Z5", "SELECT [TTBUS5_IdIdentificador], [TTBUS5_DescIdentificador] FROM [TTBUS005] WITH (NOLOCK) ORDER BY [TTBUS5_DescIdentificador] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001Z5,0,0,true,false )
             ,new CursorDef("H001Z6", "SELECT DISTINCT TOP 5 [TTBUS_Descripcion] FROM [TTBUS000] WITH (NOLOCK) WHERE UPPER(CAST([TTBUS_Descripcion] AS char(50))) like UPPER(CAST(@TTBUS_Descripcion AS char(50))) ORDER BY [TTBUS_Descripcion] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001Z6,0,0,true,false )
             ,new CursorDef("H001Z7", "SELECT DISTINCT TOP 5 [TTBUS_Descripcion] FROM [TTBUS000] WITH (NOLOCK) WHERE UPPER(CAST([TTBUS_Descripcion] AS char(50))) like UPPER(CAST(@TTBUS_Descripcion AS char(50))) ORDER BY [TTBUS_Descripcion] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001Z7,0,0,true,false )
             ,new CursorDef("H001Z8", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001Z8,100,0,true,false )
             ,new CursorDef("H001Z9", "SELECT T1.[TTBUS7_Pos] AS TTBUS7_Pos, T1.[TTBUS7_CodResp] AS TTBUS7_CodResp, T2.[USU_DES] AS TTBUS7_DesResp FROM ([TTBUS007] T1 WITH (NOLOCK) INNER JOIN [SEG002] T2 WITH (NOLOCK) ON T2.[USU_COD] = T1.[TTBUS7_CodResp]) WHERE T1.[TTBUS7_Pos] = @TTBUS_CodPosicion ORDER BY T1.[TTBUS7_Pos] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001Z9,1,0,false,true )
             ,new CursorDef("H001Z10", "SELECT [TTBUS2_IdMovimiento], [TTBUS2_IdBien], [TTBUS2_EstadoEnvio], [TTBUS2_RespDesde], [TTBUS2_RespHacia] FROM [TTBUS002] WITH (NOLOCK) WHERE ([TTBUS2_IdBien] = @TTBUS_Id) AND ([TTBUS2_EstadoEnvio] = 1) ORDER BY [TTBUS2_IdMovimiento] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001Z10,100,0,true,false )
             ,new CursorDef("H001Z11", "SELECT [TTBUS8_CodUsuario] FROM [TTBUS008] WITH (NOLOCK) WHERE [TTBUS8_CodUsuario] = @AV53USUARIO ORDER BY [TTBUS8_CodUsuario] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001Z11,1,0,false,true )
             ,new CursorDef("H001Z12", "SELECT [W53POS], [W53DES] FROM [T53FPOS] WITH (NOLOCK) ORDER BY [W53DES] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001Z12,100,0,true,false )
             ,new CursorDef("H001Z13", "SELECT T1.[TTBUS7_Pos] AS TTBUS7_Pos, T2.[W53DES] AS TTBUS7_Des FROM ([TTBUS007] T1 WITH (NOLOCK) INNER JOIN [T53FPOS] T2 WITH (NOLOCK) ON T2.[W53POS] = T1.[TTBUS7_Pos]) WHERE (T1.[TTBUS7_Pos] = @W53POS) AND (T1.[TTBUS7_Pos] <> 998) ORDER BY T1.[TTBUS7_Pos] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001Z13,1,0,false,true )
             ,new CursorDef("H001Z14", "SELECT [USU_COD], [USU_DES] FROM [SEG002] WITH (NOLOCK) WHERE [USU_COD] = @AV48TTBUS2_RespDesde ORDER BY [USU_COD] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001Z14,1,0,false,true )
             ,new CursorDef("H001Z15", "SELECT [USU_COD], [USU_DES] FROM [SEG002] WITH (NOLOCK) WHERE [USU_COD] = @AV49TTBUS2_RespHacia ORDER BY [USU_COD] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001Z15,1,0,false,true )
             ,new CursorDef("H001Z16", "SELECT [TTBUS5_IdIdentificador], [TTBUS5_DescIdentificador] FROM [TTBUS005] WITH (NOLOCK) ORDER BY [TTBUS5_DescIdentificador] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001Z16,0,0,true,false )
          };
       }
    }
