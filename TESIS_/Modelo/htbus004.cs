/*
       ...
       Generated on: 3/17/2014 13:22:16.39
...
namespace GeneXus.Programs {
   public class htbus004 : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlCloseForm1N2( )
      {
         ...
         {
            context.AddJavascriptSource("htbus004.js", "?13221648");
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( Form.Jscriptsrc.Item(idxLst)), "?13221722");
            idxLst = (int)(idxLst+1) ;
         }
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("htbus004.js", "?13221722");
         }
