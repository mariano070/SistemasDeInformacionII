...
using System.IO;
public class bldhtbus000 : GxBaseBuilder
{
   string cs_path = "." ;
   public bldhtbus000( ) : base()
   {
   }
   ...
   {
      bldhtbus000 x = new bldhtbus000() ;
      x.SetMainSourceFile( "htbus000.cs");
   ...
   {
      ItemCollection sc = new ItemCollection() ;
      sc.Add( @"bin\htbus000.dll", cs_path + @"\htbus000.rsp");
      return sc ;
   }
