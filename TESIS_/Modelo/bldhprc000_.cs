...
using System.IO;
public class bldhprc000_ : GxBaseBuilder
{
   string cs_path = "." ;
   public bldhprc000_( ) : base()
   {
   }
   ...
   {
      bldhprc000_ x = new bldhprc000_() ;
      x.SetMainSourceFile( "hprc000_.cs");
   ...
   {
      ItemCollection sc = new ItemCollection() ;
      sc.Add( @"bin\hprc000_.dll", cs_path + @"\hprc000_.rsp");
      return sc ;
   }
