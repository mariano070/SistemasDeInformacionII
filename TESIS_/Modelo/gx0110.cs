/*
       ...
       Generated on: 3/17/2014 13:22:8.20
...
namespace GeneXus.Programs {
   public class gx0110 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public gx0110( )
      {
      ...
      public void execute( out short aP0_pRBR_COD )
      {
         this.AV10pRBR_COD = 0 ;
         executePrivate();
         aP0_pRBR_COD=this.AV10pRBR_COD;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
            {
               ...
               gxgrGrid1_refresh( Grid1_PageSize26, AV6cRBR_COD, AV7cRBR_DES) ;
               return  ;
            }
            else
            {
            ...
            if ( ! entryPointCalled )
            {
               AV10pRBR_COD = (short)(NumberUtil.Val( gxfirstwebparm, ".")) ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV10pRBR_COD", StringUtil.LTrim( StringUtil.Str( (decimal)(AV10pRBR_COD), 4, 0)));
            }
         }
         context.SetTheme("Modern");
      }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" onsubmit=\"try{return gx.csv.validForm()}catch(e){return true;}\" name=\"MAINFORM\" method=\"post\" action=\""+formatLink("gx0110.aspx") + "?" + UrlEncode("" +AV10pRBR_COD)+"\" class=\""+"Form"+"\">") ;
      ...
      public override void RenderHtmlCloseForm( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vPRBR_COD", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10pRBR_COD), 4, 0, ",", "")));
      ...
      {
         return formatLink("gx0110.aspx") + "?" + UrlEncode("" +AV10pRBR_COD) ;
      }
      ...
      protected void WB4B0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_2_4B2( true) ;
         }
         else
         {
            wb_table1_2_4B2( false) ;
         }
         return  ;
      }

      protected void wb_table1_2_4B2e( bool wbgen )
      {
         if ( wbgen )
         {
         }
      ...
      protected void RF4B2( )
      {
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( context.wjLoc)) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A19RBR_DES = H004B2_A19RBR_DES[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A19RBR_DES", A19RBR_DES);
               A2RBR_COD = H004B2_A2RBR_COD[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A2RBR_COD", StringUtil.LTrim( StringUtil.Str( (decimal)(A2RBR_COD), 4, 0)));
               /* Execute user event: E124B2 */
               E124B2 ();
      ...
      protected int subGrid1_Recordcount( )
      {
         ...
         GRID1_nRecordCount = H004B3_AGRID1_nRecordCount[0] ;
         pr_default.close(1);
      ...
      protected void STRUP4B0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV10pRBR_COD = (short)(context.localUtil.CToN( cgiGet( "vPRBR_COD"), ",", ".")) ;
      ...
      {
         /* Enter Routine */
         AV10pRBR_COD = A2RBR_COD ;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV10pRBR_COD", StringUtil.LTrim( StringUtil.Str( (decimal)(AV10pRBR_COD), 4, 0)));
         context.setWebReturnParms(new Object[] {(short)AV10pRBR_COD});
         context.nUserReturn = 1 ;
         returnInSub = true;
         if (true) return;
      }

      protected void wb_table1_2_4B2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table2_9_4B2( true) ;
         }
         else
         {
            wb_table2_9_4B2( false) ;
         }
         return  ;
      }

      protected void wb_table2_9_4B2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table3_23_4B2( true) ;
         }
         else
         {
            wb_table3_23_4B2( false) ;
         }
         return  ;
      }

      protected void wb_table3_23_4B2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</fieldset>") ;
            ...
            wb_table1_2_4B2e( true) ;
         }
         else
         {
            wb_table1_2_4B2e( false) ;
         }
      }

      protected void wb_table3_23_4B2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
         ...
         if ( wbEnd == 26 )
         {
            ...
            wb_table4_32_4B2( true) ;
         }
         else
         {
            wb_table4_32_4B2( false) ;
         }
         return  ;
      }

      protected void wb_table4_32_4B2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_23_4B2e( true) ;
         }
         else
         {
            wb_table3_23_4B2e( false) ;
         }
      }

      protected void wb_table4_32_4B2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            StyleString = "" ;
            GxWebStd.gx_button_ctrl( context, context.GetButtonType( ), bttBtn_cancel_Internalname, "Cancelar", "Cancelar", "", StyleString, ClassString, 1, 1, "rounded", 1, bttBtn_cancel_Jsonclick, "ECANCEL.", TempTags, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(26), 3, 0)+","+"null"+");", "", "HLP_Gx0110.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "</tbody>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table4_32_4B2e( true) ;
         }
         else
         {
            wb_table4_32_4B2e( false) ;
         }
      }

      protected void wb_table2_9_4B2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblockrbr_cod_Internalname, 1, 1, 0, "CODIGO DE RUBRO", "", "", "", 0, lblTextblockrbr_cod_Jsonclick, "", StyleString, ClassString, "HLP_Gx0110.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            ...
            StyleString = "" ;
            GxWebStd.gx_single_line_edit( context, edtavCrbr_cod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6cRBR_COD), 4, 0, ",", "")), "", 4, "chr", 1, "row", 4, 1, 1, 0, 0, 0, "", "", StyleString, ClassString, "", context.localUtil.Format( (decimal)(AV6cRBR_COD), "ZZZ9"), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(14);\"", 0, edtavCrbr_cod_Jsonclick, "", 0, 1, -1, true, "right", "HLP_Gx0110.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            ...
            ClassString = "TextBlock" ;
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblockrbr_des_Internalname, 1, 1, 0, "DESCRIPCION DEL RUBRO", "", "", "", 0, lblTextblockrbr_des_Jsonclick, "", StyleString, ClassString, "HLP_Gx0110.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            ...
            ClassString = "Attribute" ;
            StyleString = "" ;
            GxWebStd.gx_single_line_edit( context, edtavCrbr_des_Internalname, StringUtil.RTrim( AV7cRBR_DES), "", 30, "chr", 1, "row", 30, 1, 1, 0, 0, 0, "", "", StyleString, ClassString, "", StringUtil.RTrim( context.localUtil.Format( AV7cRBR_DES, "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXX")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(19);\"", 0, edtavCrbr_des_Jsonclick, "", 0, 1, -1, true, "left", "HLP_Gx0110.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "</tbody>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_9_4B2e( true) ;
         }
         else
         {
            wb_table2_9_4B2e( false) ;
         }
      }
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10pRBR_COD = Convert.ToInt16(getParm(obj,0)) ;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV10pRBR_COD", StringUtil.LTrim( StringUtil.Str( (decimal)(AV10pRBR_COD), 4, 0)));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( Form.Jscriptsrc.Item(idxLst)), "?1322845");
            idxLst = (int)(idxLst+1) ;
         }
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx0110.js", "?1322845");
      ...
      protected void sendrow_262( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_26_idx <= subGrid1_Recordsperpage( ) * 1 ) )
         {
            ...
            edtavLinkselection_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A2RBR_COD), 4, 0, ",", "")))+"'"+"]);" ;
            ...
            StyleString = "" ;
            ROClassString = ClassString ;
            edtRBR_DES_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A2RBR_COD), 4, 0, ",", "")))+"'"+"]);" ;
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "" ;
         lV7cRBR_DES = "" ;
         H004B2_A19RBR_DES = new String[] {""} ;
         H004B2_A2RBR_COD = new short[1] ;
         H004B3_AGRID1_nRecordCount = new int[1] ;
         sStyleString = "" ;
         ClassString = "" ;
         StyleString = "" ;
         subGrid1_Linesclass = "" ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx0110__default(),
            new Object[][] {
                new Object[] {
               H004B2_A19RBR_DES, H004B2_A2RBR_COD
               }
               , new Object[] {
               H004B3_AGRID1_nRecordCount
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private String[] H004B2_A19RBR_DES ;
      private short[] H004B2_A2RBR_COD ;
      private int[] H004B3_AGRID1_nRecordCount ;
   ...
   public class gx0110__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H004B2", "SELECT [RBR_DES], [RBR_COD] FROM [BUS002] WITH (NOLOCK) WHERE ([RBR_COD] >= @AV6cRBR_COD) AND ([RBR_DES] like @AV7cRBR_DES) ORDER BY [RBR_COD]  OPTION (FAST 11)",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004B2,11,0,false,false )
             ,new CursorDef("H004B3", "SELECT COUNT(*) FROM [BUS002] WITH (NOLOCK) WHERE ([RBR_COD] >= @AV6cRBR_COD) AND ([RBR_DES] like @AV7cRBR_DES) ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004B3,1,0,false,false )
          };
       }
    }
