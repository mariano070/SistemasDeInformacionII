...
using System.IO;
public class bldhseg000 : GxBaseBuilder
{
   string cs_path = "." ;
   public bldhseg000( ) : base()
   {
   }
   ...
   {
      bldhseg000 x = new bldhseg000() ;
      x.SetMainSourceFile( "hseg000.cs");
   ...
   {
      ItemCollection sc = new ItemCollection() ;
      sc.Add( @"bin\hseg000.dll", cs_path + @"\hseg000.rsp");
      return sc ;
   }
