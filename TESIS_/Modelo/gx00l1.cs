/*
               File: Gx00L1
        Description: Selection List SEG004
             Author: GeneXus C# Generator version 10_1_5-42940
       Generated on: 2/5/2014 11:30:50.60
...
namespace GeneXus.Programs {
   public class gx00l1 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public gx00l1( )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
            {
               ...
               AV9pUSU_COD = GetNextPar( ) ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV9pUSU_COD", AV9pUSU_COD);
               setAjaxCallMode();
               if ( ! IsValidAjaxCall( true) )
               {
                  GxWebError = 1 ;
               ...
               gxgrGrid1_refresh( Grid1_PageSize26, AV6cSIS_COD, AV7cPRG_COD, AV9pUSU_COD) ;
               return  ;
            }
            else
            {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" onsubmit=\"try{return gx.csv.validForm()}catch(e){return true;}\" name=\"MAINFORM\" method=\"post\" action=\""+formatLink("gx00l1.aspx") + "?" + UrlEncode(StringUtil.RTrim(AV9pUSU_COD)) + "," + UrlEncode("" +AV10pSIS_COD) + "," + UrlEncode("" +AV11pPRG_COD)+"\" class=\""+"Form"+"\">") ;
      ...
      public override void RenderHtmlCloseForm( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vPUSU_COD", StringUtil.RTrim( AV9pUSU_COD));
      ...
      {
         return formatLink("gx00l1.aspx") + "?" + UrlEncode(StringUtil.RTrim(AV9pUSU_COD)) + "," + UrlEncode("" +AV10pSIS_COD) + "," + UrlEncode("" +AV11pPRG_COD) ;
      }
      ...
      protected void WB4F0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_2_4F2( true) ;
         }
         else
         {
            wb_table1_2_4F2( false) ;
         }
         return  ;
      }

      protected void wb_table1_2_4F2e( bool wbgen )
      {
         if ( wbgen )
         {
         }
      ...
      protected void START4F2( )
      {
         ...
         Form.Meta.addItem("Description", "Selection List SEG004", 0) ;
         context.wjLoc = "" ;
      ...
      protected void RF4F2( )
      {
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( context.wjLoc)) && ( context.nUserReturn != 1 ) )
         {
            ...
            edtUSU_COD_Internalname = "USU_COD_"+sGXsfl_26_idx ;
            /* Using cursor H004F2 */
            pr_default.execute(0, new Object[] {AV9pUSU_COD, AV6cSIS_COD, AV7cPRG_COD});
            nGXsfl_26_idx = 1 ;
            GRID1_nEOF = 0 ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( 10 == 0 ) || ( GRID1_nCurrentRecord < GRID1_nFirstRecordOnPage + subGrid1_Recordsperpage( ) ) ) ) )
            {
               A6USU_COD = H004F2_A6USU_COD[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A6USU_COD", A6USU_COD);
               A126PRG_COD = H004F2_A126PRG_COD[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A126PRG_COD", StringUtil.LTrim( StringUtil.Str( (decimal)(A126PRG_COD), 4, 0)));
               A116SIS_COD = H004F2_A116SIS_COD[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A116SIS_COD", StringUtil.LTrim( StringUtil.Str( (decimal)(A116SIS_COD), 3, 0)));
               /* Execute user event: E124F2 */
               E124F2 ();
      ...
      {
         /* Using cursor H004F3 */
         pr_default.execute(1, new Object[] {AV9pUSU_COD, AV6cSIS_COD, AV7cPRG_COD});
      ...
      {
         /* Start Routine */
         Form.Caption = StringUtil.Format( "Lista de Selección %1", "SEG004", "", "", "", "", "", "", "", "") ;
      ...
      protected void E134F2( )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV11pPRG_COD", StringUtil.LTrim( StringUtil.Str( (decimal)(AV11pPRG_COD), 4, 0)));
         context.setWebReturnParms(new Object[] {(short)AV10pSIS_COD,(short)AV11pPRG_COD});
         context.nUserReturn = 1 ;
         returnInSub = true;
         if (true) return;
      }

      protected void wb_table1_2_4F2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table2_9_4F2( true) ;
         }
         else
         {
            wb_table2_9_4F2( false) ;
         }
         return  ;
      }

      protected void wb_table2_9_4F2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table3_23_4F2( true) ;
         }
         else
         {
            wb_table3_23_4F2( false) ;
         }
         return  ;
      }

      protected void wb_table3_23_4F2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</fieldset>") ;
            ...
            wb_table1_2_4F2e( true) ;
         }
         else
         {
            wb_table1_2_4F2e( false) ;
         }
      }

      protected void wb_table3_23_4F2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
         ...
         if ( wbEnd == 26 )
         {
            ...
            wb_table4_33_4F2( true) ;
         }
         else
         {
            wb_table4_33_4F2( false) ;
         }
         return  ;
      }

      protected void wb_table4_33_4F2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_23_4F2e( true) ;
         }
         else
         {
            wb_table3_23_4F2e( false) ;
         }
      }

      protected void wb_table4_33_4F2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            StyleString = "" ;
            GxWebStd.gx_button_ctrl( context, context.GetButtonType( ), bttBtn_cancel_Internalname, "Cancelar", "Cancelar", "", StyleString, ClassString, 1, 1, "rounded", 1, bttBtn_cancel_Jsonclick, "ECANCEL.", TempTags, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(26), 3, 0)+","+"null"+");", "", "HLP_Gx00L1.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "</tbody>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table4_33_4F2e( true) ;
         }
         else
         {
            wb_table4_33_4F2e( false) ;
         }
      }

      protected void wb_table2_9_4F2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblocksis_cod_Internalname, 1, 1, 0, "CODIGO", "", "", "", 0, lblTextblocksis_cod_Jsonclick, "", StyleString, ClassString, "HLP_Gx00L1.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            ...
            StyleString = "" ;
            GxWebStd.gx_single_line_edit( context, edtavCsis_cod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6cSIS_COD), 3, 0, ",", "")), "", 3, "chr", 1, "row", 3, 1, 1, 0, 0, 0, "", "", StyleString, ClassString, "", context.localUtil.Format( (decimal)(AV6cSIS_COD), "ZZ9"), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(14);\"", 0, edtavCsis_cod_Jsonclick, "", 0, 1, -1, true, "right", "HLP_Gx00L1.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            ...
            ClassString = "TextBlock" ;
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblockprg_cod_Internalname, 1, 1, 0, "CODIGO", "", "", "", 0, lblTextblockprg_cod_Jsonclick, "", StyleString, ClassString, "HLP_Gx00L1.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            ...
            ClassString = "Attribute" ;
            StyleString = "" ;
            GxWebStd.gx_single_line_edit( context, edtavCprg_cod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV7cPRG_COD), 4, 0, ",", "")), "", 4, "chr", 1, "row", 4, 1, 1, 0, 0, 0, "", "", StyleString, ClassString, "", context.localUtil.Format( (decimal)(AV7cPRG_COD), "ZZZ9"), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(19);\"", 0, edtavCprg_cod_Jsonclick, "", 0, 1, -1, true, "right", "HLP_Gx00L1.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "</tbody>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_9_4F2e( true) ;
         }
         else
         {
            wb_table2_9_4F2e( false) ;
         }
      }
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV9pUSU_COD = (String)getParm(obj,0) ;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV9pUSU_COD", AV9pUSU_COD);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( Form.Jscriptsrc.Item(idxLst)), "?11305089");
            idxLst = (int)(idxLst+1) ;
         }
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx00l1.js", "?11305089");
      ...
      protected void sendrow_262( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_26_idx <= subGrid1_Recordsperpage( ) * 1 ) )
         {
            ...
            edtavLinkselection_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A116SIS_COD), 3, 0, ",", "")))+"'"+", "+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A126PRG_COD), 4, 0, ",", "")))+"'"+"]);" ;
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Selection List SEG004" ;
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "" ;
         H004F2_A6USU_COD = new String[] {""} ;
         H004F2_A126PRG_COD = new short[1] ;
         H004F2_A116SIS_COD = new short[1] ;
         H004F3_AGRID1_nRecordCount = new int[1] ;
         sStyleString = "" ;
         ClassString = "" ;
         StyleString = "" ;
         subGrid1_Linesclass = "" ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx00l1__default(),
            new Object[][] {
                new Object[] {
               H004F2_A6USU_COD, H004F2_A126PRG_COD, H004F2_A116SIS_COD
               }
               , new Object[] {
      ...
      private String AV9pUSU_COD ;
      private String wcpOAV9pUSU_COD ;
      ...
      private String[] H004F2_A6USU_COD ;
      private short[] H004F2_A126PRG_COD ;
      private short[] H004F2_A116SIS_COD ;
      private int[] H004F3_AGRID1_nRecordCount ;
   ...
   public class gx00l1__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV9pUSU_COD",SqlDbType.Char,16,0} ,
          ...
          def= new CursorDef[] {
              new CursorDef("H004F2", "SELECT [USU_COD], [PRG_COD], [SIS_COD] FROM [SEG004] WITH (NOLOCK) WHERE [USU_COD] = @AV9pUSU_COD and [SIS_COD] >= @AV6cSIS_COD and [PRG_COD] >= @AV7cPRG_COD ORDER BY [USU_COD], [SIS_COD], [PRG_COD]  OPTION (FAST 11)",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004F2,11,1,false,false )
             ,new CursorDef("H004F3", "SELECT COUNT(*) FROM [SEG004] WITH (NOLOCK) WHERE [USU_COD] = @AV9pUSU_COD and [SIS_COD] >= @AV6cSIS_COD and [PRG_COD] >= @AV7cPRG_COD ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004F3,1,1,false,false )
          };
       }
    }
