/*
       ...
       Generated on: 1/6/2014 11:6:32.26
...
namespace GeneXus.Programs {
   public class tbus002ttbus000_bwc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public tbus002ttbus000_bwc( )
      {
      ...
      public tbus002ttbus000_bwc( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( StringUtil.Len( (String)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               {
                  /* GeneXus formulas. */
                  AV16Pgmname = "TBUS002TTBUS000_bWC" ;
                  context.Gx_err = 0 ;
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.WriteHtmlText( "TBUS002 TTBUS000_b WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" onsubmit=\"try{return gx.csv.validForm()}catch(e){return true;}\" name=\"MAINFORM\" method=\"post\" action=\""+formatLink("tbus002ttbus000_bwc.aspx") + "?" + UrlEncode("" +AV7TTBUS_RubroBien)+"\" class=\""+"Form"+"\">") ;
      ...
      protected void RenderHtmlCloseForm4A2( )
      {
         ...
         {
            context.AddJavascriptSource("tbus002ttbus000_bwc.js", "?1163232");
         }
      ...
      protected void WB4A0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "tbus002ttbus000_bwc.aspx");
            }
      ...
      protected void START4A2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("Description", "TBUS002 TTBUS000_b WC", 0) ;
            context.wjLoc = "" ;
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 10), "'DOINSERT'") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              edtTTBUS_FechaBaja_Internalname = sPrefix+"TTBUS_FECHABAJA_"+sGXsfl_12_idx ;
                              edtTTBUS_MotivoBaja_Internalname = sPrefix+"TTBUS_MOTIVOBAJA_"+sGXsfl_12_idx ;
                              edtTTBUS_UsuarioBaja_Internalname = sPrefix+"TTBUS_USUARIOBAJA_"+sGXsfl_12_idx ;
                              edtTTBUS_MaquinaBaja_Internalname = sPrefix+"TTBUS_MAQUINABAJA_"+sGXsfl_12_idx ;
                              ...
                              context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A196TTBUS_MaquinaBaja", A196TTBUS_MaquinaBaja);
                              sEvtType = StringUtil.Right( sEvt, 1) ;
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 sEvt = StringUtil.Left( sEvt, (short)(StringUtil.Len( sEvt)-1)) ;
      ...
      protected void RF4A2( )
      {
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( context.wjLoc)) && ( context.nUserReturn != 1 ) )
         {
            ...
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < GRID_nFirstRecordOnPage + subGrid_Recordsperpage( ) ) ) ) )
            {
               ...
               A196TTBUS_MaquinaBaja = H004A2_A196TTBUS_MaquinaBaja[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A196TTBUS_MaquinaBaja", A196TTBUS_MaquinaBaja);
               n196TTBUS_MaquinaBaja = H004A2_n196TTBUS_MaquinaBaja[0] ;
               A195TTBUS_UsuarioBaja = H004A2_A195TTBUS_UsuarioBaja[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A195TTBUS_UsuarioBaja", A195TTBUS_UsuarioBaja);
               n195TTBUS_UsuarioBaja = H004A2_n195TTBUS_UsuarioBaja[0] ;
               A43TTBUS_MotivoBaja = H004A2_A43TTBUS_MotivoBaja[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A43TTBUS_MotivoBaja", A43TTBUS_MotivoBaja);
               n43TTBUS_MotivoBaja = H004A2_n43TTBUS_MotivoBaja[0] ;
               A16TTBUS_FechaBaja = H004A2_A16TTBUS_FechaBaja[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A16TTBUS_FechaBaja", context.localUtil.Format(A16TTBUS_FechaBaja, "99/99/9999"));
               n16TTBUS_FechaBaja = H004A2_n16TTBUS_FechaBaja[0] ;
               A11TTBUS_Id = H004A2_A11TTBUS_Id[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A11TTBUS_Id", StringUtil.LTrim( StringUtil.Str( (decimal)(A11TTBUS_Id), 8, 0)));
               /* Execute user event: E134A2 */
               E134A2 ();
      ...
      {
         /* Grid_Load Routine */
         edtavUpdate_Link = formatLink("ttbus000_b.aspx") + "?" + UrlEncode(StringUtil.RTrim("UPD")) + "," + UrlEncode("" +A11TTBUS_Id) ;
         context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavUpdate_Internalname, "Link", edtavUpdate_Link);
         edtavDelete_Link = formatLink("ttbus000_b.aspx") + "?" + UrlEncode(StringUtil.RTrim("DLT")) + "," + UrlEncode("" +A11TTBUS_Id) ;
      ...
      {
         /* 'DoInsert' Routine */
         context.wjLoc = formatLink("ttbus000_b.aspx") + "?" + UrlEncode(StringUtil.RTrim("INS")) + "," + UrlEncode("" +0) ;
      }
      ...
      protected void S112( )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri(sPrefix, false, "AV10TrnContext", (Object)(AV10TrnContext));
         AV10TrnContext.gxTpr_Transactionname = "TTBUS000_b" ;
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri(sPrefix, false, "AV10TrnContext", (Object)(AV10TrnContext));
      ...
      protected void wb_table1_2_4A2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table2_5_4A2( true) ;
         }
         else
         {
            wb_table2_5_4A2( false) ;
         }
         return  ;
      }

      protected void wb_table2_5_4A2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
      ...
      protected void wb_table2_5_4A2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            StyleString = "" ;
            GxWebStd.gx_bitmap( context, imgInsert_Internalname, "", context.GetImagePath( "5649fbb8-8ce0-4810-a5ce-bd649ea83c3a", "", "Modern"), "Modern", 1, 1, "", "Agrega", 0, 0, 0, "", 0, "", 0, 0, "", "", 5, imgInsert_Jsonclick, sPrefix+"E\\'DOINSERT\\'.", StyleString, ClassString, "", ""+TempTags, "", "", "HLP_TBUS002TTBUS000_bWC.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            ...
            if ( GridContainer.GetWrapped() == 1 )
            {
               ...
               context.SendWebValue( "de Baja") ;
               context.WriteHtmlTextNl( "</th>") ;
               context.WriteHtmlText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+subGrid_Linesclass+"\" "+" style=\""+((-1==0) ? "display:none;" : "")+""+"\" "+">") ;
               context.SendWebValue( "la Baja") ;
               context.WriteHtmlTextNl( "</th>") ;
               context.WriteHtmlText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+subGrid_Linesclass+"\" "+" style=\""+((-1==0) ? "display:none;" : "")+""+"\" "+">") ;
               context.SendWebValue( "la baja") ;
               context.WriteHtmlTextNl( "</th>") ;
            ...
            else
            {
               ...
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
               GridColumn.AddObjectProperty("Value", context.localUtil.Format(A16TTBUS_FechaBaja, "99/99/9999"));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
               GridColumn.AddObjectProperty("Value", StringUtil.RTrim( A43TTBUS_MotivoBaja));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
               GridColumn.AddObjectProperty("Value", StringUtil.RTrim( A195TTBUS_UsuarioBaja));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
               GridColumn.AddObjectProperty("Value", StringUtil.RTrim( A196TTBUS_MaquinaBaja));
               GridContainer.AddColumnProperties(GridColumn);
         ...
         if ( wbEnd == 12 )
         {
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_5_4A2e( true) ;
         }
         else
         {
            wb_table2_5_4A2e( false) ;
         }
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "tbus002ttbus000_bwc");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( Form.Jscriptsrc.Item(idxLst)), "?1163271");
            idxLst = (int)(idxLst+1) ;
         }
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("tbus002ttbus000_bwc.js", "?1163271");
         }
      ...
      protected void sendrow_122( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_12_idx <= subGrid_Recordsperpage( ) * 1 ) )
         {
            ...
            StyleString = "" ;
            ROClassString = ClassString ;
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtTTBUS_FechaBaja_Internalname,context.localUtil.Format(A16TTBUS_FechaBaja, "99/99/9999"),(String)"",(short)0,(String)"px",(short)17,(String)"",(short)10,(short)-1,(short)0,(short)0,(short)0,(short)0,(String)"",(String)"",(String)StyleString,(String)ClassString,(String)ROClassString,context.localUtil.Format( A16TTBUS_FechaBaja, "99/99/9999"),(String)"",(short)0,(String)edtTTBUS_FechaBaja_Jsonclick,(String)"",(short)12,(short)1,(short)1,(bool)true,(String)"right"});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            StyleString = "" ;
            ROClassString = ClassString ;
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtTTBUS_MotivoBaja_Internalname,StringUtil.RTrim( A43TTBUS_MotivoBaja),(String)"",(short)0,(String)"px",(short)17,(String)"",(short)50,(short)-1,(short)0,(short)0,(short)0,(short)0,(String)"",(String)"",(String)StyleString,(String)ClassString,(String)ROClassString,StringUtil.RTrim( context.localUtil.Format( A43TTBUS_MotivoBaja, "@!")),(String)"",(short)0,(String)edtTTBUS_MotivoBaja_Jsonclick,(String)"",(short)12,(short)1,(short)1,(bool)true,(String)"left"});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+((-1==0) ? "display:none;" : "")+"\">") ;
            ...
            StyleString = "" ;
            ROClassString = ClassString ;
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtTTBUS_MaquinaBaja_Internalname,StringUtil.RTrim( A196TTBUS_MaquinaBaja),(String)"",(short)0,(String)"px",(short)17,(String)"",(short)20,(short)-1,(short)0,(short)0,(short)0,(short)0,(String)"",(String)"",(String)StyleString,(String)ClassString,(String)ROClassString,StringUtil.RTrim( context.localUtil.Format( A196TTBUS_MaquinaBaja, "XXXXXXXXXXXXXXXXXXXX")),(String)"",(short)0,(String)edtTTBUS_MaquinaBaja_Jsonclick,(String)"",(short)12,(short)1,(short)1,(bool)true,(String)"left"});
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "" ;
         H004A2_A17TTBUS_RubroBien = new short[1] ;
         H004A2_A196TTBUS_MaquinaBaja = new String[] {""} ;
         H004A2_n196TTBUS_MaquinaBaja = new bool[] {false} ;
         H004A2_A195TTBUS_UsuarioBaja = new String[] {""} ;
         H004A2_n195TTBUS_UsuarioBaja = new bool[] {false} ;
         H004A2_A43TTBUS_MotivoBaja = new String[] {""} ;
         H004A2_n43TTBUS_MotivoBaja = new bool[] {false} ;
         H004A2_A16TTBUS_FechaBaja = new DateTime[] {DateTime.MinValue} ;
         H004A2_n16TTBUS_FechaBaja = new bool[] {false} ;
         H004A2_A11TTBUS_Id = new int[1] ;
         H004A3_AGRID_nRecordCount = new int[1] ;
         AV10TrnContext = new SdtTransactionContext(context);
         ...
         ROClassString = "" ;
         GXt_char8 = "" ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.tbus002ttbus000_bwc__default(),
            new Object[][] {
                new Object[] {
               H004A2_A17TTBUS_RubroBien, H004A2_A196TTBUS_MaquinaBaja, H004A2_n196TTBUS_MaquinaBaja, H004A2_A195TTBUS_UsuarioBaja, H004A2_n195TTBUS_UsuarioBaja, H004A2_A43TTBUS_MotivoBaja, H004A2_n43TTBUS_MotivoBaja, H004A2_A16TTBUS_FechaBaja, H004A2_n16TTBUS_FechaBaja, H004A2_A11TTBUS_Id
               }
               , new Object[] {
      ...
      private short[] H004A2_A17TTBUS_RubroBien ;
      private String[] H004A2_A196TTBUS_MaquinaBaja ;
      private bool[] H004A2_n196TTBUS_MaquinaBaja ;
      private String[] H004A2_A195TTBUS_UsuarioBaja ;
      private bool[] H004A2_n195TTBUS_UsuarioBaja ;
      private String[] H004A2_A43TTBUS_MotivoBaja ;
      private bool[] H004A2_n43TTBUS_MotivoBaja ;
      private DateTime[] H004A2_A16TTBUS_FechaBaja ;
      private bool[] H004A2_n16TTBUS_FechaBaja ;
      private int[] H004A2_A11TTBUS_Id ;
      private int[] H004A3_AGRID_nRecordCount ;
   ...
   public class tbus002ttbus000_bwc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H004A2", "SELECT [TTBUS_RubroBien], [TTBUS_MaquinaBaja], [TTBUS_UsuarioBaja], [TTBUS_MotivoBaja], [TTBUS_FechaBaja], [TTBUS_Id] FROM [TTBUS000] WITH (NOLOCK) WHERE [TTBUS_RubroBien] = @AV7TTBUS_RubroBien ORDER BY [TTBUS_Id] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004A2,11,0,true,false )
             ,new CursorDef("H004A3", "SELECT COUNT(*) FROM [TTBUS000] WITH (NOLOCK) WHERE [TTBUS_RubroBien] = @AV7TTBUS_RubroBien ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004A3,1,0,true,false )
          };
       }
    }
